...
faqItems:
  ...
  - question: "Can a founder retrieve assets once dedicated to a Swiss foundation?"
    answer: "No. Once assets are dedicated to a foundation and the charter is registered, the founder cannot retrieve them. This is a structural feature of Swiss foundation law, not a contractual restriction. Courts have consistently upheld the irrevocability principle, even when founders face personal financial difficulties."
  - question: "How much does it cost to form a Swiss foundation?"
    answer: "Total formation costs excluding the endowment typically range from CHF 5,000 to CHF 12,000. This includes notarial fees (CHF 1,500-3,000), Commercial Register fees (approximately CHF 600), and legal drafting of the charter (CHF 3,000-8,000). Crypto foundations often have higher legal costs due to regulatory complexity."
  - question: "What is the difference between a foundation and a cooperative in Switzerland?"
    answer: "A foundation is irrevocable — once the charter is registered, the founder loses control of the assets permanently. A cooperative (Genossenschaft) retains member governance and can be dissolved by its members. For community ownership projects, a cooperative may serve better. For absolute independence from any stakeholder, the foundation is the correct vehicle."
  - question: "When does a crypto foundation trigger FINMA supervision?"
    answer: "If a foundation manages third-party assets — not just its own endowment — FINMA supervision may be triggered regardless of the foundation stated charitable or protocol-development purpose. Accepting funds from token holders or ecosystem participants and deploying those funds actively may classify the foundation as a collective investment scheme or financial intermediary under AMLA."
  - question: "Can a Swiss foundation change its stated purpose after registration?"
    answer: "Only with supervisory authority consent, and purpose changes are refused where the original purpose remains achievable. This is why precise drafting of the purpose clause at formation is critical — an imprecise or overly narrow clause locks the foundation into constraints that are extremely difficult to modify later."
tocItems:
  - id: "legal-basis"
    title: "Legal Basis"
  ...
  - id: "foundation-vs-association-vs-gmbh"
    title: "Foundation vs Association vs GmbH"
  - id: "swiss-foundations-and-crypto-practical-considerations"
...
The full text of the relevant ZGB provisions is available on <a href="https://www.fedlex.admin.ch/eli/cc/24/233_245_233/en" target="_blank" rel="nofollow noopener">Fedlex, Switzerland's official federal law portal</a>.
