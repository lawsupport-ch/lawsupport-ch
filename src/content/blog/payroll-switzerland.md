...
faqItems:
  ...
  - question: "What penalties apply for late AHV contribution payments?"
    answer: "The AHV compensation office charges 5% annual interest on late contributions. Under Art. 52 AHVG, company directors face personal liability for unpaid contributions, even in a GmbH or AG with limited liability. Retroactive assessments can cover several years."
  - question: "How do payroll obligations differ between cantons?"
    answer: "Quellensteuer rates vary by canton of the employee's residence, not the employer's canton. FAK (family allowance) contribution rates also differ: Zug charges approximately 1.6%, Zurich around 2.3%, and Geneva up to 3.5%. Social insurance contribution rates (AHV/IV/EO, ALV) are federal and uniform across all cantons."
  - question: "What is the cost of outsourcing payroll in Switzerland?"
    answer: "For companies with fewer than 10 employees, fiduciary firms typically charge CHF 150-180 per hour, with payroll requiring 2-4 hours per month. Bundled accounting and payroll packages start from approximately CHF 3'800 per year. Software like Bexio costs CHF 35-83 per month."
  - question: "When must an employer register for BVG pension coverage?"
    answer: "BVG pension fund affiliation must be completed before the first employee starts work. There is no grace period. The employer must select a pension fund or collective foundation and complete the affiliation agreement. Late registration triggers 5% annual interest on unpaid contributions plus potential personal liability for directors."
  - question: "Are bonuses and commissions subject to Swiss payroll deductions?"
    answer: "Yes. All compensation elements — base salary, bonuses, commissions, overtime pay, and the 13th month salary — are subject to AHV/IV/EO, ALV (up to the ceiling), and Quellensteuer. BVG contributions apply only to the coordinated salary portion, but many pension plans extend coverage to variable compensation."
tocItems:
  ...
  - id: "2-social-insurance-contributions-the-full-breakdown"
    title: "2. Social Insurance Contributions: The Full Breakdown"
  - id: "3-contribution-rates-summary-table"
    title: "3. Contribution Rates Summary Table"
  - id: "4-source-tax-quellensteuer-withholding-for-foreign-employees"
    title: "4. Source Tax (Quellensteuer): Withholding for Foreign Employees"
  - id: "5-the-13th-month-salary"
    title: "5. The 13th Month Salary"
  - id: "6-the-payslip"
    title: "6. The Payslip"
  - id: "7-collective-agreements-gavcct"
    title: "7. Collective Agreements (GAV/CCT)"
  - id: "8-record-keeping-obligations"
