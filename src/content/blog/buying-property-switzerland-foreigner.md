...
faqItems:
  - question: "Can a US or UK citizen buy a house in Switzerland without living there?"
    answer: "In practice, no — not a residential property. Non-resident citizens of the US, UK, and other non-EU/EFTA countries are subject to Lex Koller (BewG) and cannot acquire residential real estate without cantonal authorisation. Authorisations for standard residential property are not issued for pure investment purposes. The only exception is a holiday apartment in a designated tourist zone, subject to the federal quota system."
  - question: "What are the main Lex Koller restrictions on foreign property buyers?"
    answer: "Lex Koller (BewG, Federal Act on the Acquisition of Immovable Property by Persons Abroad) prohibits 'persons abroad' from acquiring Swiss residential real estate without prior cantonal authorisation. The restriction applies to non-resident foreign nationals, EU/EFTA nationals without a Swiss B or C permit, and Swiss companies majority-controlled by foreign beneficial owners. Commercial property is exempt where acquired for genuine business use."
  - question: "Do EU citizens face different rules to non-EU citizens when buying property in Switzerland?"
    answer: "Yes. EU/EFTA nationals holding a Swiss B permit may purchase their primary residence in their canton of registration without authorisation. Non-EU nationals on a B permit do not automatically receive this right. EU/EFTA nationals without any Swiss permit are still subject to Lex Koller restrictions, the same as other non-residents."
  - question: "Can a foreigner buy commercial property in Switzerland?"
    answer: "Yes. Lex Koller explicitly exempts commercial and industrial property acquired for genuine business use in Switzerland. Office premises, warehouses, retail premises, and hospitality facilities operated as a business can be acquired by foreign nationals or foreign-owned entities without triggering Lex Koller restrictions."
  - question: "Does buying through a Swiss company allow a foreigner to purchase Swiss residential property?"
    answer: "No. Under BewG Article 5, a Swiss GmbH or AG majority-owned by non-resident foreign nationals is treated as a 'person abroad'. Lex Koller looks through the corporate structure to the beneficial owners. Holding residential property inside a Swiss company does not create an exemption — it can create additional compliance exposure."
  - question: "What cantonal authorisation is required for foreign property buyers in Switzerland?"
    answer: "Foreign buyers subject to Lex Koller must apply to the relevant cantonal authority (Bewilligungsbehörde) for authorisation before or concurrent with executing the notarial deed. Authorisation is required for residential property purchases by persons abroad. The cantonal authority assesses the application against BewG criteria; for standard residential property the authorisation is very rarely granted outside designated tourist zones."
  - question: "Can a foreigner get a mortgage from a Swiss bank?"
    answer: "It is possible but more difficult than for Swiss residents. Swiss banks apply FINMA/SBA guidelines requiring at least 20% equity for a primary residence (10% from personal liquid assets). Non-resident buyers without Swiss income history face additional scrutiny. Private banks and some cantonal banks are more flexible for high-net-worth clients, typically requiring substantial assets under management or ancillary deposits."
  - question: "What is the property transfer tax in Switzerland, and how does it vary by canton?"
    answer: "Property transfer tax (Handänderungssteuer) is a cantonal tax on the purchase price. Rates vary materially: Zug levies 0%, Zurich approximately 1% (in the form of notarial and registration fees), Valais around 1%, Ticino around 2%, Vaud around 2.2%, and Geneva 3.0–3.3%. Total buyer transaction costs including notarial fees and Grundbuch registration typically range from 3–5% of the purchase price."
  - question: "What are notary costs for a property purchase in Switzerland?"
    answer: "All Swiss property transfers require a notarial deed (öffentliche Beurkundung). Notarial fees are typically 0.1–0.5% of the transaction value, varying by canton and transaction complexity. Land registry (Grundbuch) registration fees are generally a further 0.1–0.3% of the purchase price. Both are usually paid by the buyer."
  - question: "How is property recorded and protected in the Swiss Land Register (Grundbuch)?"
    answer: "The Grundbuch (Land Register) is Switzerland's official public register of real property ownership and encumbrances, maintained at cantonal level. Legal ownership of real estate only transfers upon entry in the Grundbuch. The register records title, mortgages (Schuldbrief or Grundpfandverschreibung), easements, and other encumbrances. Due diligence on any Swiss property purchase must include a full Grundbuch extract to identify all encumbrances."
tocItems:
  - id: "the-central-restriction-lex-koller-bewg"
    title: "The Central Restriction: Lex Koller (BewG)"
  - id: "who-is-subject-to-lex-koller"
    title: "Who Is Subject to Lex Koller?"
  - id: "who-is-exempt-from-lex-koller"
    title: "Who Is Exempt from Lex Koller?"
  - id: "eu-vs-non-eu-buyers-the-key-difference"
    title: "EU vs Non-EU Buyers: The Key Difference"
  - id: "holiday-apartments-the-narrow-exception-for-non-residents"
    title: "Holiday Apartments: The Narrow Exception for Non-Residents"
  - id: "the-commercial-property-exception"
    title: "The Commercial Property Exception"
  - id: "why-a-swiss-corporate-wrapper-does-not-bypass-lex-koller-for"
    title: "Why a Swiss Corporate Wrapper Does Not Bypass Lex Koller for Residential Property"
  - id: "cantonal-authorisation-how-the-process-works"
    title: "Cantonal Authorisation: How the Process Works"
  - id: "costs-of-acquisition-taxes-and-fees-by-canton"
    title: "Costs of Acquisition: Taxes and Fees by Canton"
  - id: "mortgage-financing-for-foreign-buyers"
    title: "Mortgage Financing for Foreign Buyers"
  - id: "ongoing-property-taxes-and-imputed-rental-income"
    title: "Ongoing Property Taxes and Imputed Rental Income"
  - id: "the-transaction-process-step-by-step"
...
The full text of the BewG is publicly available on <a href="https://www.fedlex.admin.ch/eli/cc/1984/1148_1148_1148/en" target="_blank" rel="nofollow noopener">fedlex.admin.ch</a>. Key operative provisions are:
...
This gap between EU and non-EU B permit holders is frequently misunderstood.

### A Real Case: Romanian Entrepreneur and Swiss Property

A Romanian entrepreneur based in Bucharest wanted to establish an AG in Zug. One of his motivations was the privacy advantage of the AG structure — unlike the GmbH, where shareholder names appear in the public Commercial Register, an AG's shareholders are not publicly disclosed.

The immediate problem: Swiss corporate law requires at least one board member domiciled in Switzerland and authorised to represent the company. The founder's solution was to appoint a friend (a Swiss citizen) as a temporary board member for approximately one year, while the founder worked towards obtaining his own Swiss residence.

Lex Koller applied in full. As a non-EU national without a Swiss residence permit, the founder was subject to the standard restrictions on residential property acquisition. The commercial property exception (BewG Article 7(1)(b)) applied to any office or business premises the company needed, but residential property for the founder's personal use was not available without a Swiss permit. The founder's path to property ownership ran through the immigration process: obtain a B permit, then purchase a primary residence in the canton of registration. Non-EU nationals on a B permit seeking to purchase residential property should obtain legal advice before proceeding, as the exemption available to EU/EFTA nationals does not automatically extend to them. The <a href="https://www.sem.admin.ch/sem/en/home/themen/aufenthalt/eu_efta.html" target="_blank" rel="nofollow noopener">State Secretariat for Migration (SEM)</a> publishes guidance on permit categories and associated rights.
...
A common misconception is that holding residential property inside a Swiss company sidesteps Lex Koller. It does not. This is one of the first questions we receive from foreign entrepreneurs who have just formed a Swiss AG or GmbH.
...
1. Submission of the application with full documentation: buyer identity and ownership chain, property description, intended use, and financing structure
2. Cantonal review against BewG criteria — for residential property, this is a high bar that is very rarely met outside the holiday apartment quota
3. Authorisation or refusal; refused applications may be appealed through the cantonal administrative courts
4. Where authorised, the notary incorporates the authorisation reference in the deed
...
Registration in the Grundbuch is mandatory for any transfer to be legally effective — ownership does not pass until the Grundbuch entry is made. Registration fees are generally 0.1–0.3% of the purchase price. The Grundbuch extract (*Grundbuchauszug*) obtained during due diligence will disclose all existing encumbrances, mortgages, easements, and restrictions. Statistical data on Swiss real estate transactions is published by the <a href="https://www.bfs.admin.ch/bfs/en/home/statistics/construction-housing.html" target="_blank" rel="nofollow noopener">Swiss Federal Statistical Office (BFS)</a>.
...
Switzerland levies annual wealth tax at cantonal and communal level. Real estate is included in the taxable wealth base at its assessed fiscal value (*Steuerwert*), typically 70–80% of market value. Mortgage debt reduces taxable net wealth.

**Imputed Rental Income (Eigenmietwert)**
Switzerland deems owner-occupiers to receive a notional rental income (*Eigenmietwert*) equal to approximately 60–70% of estimated market rent. This amount is added to the owner's taxable income. In exchange, mortgage interest payments and certain maintenance costs are deductible. The system is subject to periodic reform debate but remains in force for 2026.

**Real Estate Capital Gains Tax (Grundstückgewinnsteuer)**
Most Swiss cantons levy a specific tax on gains from property sales. The rate is inversely correlated with holding period: selling within two years of acquisition typically triggers rates of 30–40% on the gain; a holding period of 20+ years may reduce the rate to around 10%. This is a significant consideration for any short-term investment strategy.

---

## The Transaction Process Step by Step

1. **Due diligence** — verify Lex Koller status, confirm zoning, obtain and review the Grundbuch extract for encumbrances, charges, and easements
2. **Preliminary agreement** — a non-binding letter of intent or, more formally, a notarised preliminary purchase agreement (*Vorvertrag*)
3. **Financing confirmation** — obtain written mortgage commitment from the lender before execution of the deed
4. **Cantonal authorisation** (where required under BewG) — must be obtained before or concurrent with the deed; the notary will confirm this requirement in advance
5. **Notarial deed** — both parties sign before a cantonal notary; transfer tax falls due at this stage in applicable cantons
6. **Land Register registration** — the notary submits for Grundbuch entry; legal ownership transfers upon registration
...
**Can a US or UK citizen buy a house in Switzerland without living there?**
In practice, no — not a residential property. Non-resident citizens of the US, UK, and other non-EU/EFTA countries are subject to Lex Koller (BewG) and cannot acquire residential real estate without cantonal authorisation. Authorisations for standard residential property are not issued for investment purposes. The only exception is a holiday apartment in a designated tourist zone under the BewG Article 8 quota system.

**What are the main Lex Koller restrictions on foreign property buyers?**
Lex Koller (BewG) prohibits "persons abroad" from acquiring Swiss residential real estate without prior cantonal authorisation under BewG Article 2. The restriction applies to non-resident foreign nationals, EU/EFTA nationals without a Swiss B or C permit, and Swiss companies majority-controlled by foreign beneficial owners (BewG Article 5). Commercial property is exempt where acquired for genuine business use (BewG Article 7(1)(b)).

**Do EU citizens face different rules to non-EU citizens when buying property in Switzerland?**
...
**How is property recorded and protected in the Swiss Land Register (Grundbuch)?**
The Grundbuch is Switzerland's official public register of real property ownership and encumbrances, maintained at cantonal level. Legal ownership only transfers upon Grundbuch entry — execution of the notarial deed alone is insufficient. The register records title, mortgages (*Schuldbrief* or *Grundpfandverschreibung*), easements, and other encumbrances. A full Grundbuch extract must be obtained as part of due diligence on any Swiss property transaction.

---

## Request a Free Assessment

Lex Koller compliance analysis, structuring a commercial property acquisition, coordinating with Swiss notaries and cantonal authorities, and understanding the interaction between property ownership and residence permit status all require legal expertise specific to Swiss property and corporate law.
