...
description: "Swiss work permits for 2026: L, B, C and G permits, EU vs non-EU rules, annual quotas, employer obligations, priority check and application timelines."
date: "27.08.2026"
...
faqItems:
  - question: "What are the Swiss work permit types?"
    answer: "Switzerland issues four main work permits: the L permit (short-term, up to 12 months), the B permit (initial residence, 5 years for EU/EFTA or 1 year renewable for non-EU), the C permit (permanent residence after 5 or 10 years), and the G permit (cross-border commuter)."
  - question: "How long does a Swiss work permit application take?"
    answer: "EU/EFTA nationals: 5-20 working days. Non-EU specialist and manager applications: 4-12 weeks for cantonal-only cases, 8-16 weeks where federal SEM referral is required. Non-EU self-employment applications: 3-6 months."
  - question: "Can EU nationals work in Switzerland without a permit?"
    answer: "EU/EFTA nationals have a qualified right to work under the Agreement on Free Movement of Persons. They still need a B or L permit, but the process is a registration exercise rather than a discretionary assessment with no quota and no priority check."
  - question: "Does forming a Swiss company give me a work permit automatically?"
...
tocItems:
  ...
  - id: "swiss-work-permit-types"
    title: "Swiss Work Permit Types"
  - id: "permit-comparison-table"
    title: "Permit Comparison Table"
  - id: "annual-quotas-for-non-euefta-workers"
    title: "Annual Quotas for Non-EU/EFTA Workers"
  - id: "key-categories-for-non-euefta-nationals"
    title: "Key Categories for Non-EU/EFTA Nationals"
  - id: "employer-obligations-the-priority-check"
    title: "Employer Obligations: The Priority Check"
  - id: "application-process-step-by-step"
    title: "Application Process: Step by Step"
  - id: "family-reunification"
    title: "Family Reunification"
  - id: "from-b-permit-to-c-permit-the-residency-pathway"
...
| Permit | Duration | Renewable | Quota (Non-EU) | Typical Use Case |
|---|---|---|---|---|
| **L permit** | Up to 12 months | No (same form) | Yes (~5'200/year) | Fixed-term contracts, short-term transfers |
| **B permit** | 5 years (EU/EFTA) / 1 year (non-EU) | Yes | Yes (~8'500/year) | Standard employment, self-employment, entrepreneurs |
| **C permit** | Permanent | Not required | No | After 5 years (EU/EFTA) or 10 years (non-EU) on B permit |
| **G permit** | 5 years (EU/EFTA) / 1 year (non-EU) | Yes | Yes (non-EU) | Cross-border commuters living in neighbouring country |
...
For EU/EFTA nationals: yes, under the 90-day notification procedure. For non-EU nationals: no. You must wait for permit issuance and obtain a D visa from the Swiss consulate in your country before entering Switzerland for work. Starting work without a valid permit is a criminal offence under Art. 115 AIG, carrying fines and potential entry bans.

**Do I need to speak German or French for a Swiss work permit?**

Not for the permit application itself. The employer handles documentation in the cantonal language. Whether you need language skills for the role depends on your position. International companies in Zurich, Zug, and Geneva often operate in English. Smaller Swiss firms, client-facing roles, and public-sector positions require the local language. Language proficiency becomes a legal requirement only at the [C permit](/immigration/c-permit-switzerland/) stage (A2/B1 for non-EU nationals) and for [Swiss citizenship](/immigration/swiss-citizenship/) (B1 spoken, A2 written).
