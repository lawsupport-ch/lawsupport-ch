...
faqItems:
  ...
  - question: "How long does it take to set up a nominee arrangement?"
    answer: "From initial KYC submission to signed nominee agreement and commercial register entry, expect 2-4 weeks. Rush arrangements can be completed in 5-7 business days if all documentation is provided upfront and the canton processes quickly."
  - question: "What happens to the nominee arrangement if the beneficial owner dies?"
    answer: "The nominee agreement typically includes succession provisions. The nominee continues to hold the position until heirs provide instructions. Without clear succession terms, the nominee must act in the company's best interest and may need to seek court guidance."
  - question: "Can a nominee service provider act for competing businesses?"
    answer: "Yes, unless the nominee agreement includes an exclusivity clause. Reputable providers manage conflicts of interest through information barriers and separate personnel. It is advisable to include non-competition provisions in the agreement."
  - question: "What AML documentation does the nominee require from the beneficial owner?"
    answer: "The nominee must collect certified copies of passport or national ID, proof of residential address, source of funds documentation, a Form A beneficial owner declaration, and in some cases a criminal record extract. Enhanced due diligence applies for PEPs."
tocItems:
  ...
  - id: "registered-address-domizil-services"
    title: "Registered Address (Domizil) Services"
  - id: "nominee-shareholder-services"
    title: "Nominee Shareholder Services"
  - id: "what-nominee-services-do-not-provide"
