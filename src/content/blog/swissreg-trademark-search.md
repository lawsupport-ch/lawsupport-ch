...
faqItems:
  ...
  - question: "How often should I monitor Swissreg for conflicting marks?"
    answer: "For active brands, quarterly monitoring is advisable. New trademark applications are published daily, and a mark filed after yours could still create enforcement challenges if the owner claims prior use rights. Professional watch services automate this process and alert you to new filings in your Nice classes."
  - question: "Can I search for figurative marks (logos) on Swissreg?"
    answer: "Swissreg allows browsing of figurative marks by Vienna Classification codes, but there is no image-based reverse search. You must know the classification category or search by owner name. For thorough logo clearance, professional search services using image recognition algorithms are necessary."
  - question: "What is the opposition period after a Swiss trademark is published?"
    answer: "The opposition period is 3 months from publication in the Swiss Trademark Gazette. During this window, any holder of a prior right can file an opposition with IGE/IPI for a fee of CHF 800. If no opposition is filed, the mark proceeds to full registration."
  - question: "How long does Swiss trademark protection last?"
    answer: "A Swiss trademark registration is valid for 10 years from the filing date. It can be renewed indefinitely for successive 10-year periods upon payment of the renewal fee. Failure to renew results in the mark lapsing and becoming available for third-party registration."
  - question: "What are the filing fees for a Swiss trademark with IGE/IPI?"
    answer: "The base filing fee is CHF 550 for registration in one Nice class, with CHF 100 for each additional class. Online filing is available through the IGE e-trademark portal. Expedited processing is not offered; all applications follow the standard examination timeline of approximately 4 months."
  - question: "Can unregistered trademarks block my Swiss filing?"
    answer: "Yes. Under Art. 14 MSchG, a party that has used a mark commercially in Switzerland before your filing date may hold defensible prior use rights, even without a registration. These rights do not appear in any database and cannot be discovered through Swissreg or TMview searches alone."
  - question: "Should I search ZEFIX before filing a trademark application?"
    answer: "Yes. Company names registered in the Swiss Commercial Register can conflict with trademarks under Swiss company name law (Firmenrecht). A company name registered years before your trademark filing can block it, even if it never appears in Swissreg. Always search both databases as part of your clearance process."
tocItems:
  - id: "what-swissreg-contains"
    title: "What Swissreg Contains"
  - id: "accessing-swissreg"
    title: "Accessing Swissreg"
  - id: "step-by-step-how-to-search-swiss-trademarks-on-swissreg"
    title: "Step-by-Step: How to Search Swiss Trademarks on Swissreg"
  - id: "using-tmview-for-cross-border-checks"
    title: "Using TMview for Cross-Border Checks"
  - id: "swissreg-search-for-patents"
    title: "Swissreg Search for Patents"
  - id: "swissreg-search-for-designs"
    title: "Swissreg Search for Designs"
  - id: "what-to-do-after-your-swissreg-search"
...
| Field | What It Means |
|---|---|
| Registration number | Unique IGE/IPI identifier |
| Status | "Registered" / "Pending" / "Lapsed" / "Opposed" |
| Filing date | When the application was filed |
| Registration date | When the mark was formally registered |
| Owner | Name and address of trademark owner |
| Goods/services | What the mark covers (described by Nice class and goods/services list) |
| Mark representation | The trademark itself (word, logo, image) |
...
No. Swissreg is a search and information database only. To file a Swiss trademark application, you must submit it to <a href="https://www.ige.ch" target="_blank" rel="nofollow noopener">IGE/IPI</a> through their separate e-trademark filing portal or by post. Filing fees start at CHF 550 for one Nice class, with CHF 100 for each additional class.
...
Yes. Even if you are registering a company name rather than a trademark, a Swissreg search is advisable. If your company name infringes an existing trademark, the trademark owner can demand you change it. Check both Swissreg for trademarks and <a href="https://www.zefix.ch" target="_blank" rel="nofollow noopener">Zefix</a> for existing company names in the commercial register.
