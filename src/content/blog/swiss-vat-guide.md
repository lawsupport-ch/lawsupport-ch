...
tocItems:
  - id: "swiss-vat-at-a-glance"
    title: "Swiss VAT at a Glance"
  - id: "current-vat-rates"
    title: "Current VAT Rates"
  - id: "who-must-register-for-vat"
    title: "Who Must Register for VAT"
  - id: "voluntary-registration"
    title: "Voluntary Registration"
  - id: "the-registration-process"
    title: "The Registration Process"
  - id: "filing-and-payment"
    title: "Filing and Payment"
  - id: "input-tax-recovery"
    title: "Input Tax Recovery"
  - id: "vat-on-imports-and-exports"
    title: "VAT on Imports and Exports"
  - id: "common-compliance-mistakes"
    title: "Common Compliance Mistakes"
  - id: "vat-and-digital-services"
    title: "VAT and Digital Services"
faqItems:
  - question: "What is the standard VAT rate in Switzerland in 2026?"
    answer: "The standard Swiss VAT rate is 8.1% as of 1 January 2024. This rate applies to most goods and services. The reduced rate is 2.6% for essential goods, and the special accommodation rate is 3.8% for hotel stays."
  - question: "What is the VAT registration threshold in Switzerland?"
    answer: "Businesses must register for Swiss VAT if their worldwide turnover from taxable supplies exceeds CHF 100'000 per year. Foreign companies supplying goods or certain services in Switzerland must register regardless of turnover from 1 January 2025 if their global revenue exceeds CHF 100'000."
  - question: "How often must Swiss VAT returns be filed?"
    answer: "VAT returns are filed quarterly by default, with deadlines 60 days after each quarter-end (e.g., 28 February for Q4). Companies may apply to file semi-annually or monthly. Monthly filing is advantageous for businesses with regular input tax credits exceeding output tax."
  - question: "Can a foreign company register for Swiss VAT?"
    answer: "Yes. Foreign companies making taxable supplies in Switzerland must register and appoint a Swiss-based fiscal representative who provides a bank guarantee. Since 2019, foreign mail-order companies shipping goods to Switzerland must register if their Swiss turnover exceeds CHF 100'000."
  - question: "What goods and services are exempt from Swiss VAT?"
    answer: "Exempt supplies include healthcare, education, insurance, banking services, real estate transactions (rental and sale), and postal services. Exempt suppliers cannot recover input tax on related purchases, which creates hidden VAT costs."
  - question: "Is there VAT on Swiss exports?"
    answer: "Exports of goods from Switzerland are zero-rated — VAT at 0% applies, and the exporter may recover input tax on related purchases. Export of services follows place-of-supply rules; many services supplied to foreign recipients are treated as outside Swiss VAT scope."
  - question: "What is the difference between exempt and zero-rated for Swiss VAT?"
    answer: "Zero-rated supplies (mainly exports) carry 0% VAT but allow full input tax recovery. Exempt supplies carry no VAT but block input tax recovery on related costs. This distinction matters: exporters benefit from zero-rating, while exempt suppliers like banks bear irrecoverable VAT as a cost."
  - question: "What penalties apply for late VAT filing in Switzerland?"
    answer: "The ESTV charges default interest at 4.5% per annum on late payments. Repeated late filing may result in fines. Intentional evasion of VAT is a criminal offence carrying fines of up to CHF 800'000 and — in cases involving fraud — imprisonment."
  - question: "Can I use the net tax rate method for Swiss VAT?"
    answer: "Businesses with annual taxable turnover below CHF 5'005'000 and VAT liability below CHF 109'000 may apply for the Saldosteuersatz (net tax rate) method. This simplified approach uses industry-specific flat rates (0.1% to 6.7%) and eliminates the need to track individual input tax."
  - question: "How does VAT apply to digital services sold to Swiss customers?"
    answer: "Foreign providers of electronic services (streaming, software, e-books) to Swiss customers must register for VAT if their Swiss revenue exceeds CHF 100'000 per year. A simplified registration procedure exists. The standard 8.1% rate applies to B2C digital supplies."
relatedArticles:
...
For the complete legal framework and detailed rate tables, see our main article on [VAT in Switzerland](/tax-accounting/vat-switzerland/).
...
| Reduced | 2.6% | Food, beverages (non-alcoholic), books, newspapers, medicines, agricultural inputs |
| Accommodation | 3.8% | Hotel and similar lodging (including breakfast if included in the room rate) |
...
For step-by-step registration guidance, see [VAT registration in Switzerland](/tax-accounting/vat-registration-switzerland/).
...
[VAT registration](/tax-accounting/vat-registration-switzerland/) is handled online through the ESTV's online portal. The process requires:
...
The FAQ section above covers the ten most common questions about Swiss VAT. For specific VAT advice — including registration, rate classification, or audit defence — [contact Morgan Hartley Consulting](/contacts/) for professional assistance.
