...
faqItems:
  ...
  - question: "Can I request a tax ruling on cryptocurrency structuring?"
    answer: "Yes. The Steuerverwaltung Zug in particular has developed significant expertise in cryptocurrency taxation and regularly issues rulings on token classification, staking income treatment, DeFi treasury management, and foundation structures. Other cantons also accept such requests but may have less institutional familiarity with the subject matter."
  - question: "What information must the ruling request include?"
    answer: "A ruling request must contain a precise factual description of the planned transaction, the specific tax questions to be answered, the applicant's own legal analysis and proposed treatment, and supporting documents such as draft contracts and structure charts. Vague or incomplete submissions invite clarifying questions and delay the process."
  - question: "Can a ruling be revoked or withdrawn by the tax authority?"
    answer: "A ruling cannot be unilaterally revoked as long as the facts remain as described and the underlying law has not changed. If the taxpayer implements the structure differently from what was described, the ruling does not apply. If Swiss tax law changes, a new ruling should be requested to confirm the treatment under the amended law."
  - question: "Is a pre-submission meeting with the tax inspector recommended?"
    answer: "Yes, particularly for novel or complex structures. An informal discussion before filing allows you to test the authority's appetite for the proposed treatment without committing to a formal submission. Zug's Steuerverwaltung is generally accessible and willing to engage in pre-filing conversations at no charge from the authority's side."
  - question: "Do Swiss tax rulings affect other jurisdictions' treatment of the same structure?"
    answer: "A Swiss ruling binds only the Swiss cantonal authority that issued it. Foreign tax authorities are not bound by Swiss rulings. However, under OECD BEPS Action 5, Switzerland exchanges certain categories of rulings with treaty partners, which means the foreign authority will be informed of the ruling's existence and terms."
tocItems:
  ...
  - id: "which-authority-issues-swiss-tax-rulings"
    title: "Which Authority Issues Swiss Tax Rulings"
  - id: "how-to-apply"
    title: "How to Apply"
  - id: "timeline"
    title: "Timeline"
  - id: "validity-and-limitations"
    title: "Validity and Limitations"
  - id: "common-ruling-scenarios"
