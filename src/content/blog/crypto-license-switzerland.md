...
tocItems:
  - id: "why-switzerland-for-crypto-licensing"
    title: "Why Switzerland for Crypto Licensing?"
  - id: "finmas-token-classification-framework"
    title: "FINMA's Token Classification Framework"
  - id: "what-crypto-licence-does-your-business-need"
    title: "What Crypto Licence Does Your Business Need?"
  - id: "vasp-registration-under-the-swiss-anti-money-laundering-act"
    title: "VASP Registration Under the Swiss Anti-Money Laundering Act"
  - id: "the-fintech-licence-banking-act-art-1b"
    title: "The FinTech Licence (Banking Act, Art. 1b)"
  - id: "the-banking-licence"
    title: "The Banking Licence"
  - id: "the-dlt-trading-facility-licence"
    title: "The DLT Trading Facility Licence"
  - id: "the-securities-firm-licence-effektenhändler-finia"
    title: "The Securities Firm Licence (Effektenhändler / FinIA)"
  - id: "fund-management-licence-for-crypto-asset-funds"
    title: "Fund Management Licence for Crypto Asset Funds"
  - id: "the-swiss-foundation-structure-for-crypto-projects"
    title: "The Swiss Foundation Structure for Crypto Projects"
  - id: "amla-compliance-requirements-for-swiss-crypto-businesses"
    title: "AMLA Compliance Requirements for Swiss Crypto Businesses"
  - id: "crypto-friendly-banking-in-switzerland"
    title: "Crypto-Friendly Banking in Switzerland"
  - id: "real-world-scenario-a-crypto-exchange-applying-through-vqf"
    title: "Real-World Scenario: A Crypto Exchange Applying Through VQF"
  - id: "common-mistakes-by-crypto-projects-approaching-switzerland"
    title: "Common Mistakes by Crypto Projects Approaching Switzerland"
  - id: "timeline-and-cost-summary"
    title: "Timeline and Cost Summary"
...
faqItems:
  - question: "Do all crypto businesses in Switzerland need a FINMA licence?"
    answer: "Not necessarily. The requirement depends on your business activity and token type. A business that merely develops blockchain software or operates a non-custodial wallet does not require a licence. A business that holds client assets, exchanges crypto for clients as a main business, or deals in securities-equivalent tokens does require either AMLA registration (through an SRO or direct FINMA registration) or a specific FINMA licence. A proper regulatory analysis of your business model is the ..."
  - question: "What is the difference between VQF membership and a FINMA licence?"
    answer: "VQF is a FINMA-recognised Self-Regulatory Organisation. Membership in VQF satisfies your Anti-Money Laundering Act registration requirement as a financial intermediary. It is not the same as a FINMA licence. FINMA licences (banking licence, FinTech licence, securities firm licence, DLT trading facility licence) are granted directly by FINMA and permit activities that SRO membership alone does not. For most crypto exchanges and custody providers, VQF membership is the correct and sufficient re..."
  - question: "Can a non-Swiss company obtain a Swiss crypto licence?"
    answer: "For VASP/AMLA registration through an SRO, the registered entity must be incorporated in Switzerland — a Swiss AG, GmbH, or branch. A foreign company cannot register through VQF directly. For FINMA licences, the licensed entity must generally be incorporated in Switzerland. A foreign company wishing to operate in Switzerland typically needs to establish a Swiss subsidiary or branch. This is standard procedure and not a significant barrier."
  - question: "How long does it take to get a crypto exchange operational in Switzerland?"
    answer: "For an exchange operating through VQF membership, the realistic timeline from the decision to proceed to operational launch is 8–12 months: 1–2 months for incorporation and setup, 3–5 months for VQF application and approval, and 2–3 months for banking setup and technical launch. This assumes a clean application with a complete AML programme. Shortcuts tend to add time, not save it."
  - question: "Are crypto assets subject to Swiss inheritance and estate law?"
  ...
  - question: "What is the Travel Rule and does it apply to Swiss crypto businesses?"
    answer: "The FATF Travel Rule requires virtual asset service providers to share originator and beneficiary information for transfers above a threshold — CHF 1,000 in Switzerland — with the receiving VASP. Swiss implementation under AMLA and the related ordinances means that any Swiss VASP must have a functional Travel Rule solution in place. Acceptable approaches include integration with Travel Rule protocols (TRUST, OpenVASP, TRP) or bilateral arrangements with counterparties. Non-compliance with the..."
  - question: "What is the difference between a FinTech licence and a banking licence in Switzerland?"
    answer: "The FinTech licence (Art. 1b Banking Act) allows a business to hold client deposits up to CHF 100 million without being a full bank. A banking licence is required for deposit-taking above CHF 100 million or for any lending, interest-bearing account, or core banking activity. The FinTech licence has a lower capital requirement (CHF 300,000 minimum) and a shorter application timeline than a banking licence."
  - question: "Can a Swiss crypto business apply for a FinTech licence and SRO membership simultaneously?"
    answer: "Yes. In fact, joining an SRO such as VQF first is the recommended approach. SRO membership can be obtained in 3–6 months and allows the business to operate in AML-compliant mode while the longer FinTech licence application (6–12 months) is in progress. The two processes run in parallel and are complementary, not mutually exclusive."
  - question: "Does FINMA have a formal no-action letter or pre-approval process for new crypto business models?"
