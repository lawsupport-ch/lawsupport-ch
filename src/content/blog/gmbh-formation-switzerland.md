...
heroImage: "/images/gmbh-formation-switzerland-hero.webp"
...
faqItems:
  ...
  - question: "What are the total costs to form a Swiss GmbH?"
  ...
  - question: "What is the difference between a GmbH and an AG in Switzerland?"
    answer: "The GmbH requires CHF 20,000 minimum capital (fully paid in) and share transfers need notarial authentication. The AG requires CHF 100,000 minimum capital (CHF 50,000 paid in) but shares transfer freely without notarial formalities. The AG is preferred for companies planning to raise external capital or issue multiple share classes."
  - question: "Can a non-resident form a Swiss GmbH without travelling to Switzerland?"
    answer: "Yes. The entire process can be handled remotely by power of attorney. Founders anywhere in the world sign notarised documents locally (apostilled if outside Switzerland), and a Swiss representative attends the notarial formation meeting. No physical travel to Switzerland is required."
  - question: "What ongoing obligations does a Swiss GmbH have after formation?"
    answer: "Annual obligations include preparing financial statements (due within six months of financial year-end), filing corporate tax returns with the cantonal tax authority, holding at least one annual general meeting, maintaining a share register, and paying AHV contributions for employees and directors. Accounting costs start from CHF 1,400/year for a dormant entity."
  - question: "What is the Lex Friedrich restriction and does it affect GmbH formation?"
    answer: "The Lex Friedrich (BewG) restricts foreign acquisition of Swiss real estate. It does not prevent foreign nationals from forming a GmbH, but if the GmbH purpose involves acquiring Swiss real estate, cantonal authorisation may be required. Standard commercial GmbHs without real estate holdings are not affected."
tocItems:
  - id: "what-is-a-swiss-gmbh"
    title: "What Is a Swiss GmbH?"
  - id: "key-characteristics-of-the-swiss-gmbh"
    title: "Key Characteristics of the Swiss GmbH"
  - id: "step-by-step-how-gmbh-formation-switzerland-works-in-2026"
    title: "Step-by-Step: How GmbH Formation Switzerland Works in 2026"
  - id: "real-world-story-the-logistics-startup-that-almost-filed-twi"
    title: "Real-World Story: The Logistics Startup That Almost Filed Twice"
  - id: "gmbh-formation-costs-in-switzerland-2026"
    title: "GmbH Formation Costs in Switzerland (2026)"
  - id: "gmbh-vs-ag-when-the-gmbh-is-the-right-choice"
    title: "GmbH vs AG: When the GmbH Is the Right Choice"
  - id: "real-world-story-the-foreign-subsidiary-that-needed-speed"
    title: "Real-World Story: The Foreign Subsidiary That Needed Speed"
  - id: "swiss-resident-director-requirement"
    title: "Swiss Resident Director Requirement"
  - id: "tax-considerations-for-the-swiss-gmbh"
    title: "Tax Considerations for the Swiss GmbH"
  - id: "common-mistakes-in-gmbh-formation-switzerland"
...
![Zurich Prime Tower and modern office buildings in the Swiss business district](/images/gmbh-formation-switzerland-hero.webp)
...
**Shareholders are publicly listed.** Every shareholder and their capital contribution appears in the Commercial Register (Handelsregister). This is searchable by anyone through <a href="https://www.zefix.ch" target="_blank" rel="nofollow noopener">ZEFIX, the federal company search portal</a>. If confidentiality matters to you, the AG structure offers meaningfully more privacy.
...
Start with a name search on <a href="https://www.zefix.ch" target="_blank" rel="nofollow noopener">ZEFIX (zefix.ch)</a>. Your proposed name must be unique, not misleading, and must include the designation "GmbH" or "Sàrl" (French-speaking cantons) or "Sagl" (Ticino). Names that imply a public authority or a regulated activity require additional approvals.
...
For guidance on the broader banking picture, see our page on [corporate bank accounts in Switzerland](/banking/corporate-bank-account-switzerland/).
...
Learn more on our [Swiss nominee director page](/corporate-services/nominee-director-switzerland/).
