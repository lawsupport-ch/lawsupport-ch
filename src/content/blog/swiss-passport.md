...
tocItems:
  ...
  - id: "the-only-path-swiss-citizenship"
    title: "The Only Path: Swiss Citizenship"
  ...
  - id: "dual-citizenship-switzerland-allows-it"
    title: "Dual Citizenship: Switzerland Allows It"
  - id: "applying-for-the-swiss-passport-itself"
    title: "Applying for the Swiss Passport Itself"
...
3. **Citizenship by descent (jus sanguinis)** — automatic transmission through a Swiss parent, available regardless of residence
...
**Federal level:** The <a href="https://www.sem.admin.ch/sem/en/home.html" target="_blank" rel="nofollow noopener">State Secretariat for Migration (SEM)</a> assesses whether federal statutory requirements are met.
