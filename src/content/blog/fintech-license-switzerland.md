...
faqItems:
  ...
  - question: "How much does it cost to obtain a Swiss FinTech-Bewilligung?"
    answer: "The FINMA application fee is CHF 5,000, but total first-year costs including company formation, SRO membership, regulatory advisory, and compliance documentation typically run CHF 80,000-130,000 excluding the CHF 300,000 minimum capital requirement. Annual FINMA supervision fees add CHF 20,000-50,000 thereafter."
  - question: "What is the difference between VQF and PolyReg for SRO membership?"
    answer: "VQF is the largest FINMA-recognised SRO with over 1,000 members and is the standard choice for fintech and crypto businesses. PolyReg is smaller and sometimes faster to onboard but has specific contractual requirements that can create friction — for instance, requiring bilateral signed contracts with exchange partners who only offer standard Terms of Service."
  - question: "What happens three months after SRO membership is granted?"
    answer: "A mandatory audit takes place three months after SRO membership is granted. If the appointed AML officer or responsible director cannot demonstrate competence during that audit, the SRO can revoke the membership. Finding qualified AML officers willing to serve fintech startups is genuinely difficult — budget for this search before applying."
  - question: "Can I buy a pre-licensed Swiss financial intermediary instead of applying from scratch?"
    answer: "Yes. Turnkey licensed financial intermediaries with existing SRO membership have traded for approximately CHF 480,000 in recent transactions. Whether this represents value depends on your timeline and risk tolerance — it eliminates the 6-15 month application process but costs significantly more than building from scratch."
  - question: "What are the ongoing compliance obligations for a FinTech-Bewilligung holder?"
    answer: "Holders must maintain full AML/CFT compliance, submit to annual regulatory audits, provide periodic reports to FINMA, notify FINMA immediately of material changes (board composition, business model, capital), and ensure deposits never exceed CHF 100 million or are invested or on-lent. Non-compliance can result in licence revocation."
tocItems:
  ...
  - id: "the-four-main-regulatory-pathways"
    title: "The Four Main Regulatory Pathways"
  - id: "payment-services-no-psd2-equivalent-in-switzerland"
    title: "Payment Services: No PSD2 Equivalent in Switzerland"
  - id: "vasp-regulation-virtual-asset-service-providers"
    title: "VASP Regulation: Virtual Asset Service Providers"
  - id: "regulatory-pathway-comparison-table"
    title: "Regulatory Pathway Comparison Table"
