...
faqItems:
  - question: "Does IGE/IPI register copyrights?"
    answer: "No. Copyright in Switzerland is automatic upon creation of an original work under the Copyright Act (URG). No registration is required or available. IGE/IPI only handles trademarks, patents, and designs."
  - question: "How long does Swiss trademark registration take?"
    answer: "Standard timeline: 3-6 months if no examination issues and no opposition. If an opposition is filed by a third party, the process extends to 12-24 months."
  - question: "Can foreign companies file directly with IGE/IPI?"
    answer: "Yes. Foreign applicants can file trademark, patent, and design applications directly with IGE/IPI. A Swiss address for correspondence is required; a professional representative is recommended."
  - question: "What is the difference between a Swiss national patent and a European patent?"
    answer: "A Swiss national patent is granted after formal examination only. A European patent filed through the EPO undergoes full substantive examination. The EPO patent is more expensive but carries stronger legal presumption of validity."
  - question: "Is a Swiss trademark valid in Liechtenstein?"
    answer: "Yes. Under the bilateral treaty between Switzerland and Liechtenstein, Swiss trademark registrations automatically extend to Liechtenstein without additional fees or filings."
  - question: "How much does it cost to register a trademark with IGE/IPI?"
    answer: "The official fee for a Swiss trademark application is CHF 550 for up to three classes. Each additional class costs CHF 100. Professional representative fees typically add CHF 1,500 to 3,000."
  - question: "Can I oppose a trademark application at IGE/IPI?"
    answer: "Yes. Any trademark owner can file an opposition within three months of publication in the Swiss Official Gazette of Commerce (SOGC). The opposition fee is CHF 800."
  - question: "What mistakes commonly lead to trademark refusal at IGE/IPI?"
    answer: "Descriptive marks, generic terms, and marks that are deceptive about geographic origin are the most frequent grounds for refusal. Filing in the wrong Nice class also causes delays and additional costs."
  - question: "Does IGE/IPI examine patent applications for novelty?"
    answer: "No. Swiss national patents undergo formal examination only. IGE/IPI checks formalities and grants the patent without assessing novelty, inventive step, or industrial applicability. This differs from the EPO process."
  - question: "How long does design protection last through IGE/IPI?"
    answer: "A Swiss design registration lasts 5 years from filing and can be renewed four times, giving a maximum protection period of 25 years. Renewal fees increase with each period."
tocItems:
  - id: "what-igeipi-does"
    title: "What IGE/IPI Does"
  - id: "trademark-registration-at-igeipi"
    title: "Trademark Registration at IGE/IPI"
  - id: "patent-registration-at-igeipi"
    title: "Patent Registration at IGE/IPI"
  - id: "design-registration-at-igeipi"
    title: "Design Registration at IGE/IPI"
  - id: "swissreg-igeipis-public-register-search-tool"
    title: "Swissreg: IGE/IPI's Public Register Search Tool"
  - id: "international-ip-protection-through-igeipi"
...
2. File trademark application online at ige.ch (eIAM portal)
3. IGE examines the application for formal requirements and absolute grounds for refusal
4. If accepted: published in Swissgazette (SHAB) for opposition (3-month opposition period)
5. If no opposition (or opposition dismissed): trademark registered; certificate issued
...
1. Visit swissreg.ch
2. Select "Trademarks" search
3. Search by: word/figurative mark, owner name, Nice class, application number, or date range
4. View registration status, goods/services covered, owner details, and documents
...
**Madrid System (WIPO) — International Trademarks:**
IGE/IPI is the office of origin for Swiss trademark holders extending internationally via the Madrid Protocol. A Swiss trademark registration is required as the base mark.

**Hague System (WIPO) — International Designs:**
IGE/IPI acts as the office of origin for Swiss design holders filing internationally.

**PCT Applications (WIPO) — International Patents:**
IGE/IPI accepts PCT applications for Swiss applicants. The application is then processed internationally by WIPO with national phase entries in desired countries.
...
*Sources: <a href="https://www.ige.ch/en" target="_blank" rel="nofollow noopener">IGE/IPI Official Website</a> | <a href="https://www.swissreg.ch" target="_blank" rel="nofollow noopener">Swissreg Public Database</a> | <a href="https://www.fedlex.admin.ch/eli/cc/1993/274_274_274/en" target="_blank" rel="nofollow noopener">Trademark Protection Act (MSchG) on Fedlex</a>*
