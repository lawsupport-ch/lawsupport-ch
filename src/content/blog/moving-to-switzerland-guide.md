...
tocItems:
  - id: "before-you-move-visa-and-entry-requirements"
    title: "Before You Move: Visa and Entry Requirements"
  - id: "immigration-routes-for-different-nationalities"
    title: "Immigration Routes for Different Nationalities"
  - id: "us-citizens-moving-to-switzerland"
    title: "US Citizens Moving to Switzerland"
  - id: "family-reunification"
    title: "Family Reunification"
  - id: "cost-of-living-what-to-expect"
    title: "Cost of Living: What to Expect"
  - id: "buying-property-as-a-foreigner"
    title: "Buying Property as a Foreigner"
  - id: "lex-koller-restrictions"
    title: "Lex Koller Restrictions"
  - id: "health-insurance-and-social-security"
    title: "Health Insurance and Social Security"
  - id: "banking-and-finances"
...
faqItems:
  ...
  - question: "What are the best cantons for foreigners to live in?"
    answer: "Zug offers the lowest tax rates and a large international community. Zurich has the broadest job market and infrastructure. Geneva and Vaud are French-speaking with strong international organisation presence. Basel is popular for pharmaceutical and life sciences professionals. Canton choice depends on language preference, employment, and tax situation."
  - question: "How long can I stay in Switzerland without a permit?"
    answer: "EU/EFTA nationals can stay up to 3 months without a permit (or up to 12 months if job-seeking). Non-EU nationals from visa-exempt countries can stay 90 days within any 180-day period under the Schengen rules. Any gainful activity — including remote work — requires a work permit regardless of duration."
  - question: "Do I need to learn German, French, or Italian before moving?"
    answer: "There is no language requirement for entry or initial permit issuance. However, language proficiency is required for the C permit and for naturalisation (B1 oral, A2 written). Practical life — banking, government services, healthcare — is easier with local language skills. English is widely spoken in business contexts in Zurich, Basel, and Geneva."
  - question: "What happens if I move to Switzerland and then want to leave?"
    answer: "You must deregister with the municipal residents' registration office (Einwohnerkontrolle) and return your permit. Failure to deregister can create tax complications. Social security contributions may be partially refundable depending on your nationality and the applicable social security agreement. Health insurance must be cancelled separately."
relatedArticles:
...
The route to [immigrating to Switzerland](/immigration/immigrate-to-switzerland/) depends on your citizenship, qualifications, and purpose of stay.
...
[US citizens immigrating to Switzerland](/immigration/immigrate-switzerland-from-us/) face specific considerations beyond the standard non-EU process:
...
[Family reunification in Switzerland](/immigration/family-reunification-switzerland/) allows permit holders to bring immediate family members:
...
The [cost of living in Switzerland](/immigration/cost-of-living-switzerland/) is among the highest in the world, but salaries are proportionally high.
...
[Buying property in Switzerland as a foreigner](/immigration/buying-property-switzerland-foreigner/) is possible but regulated. The rules differ based on your nationality and permit status:
...
The [Lex Koller Act](/immigration/lex-koller-switzerland/) (Bundesgesetz ueber den Erwerb von Grundstuecken durch Personen im Ausland, BewG) is the federal law restricting foreign purchase of Swiss residential property.
...
- [Property purchase](/immigration/buying-property-switzerland-foreigner/) guidance including [Lex Koller](/immigration/lex-koller-switzerland/) compliance
