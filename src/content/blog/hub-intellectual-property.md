---
title: "Intellectual Property in Switzerland: Trademarks, Patents & Protection"
...
faqItems:
  ...
  - question: "Does Switzerland examine patents substantively?"
  ...
  - question: "Do I need to register copyright in Switzerland?"
    answer: "No. Copyright arises automatically upon creation of a work under the Swiss Copyright Act (URG/LDA). There is no copyright register in Switzerland. Protection covers literary, artistic, and scientific works including software, databases, photographs, music, and films. Protection lasts 70 years after the author death (50 years for software). Proving authorship and creation date is the practical challenge in disputes."
  - question: "Can I extend Swiss trademark protection internationally?"
    answer: "Yes, through the Madrid Protocol administered by WIPO. You file an international application through IGE/IPI designating the countries where you want protection. Each designated country examines the mark under its own law. The Madrid system covers over 130 countries. Alternatively, you can file separate national applications in each country, which gives more control but increases costs and administrative burden."
  - question: "What is the patent box tax regime?"
    answer: "The Swiss patent box allows qualifying companies to receive a tax reduction of up to 90% on income derived from patents and comparable rights. Introduced under the STAF reform (effective 1 January 2020), it applies at cantonal level using the OECD modified nexus approach. This ties the benefit to the company own R&D expenditure. The federal tax rate (8.5%) is not reduced by the patent box."
  - question: "How do I enforce IP rights in Switzerland?"
    answer: "Trademark enforcement is handled by cantonal civil courts through injunctions, damages claims, and destruction of infringing goods. Criminal proceedings are also possible under the Trademark Protection Act (MSchG). Patent disputes go to the Federal Patent Court in St. Gallen, which has exclusive jurisdiction since 2012. Preliminary injunctions can be obtained within days in urgent cases. The losing party generally bears the winning party legal costs."
  - question: "What is the IGE/IPI?"
    answer: "The Swiss Federal Institute of Intellectual Property (IGE/IPI), based in Bern, is Switzerland national IP office. It administers trademark, patent, and design registrations; provides IP information services through the Swissreg database; represents Switzerland in international IP organisations (WIPO, EPO); and advises the government on IP policy. All Swiss IP applications are filed through IGE/IPI."
  - question: "Do I need separate IP registrations for Switzerland and the EU?"
...
tocItems:
  - id: "swiss-ip-protection-overview"
  ...
  - id: "copyright-and-related-rights"
    title: "Copyright and Related Rights"
  - id: "building-an-ip-strategy"
    title: "Building an IP Strategy"
  - id: "international-ip-protection-from-switzerland"
    title: "International IP Protection from Switzerland"
  - id: "ip-enforcement-in-switzerland"
    title: "IP Enforcement in Switzerland"
  - id: "tax-benefits-for-ip-holders"
...
For detailed guidance on using IGE/IPI's services, see our [trademark and design protection guide](/intellectual-property/trademark-design-protection-switzerland/).
...
1. **Prior art search**: Search Swissreg and international databases to identify conflicting marks
2. **Application filing**: Submit the application to IGE/IPI with a clear representation of the mark and a list of goods/services
3. **Formal examination**: IGE/IPI checks formal requirements (2-4 weeks)
4. **Publication**: The mark is published in the official gazette
5. **Opposition period**: Third parties have 3 months to oppose the registration
6. **Registration**: If no opposition or after successful defence, the mark is registered
...
Our [trademark and design protection guide](/intellectual-property/trademark-design-protection-switzerland/) covers the registration process in full detail, including costs, common pitfalls, and enforcement options.
...
Strategic use of overlapping rights strengthens protection. For guidance on coordinating design registration with other IP rights, see our [trademark and design protection guide](/intellectual-property/trademark-design-protection-switzerland/).
...
This creates a significant incentive for R&D-intensive businesses to establish IP-holding functions in Switzerland. For detailed guidance on patent filing, prosecution, and the patent box, see our [patents and IP strategy guide](/intellectual-property/patents-ip-strategy-switzerland/).
...
Our [patents and IP strategy guide](/intellectual-property/patents-ip-strategy-switzerland/) provides a framework for building an IP portfolio that serves both protective and commercial objectives.
