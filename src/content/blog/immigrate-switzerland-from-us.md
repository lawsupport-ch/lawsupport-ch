...
faqItems:
  ...
  - question: "What is the typical cost of immigrating to Switzerland from the US?"
    answer: "Budget CHF 10,000 to 25,000 for immigration legal fees, plus CHF 3,000 to 5,000 for permit application costs. If establishing a Swiss company, add CHF 20,000 to 50,000 for incorporation and initial capitalisation."
  - question: "Which Swiss cantons are most welcoming to American immigrants?"
    answer: "Zug, Schwyz, and Nidwalden actively attract international residents through low tax rates and efficient administration. Geneva and Vaud have larger English-speaking communities but higher living costs and tax rates."
  - question: "How does FATCA affect Americans living in Switzerland?"
    answer: "Swiss banks must report account details of US persons to the IRS under FATCA. This creates practical difficulties: many banks refuse US clients, and those that accept them charge higher compliance fees."
  - question: "Can I bring my pet to Switzerland from the US?"
    answer: "Yes, but dogs, cats, and ferrets require a microchip, valid rabies vaccination at least 21 days before entry, and an EU-format health certificate issued by a USDA-accredited veterinarian."
  - question: "What is lump-sum taxation and do Americans qualify?"
    answer: "Lump-sum taxation (forfait fiscal) taxes wealthy foreign residents on living expenses rather than actual income. Americans technically qualify, but US worldwide taxation obligations mean the benefit is limited compared to other nationalities."
tocItems:
  - id: "why-americans-face-a-unique-situation"
    title: "Why Americans Face a Unique Situation"
  - id: "route-1-employment-based-immigration-the-most-common-path"
    title: "Route 1: Employment-Based Immigration (The Most Common Path)"
  - id: "route-2-self-employment-difficult-not-impossible"
    title: "Route 2: Self-Employment (Difficult, Not Impossible)"
  - id: "route-3-retirement-and-passive-income-lump-sum-taxation"
    title: "Route 3: Retirement and Passive Income — Lump-Sum Taxation"
  - id: "route-4-family-reunification"
    title: "Route 4: Family Reunification"
  - id: "fatca-and-swiss-bank-accounts-a-practical-obstacle"
    title: "FATCA and Swiss Bank Accounts: A Practical Obstacle"
  - id: "us-tax-obligations-do-not-stop-at-the-border"
    title: "US Tax Obligations Do Not Stop at the Border"
  - id: "the-renunciation-question"
    title: "The Renunciation Question"
  - id: "practical-immigration-timeline"
...
2. Employer submits work permit application to cantonal authority — **week 1**
3. Priority check and cantonal review — **weeks 2 to 8**
4. Permit approval and federal confirmation — **weeks 8 to 16**
5. D visa application at Swiss consulate in the US — **add 2 to 4 weeks**
