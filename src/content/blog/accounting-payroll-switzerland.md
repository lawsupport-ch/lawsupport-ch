...
tocItems:
  - id: "the-swiss-back-office-framework"
    title: "The Swiss Back-Office Framework"
  - id: "accounting-standards-and-legal-requirements"
    title: "Accounting Standards and Legal Requirements"
  - id: "bookkeeping-rules"
    title: "Bookkeeping Rules"
  - id: "statutory-audit-requirements"
    title: "Statutory Audit Requirements"
  - id: "payroll-in-switzerland"
    title: "Payroll in Switzerland"
  - id: "social-insurance-system"
    title: "Social Insurance System"
  - id: "employer-registration"
    title: "Employer Registration"
  - id: "stamp-duty"
    title: "Stamp Duty"
  - id: "withholding-tax-on-employment-income"
    title: "Withholding Tax on Employment Income"
  - id: "accounting-recovery-and-catch-up"
    title: "Accounting Recovery and Catch-Up"
faqItems:
  - question: "What accounting standards must Swiss companies follow?"
    answer: "All Swiss companies must prepare financial statements under the Code of Obligations (OR, Art. 957-963). Larger companies (revenue above CHF 500'000) must apply recognised standards: Swiss GAAP FER, IFRS, or US GAAP. Listed companies must use IFRS or US GAAP. Small companies may use simplified accounting."
  - question: "When is a statutory audit required in Switzerland?"
    answer: "An ordinary audit is required if the company exceeds two of three thresholds in two consecutive years: total assets CHF 20 million, revenue CHF 40 million, or 250 full-time employees. Smaller companies undergo a limited audit (review). Companies with fewer than 10 FTEs may opt out of audit entirely with unanimous shareholder consent."
  - question: "What are the employer social insurance contributions in Switzerland?"
    answer: "Employers contribute approximately 6.4% of gross salary for AHV/IV/EO, 1.1% for ALV (unemployment insurance, on salary up to CHF 148'200), plus occupational pension (BVG) contributions that vary by age and plan. Total employer social insurance cost typically runs 12-18% of gross salary."
  - question: "How does Swiss payroll work for foreign employees?"
    answer: "Foreign employees without C permit are subject to withholding tax at source (Quellensteuer). The employer deducts tax directly from salary based on cantonal tariff tables. The employee does not file a tax return unless their gross salary exceeds CHF 120'000 per year, in which case a quasi-resident assessment applies."
  - question: "What is the BVG minimum coordination deduction?"
    answer: "The BVG coordination deduction for 2026 is CHF 25'725 (7/8 of the maximum AHV pension). Only salary above this amount is subject to mandatory occupational pension contributions. The insured salary is capped at CHF 62'475 under the BVG minimum. Many employers provide supra-mandatory coverage above these limits."
  - question: "Must every Swiss company register with the compensation office?"
    answer: "Yes. Every employer must register with a cantonal AHV compensation office (Ausgleichskasse) before paying the first salary. This registration is separate from commercial register entry. Sole proprietors without employees must also register if their annual income exceeds CHF 2'300."
  - question: "What is stamp duty in Switzerland?"
    answer: "Swiss stamp duty (Stempelabgabe) has three components: issuance stamp on share capital (1% on equity above CHF 1 million), transfer stamp on securities transactions (0.15% domestic, 0.3% foreign), and insurance premium stamp (5% on certain premiums). The issuance stamp applies at incorporation and capital increases."
  - question: "How long must Swiss companies retain accounting records?"
    answer: "Swiss law requires retention of business correspondence and accounting records for 10 years from the end of the financial year. This includes the annual report, audit report, all bookkeeping entries, supporting vouchers (invoices, receipts, bank statements), and the inventory. Electronic storage is permitted if the records remain readable."
  - question: "What happens if a company misses payroll tax deadlines?"
    answer: "Late payment of withholding tax (Quellensteuer) triggers interest charges and potential fines. The employer is liable for the tax — it cannot be passed to the employee retroactively. Late AHV contributions incur 5% annual interest. Persistent non-compliance may result in director personal liability under social insurance law."
  - question: "Can a Swiss company outsource its entire back-office?"
    answer: "Yes. Accounting, payroll, tax filing, and HR administration can all be outsourced to a licensed fiduciary or accounting firm. The legal responsibility remains with the company's board of directors — outsourcing does not transfer liability. Many SMEs outsource all back-office functions except strategic decisions."
relatedArticles:
  - title: "Swiss Corporate Tax: Rates, Returns & Cantonal Comparison"
    href: "/tax-accounting/corporate-tax-overview-switzerland/"
...
1. **Accounting**: Financial statements under OR/CO, applying Swiss GAAP FER or IFRS for larger entities
2. **Bookkeeping**: Day-to-day recording of transactions under OR Art. 957-958
3. **Audit**: Ordinary, limited, or opt-out depending on company size
4. **Payroll**: Salary calculation, deductions, and payment
5. **Social insurance**: AHV/IV/EO, ALV, BVG, UVG — contributions split between employer and employee
6. **Employer registration**: With the cantonal compensation office, pension fund, and accident insurer
7. **Taxes on capital**: Stamp duty on equity issuance and securities transactions
8. **Withholding tax**: On salaries of foreign employees without C permit
...
The relationship between [accounting and tax](/tax-accounting/accounting-tax-switzerland/) in Switzerland is direct: taxable profit is derived from the statutory financial statements. Unlike some jurisdictions where tax accounts differ from commercial accounts, Swiss tax law uses the commercial balance sheet as the starting point (Massgeblichkeitsprinzip). This makes the quality of accounting directly relevant to the tax position.

---

## Bookkeeping Rules

[Bookkeeping in Switzerland](/tax-accounting/bookkeeping-switzerland/) must follow the principles set out in OR Art. 957a:
...
Swiss law distinguishes three audit regimes, and the rules are covered in detail in our guide to [statutory audit in Switzerland](/tax-accounting/audit-switzerland/):
...
[Payroll](/tax-accounting/payroll-switzerland/) in Switzerland involves several mandatory deductions from gross salary:
...
The [Swiss social insurance system](/tax-accounting/social-insurance-switzerland/) rests on three pillars:
...
Every company that employs staff must complete [employer registration](/tax-accounting/employer-registration-switzerland/) with multiple bodies:

1. **AHV compensation office** (Ausgleichskasse): Register before the first salary payment. The company is assigned an employer number and must remit AHV/IV/EO/ALV contributions quarterly or monthly.

2. **Occupational pension fund** (BVG): Join a pension foundation within three months of employing the first person subject to BVG. Options include industry foundations, collective foundations, or company-specific foundations.

3. **Accident insurer** (UVG): Register with SUVA (mandatory for certain industries — construction, manufacturing, transport) or a private insurer. Coverage must be in place from the first day of employment.

4. **Cantonal tax authority**: Register for withholding tax (Quellensteuer) if employing foreign nationals without C permit. The employer is responsible for deducting and remitting the tax.

5. **Family allowance fund** (FAK/CAF): Register with the cantonal family allowance fund to remit contributions and process family allowance payments for employees with children.
...
Swiss [stamp duty](/tax-accounting/stamp-duty-switzerland/) (Stempelabgabe) consists of three separate taxes:
...
[Withholding tax](/tax-accounting/withholding-tax-switzerland/) on employment income (Quellensteuer) applies to employees who:
...
Our guide to [accounting recovery in Switzerland](/tax-accounting/accounting-recovery-switzerland/) covers the reconstruction process in detail: how to rebuild accounts from bank statements, file overdue returns, settle accumulated interest, and restore the company to good standing.
...
The FAQ section above addresses the ten most common questions about Swiss accounting, payroll, and social insurance. For specific advice on your company's back-office obligations, [contact Morgan Hartley Consulting](/contacts/) for a confidential discussion.
