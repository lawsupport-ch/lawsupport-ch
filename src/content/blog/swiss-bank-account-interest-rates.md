...
faqItems:
  ...
  - question: "How do Swiss savings rates compare to EU bank rates?"
    answer: "Swiss franc savings rates are typically 0.5-1.5 percentage points lower than eurozone equivalents. This reflects the CHF safe-haven premium and lower SNB policy rate. Holding EUR in a Swiss bank account may yield rates closer to ECB benchmarks, but currency risk applies."
  - question: "Can I negotiate a better interest rate with my Swiss bank?"
    answer: "Yes, for deposits above CHF 250,000. Banks have internal pricing tiers and relationship managers can offer preferential rates for larger balances. Private banks are more flexible than cantonal or retail banks on rate negotiations."
  - question: "What is the difference between a savings account and a fixed deposit in Switzerland?"
    answer: "A savings account (Sparkonto) offers instant access with variable rates, typically 0.25-0.75% in 2026. A fixed deposit (Festgeld) locks funds for 3-24 months at a higher fixed rate, usually 0.50-1.25%. Early withdrawal from fixed deposits incurs penalties."
  - question: "Do corporate accounts earn interest in Switzerland?"
    answer: "Most Swiss corporate current accounts pay zero interest. Some banks offer overnight sweep accounts or short-term deposit options for excess corporate liquidity. Treasury management becomes relevant for companies holding CHF 500,000 or more in cash."
  - question: "How does Swiss withholding tax affect interest earnings?"
    answer: "Swiss withholding tax (Verrechnungssteuer) at 35% is automatically deducted from interest payments. Swiss tax residents reclaim this in full through their annual tax return. Non-residents may reclaim part or all under applicable double taxation treaties, but the process takes 6-18 months."
tocItems:
  - id: "snb-policy-rate-and-its-effect-on-savings-rates"
    title: "SNB Policy Rate and Its Effect on Savings Rates"
  - id: "current-chf-savings-account-rates-2026"
    title: "Current CHF Savings Account Rates (2026)"
  - id: "fixed-deposits-festgeld-depots-a-terme"
    title: "Fixed Deposits (Festgeld / Depots a terme)"
  - id: "notice-accounts-kuendigungskonto"
    title: "Notice Accounts (Kuendigungskonto)"
  - id: "chf-interest-on-corporate-accounts"
    title: "CHF Interest on Corporate Accounts"
  - id: "eur-accounts-in-swiss-banks"
    title: "EUR Accounts in Swiss Banks"
  - id: "usd-accounts-in-swiss-banks"
    title: "USD Accounts in Swiss Banks"
  - id: "negative-interest-rates-history-and-risk"
    title: "Negative Interest Rates: History and Risk"
  - id: "maximising-returns-on-swiss-franc-cash"
...
Yes — <a href="https://www.esisuisse.ch/en" target="_blank" rel="nofollow noopener">esisuisse</a> guarantees CHF 100'000 per depositor per bank. Cantonal banks with state guarantees (Staatsgarantie) provide additional protection.
