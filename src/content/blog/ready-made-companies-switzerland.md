...
tocItems:
  ...
  - id: "shelf-companies-in-switzerland"
    title: "Shelf Companies in Switzerland"
  - id: "shelf-vs-fresh-formation"
    title: "Shelf vs Fresh Formation"
  - id: "nominee-director-services"
    title: "Nominee Director Services"
  - id: "nominee-shareholder-arrangements"
    title: "Nominee Shareholder Arrangements"
  - id: "holding-company-structures"
    title: "Holding Company Structures"
  - id: "legal-framework-and-compliance"
    title: "Legal Framework and Compliance"
  - id: "costs-and-timelines"
    title: "Costs and Timelines"
  - id: "risk-factors-and-due-diligence"
...
relatedArticles:
  ...
  - title: "Company Lifecycle in Switzerland: Liquidation, Bankruptcy & Debt Collection"
    href: "/company-formation/company-lifecycle-switzerland/"
...
Each serves a different need, and they are often combined. A foreign investor might purchase a [shelf company](/company-formation/shelf-company-switzerland/), appoint a [nominee director](/company-formation/nominee-services-switzerland/), use [nominee shareholders](/company-formation/nominee-shareholder-switzerland/) for privacy, and position the entity within a [holding structure](/company-formation/holding-company-switzerland/) for tax efficiency.

## Shelf Companies in Switzerland

A [shelf company](/company-formation/shelf-company-switzerland/) (also called a ready-made or off-the-shelf company) is an AG or GmbH that was incorporated and registered but never traded. It sits on a "shelf" maintained by a formation agent or law firm until a buyer comes along.
...
|---|---|---|
| **Time to operate** | 5–10 business days | 3–6 weeks |
| **Cost** | CHF 7,000–30,000 + capital | CHF 3,000–8,000 + capital |
| **Customisation** | Post-purchase amendments needed | Fully customised from day one |
| **History** | Has a formation date (possibly months/years old) | Brand new |
| **Risk** | Requires due diligence | No legacy risk |
| **Name choice** | Must change from shelf name | Choose your name from start |
...
[Nominee director services](/company-formation/nominee-services-switzerland/) satisfy this requirement for foreign owners who do not reside in Switzerland. A professional nominee — typically a lawyer, fiduciary, or corporate services provider — is appointed to the board or as managing director.
...
A [nominee shareholder](/company-formation/nominee-shareholder-switzerland/) holds shares or quotas on behalf of the beneficial owner. The shares are legally registered in the nominee's name, but the economic benefit belongs to the beneficial owner under a separate trust agreement.

### Legal Requirements Since 2015/2019
...
A [Swiss holding company](/company-formation/holding-company-switzerland/) is a standard AG or GmbH whose primary purpose is holding participations in other companies. Switzerland offers significant tax advantages for qualifying holding structures.
...
|---|---|---|
| Shelf company purchase | CHF 5,000–25,000 | 5–10 business days |
| Nominee director (annual) | CHF 3,000–10,000 | Immediate appointment |
| Nominee shareholder (annual) | CHF 2,000–5,000 | Immediate arrangement |
| Holding company setup | CHF 5,000–15,000 | 3–6 weeks (fresh) or 5–10 days (shelf) |
| Name change | CHF 1,500–3,000 | 10–15 business days |
| Purpose amendment | CHF 1,000–2,000 | 10–15 business days |
