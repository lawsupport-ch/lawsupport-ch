...
faqItems:
  - question: "Can I open a Swiss bank account before moving to Switzerland?"
    answer: "Traditional Swiss banks generally require a Swiss address or in-person visit. For pre-arrival, options are limited: Revolut can provide a CHF IBAN usable for some purposes, but it is not a Swiss bank. Upon arrival and commune registration, local account opening is quick — within 1–2 weeks."
  - question: "What is the fastest way to open a Swiss bank account?"
    answer: "For Swiss residents: Neon or Yuh — a CHF account with Mastercard can be operational within 24–48 hours of completing video KYC via the app."
  - question: "Do Swiss online accounts have deposit protection?"
    answer: "Neobanks backed by Swiss licensed banks (Neon via Hypothekarbank Lenzburg, Yuh via Swissquote) have <a href=\"https://www.esisuisse.ch/en\" target=\"_blank\" rel=\"nofollow noopener\">esisuisse</a> deposit protection up to CHF 100,000. Revolut (Lithuanian bank) falls under Lithuanian DGS."
  - question: "Is it safe to use a Swiss neobank instead of a traditional bank?"
    answer: "Swiss neobanks such as Neon and Yuh operate through partnerships with FINMA-licenced banks, so your deposits receive the same esisuisse protection as traditional bank accounts. The key difference is service scope — neobanks focus on payments and everyday banking, while traditional banks offer mortgages, investment advisory, and broader product ranges."
  - question: "Can a non-EU citizen open a Swiss bank account online?"
    answer: "Non-EU citizens who are Swiss residents can open accounts at most neobanks and traditional banks via video KYC. Non-EU citizens without Swiss residency face very limited online options — a corporate account through a Swiss company formation is typically the most practical route."
  - question: "What are the fees for Swiss online bank accounts?"
    answer: "Swiss neobanks like Neon charge CHF 0 for the basic account and CHF 5/month for premium. Yuh is free with pay-per-use pricing. Traditional banks offering online opening (ZKB, PostFinance) charge CHF 3-8/month. Corporate online accounts at Relio cost CHF 249/month flat."
  - question: "Can I receive salary payments into a Swiss online bank account?"
    answer: "Yes. Neon and Yuh provide full Swiss IBAN numbers that employers can use for salary transfers. Some employers may initially question a neobank IBAN, but legally there is no difference from a traditional bank account for payroll purposes."
  - question: "How secure are Swiss neobank apps compared to traditional banks?"
    answer: "Swiss neobanks use biometric authentication, device binding, and transaction verification comparable to traditional banks. The key security difference is that neobank deposits are held with the partner bank (e.g., Hypothekarbank Lenzburg for Neon) and are protected up to CHF 100,000 under esisuisse."
  - question: "Can I open multiple Swiss bank accounts online?"
    answer: "Yes. There is no legal limit on the number of Swiss bank accounts you can hold. Many residents maintain both a neobank account for daily spending and a traditional bank account for savings or mortgage purposes. Each account is separately protected under esisuisse up to CHF 100,000."
  - question: "What happens if a Swiss neobank goes out of business?"
    answer: "Your deposits remain safe with the underlying licensed bank (e.g., Hypothekarbank Lenzburg for Neon, Swissquote for Yuh). If the neobank ceases operations, the partner bank manages the transition. Historical precedent exists — when Moneypark restructured, client funds were unaffected because they were held at the partner institution."
tocItems:
  - id: "who-can-open-a-swiss-bank-account-online"
    title: "Who Can Open a Swiss Bank Account Online?"
  - id: "swiss-digital-neobanks-fully-online"
    title: "Swiss Digital / Neobanks (Fully Online)"
  - id: "traditional-swiss-banks-with-onlineremote-opening"
    title: "Traditional Swiss Banks with Online/Remote Opening"
  - id: "non-residents-online-options"
    title: "Non-Residents: Online Options"
  - id: "required-documents-for-online-account-opening"
...
**Currency:** CHF
**Features:** CHF current account, Mastercard, free ATM withdrawals, mobile banking
**Monthly fee:** CHF 0 (free basic account) or CHF 5 (neon green, with 1% cash back)
**Limitation:** Not available to non-residents; no savings products

### Yuh (Swissquote + PostFinance joint venture)

**Who:** Swiss residents
**Open online:** Yes — full app-based onboarding
**Currency:** CHF, EUR, USD, and 15 cryptocurrencies
**Features:** Current account, investment account, crypto trading, Mastercard
**Monthly fee:** CHF 0
...
**Open online:** Yes — app-based, minutes
**Currency:** 30+ currencies including CHF
...
Neobanks backed by Swiss licensed banks (Neon via Hypothekarbank Lenzburg, Yuh via Swissquote) have <a href="https://www.esisuisse.ch/en" target="_blank" rel="nofollow noopener">esisuisse</a> deposit protection up to CHF 100,000. Revolut (Lithuanian bank) falls under Lithuanian DGS.
