...
tocItems:
  - id: "why-swiss-corporate-banking-is-different"
    title: "Why Swiss Corporate Banking Is Different"
  - id: "what-swiss-banks-actually-check-kyc-requirements"
    title: "What Swiss Banks Actually Check: KYC Requirements"
  - id: "types-of-swiss-banks-which-one-fits-your-business"
    title: "Types of Swiss Banks: Which One Fits Your Business"
  - id: "the-capital-deposit-account-kapitaleinzahlungskonto"
    title: "The Capital Deposit Account (Kapitaleinzahlungskonto)"
  - id: "why-swiss-banks-reject-corporate-account-applications"
    title: "Why Swiss Banks Reject Corporate Account Applications"
  - id: "a-real-case-three-weeks-from-rejection-to-approval"
    title: "A Real Case: Three Weeks from Rejection to Approval"
  - id: "multi-currency-accounts-for-swiss-companies"
    title: "Multi-Currency Accounts for Swiss Companies"
  - id: "timeline-what-to-expect-in-2026"
    title: "Timeline: What to Expect in 2026"
  - id: "our-banking-introduction-service"
...
The extract from the Swiss Commercial Register (Handelsregisterauszug) must be current and, for many banks, apostilled or certified. For foreign entities in the ownership chain, equivalent foreign registry extracts are required — again, certified. You can verify Swiss register data at <a href="https://www.zefix.ch" target="_blank" rel="nofollow noopener">zefix.ch</a>.
