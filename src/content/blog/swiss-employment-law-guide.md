---
title: "Swiss Employment Law: Contracts, Termination & Working Conditions"
...
tocItems:
  - id: "swiss-employment-law-framework"
    title: "Swiss Employment Law Framework"
  - id: "employment-contracts"
    title: "Employment Contracts"
  - id: "probationary-period-and-fixed-term-contracts"
    title: "Probationary Period and Fixed-Term Contracts"
  - id: "working-hours-and-rest-periods"
    title: "Working Hours and Rest Periods"
  - id: "termination-of-employment"
    title: "Termination of Employment"
  - id: "protection-against-unfair-dismissal"
    title: "Protection Against Unfair Dismissal"
  - id: "overtime-and-compensation"
    title: "Overtime and Compensation"
  - id: "collective-labour-agreements"
    title: "Collective Labour Agreements"
...
This guide covers the key elements of Swiss employment law: [employment contracts](/employment-law/employment-contract-switzerland/), [termination rules](/employment-law/termination-employment-switzerland/), [working hours](/employment-law/working-hours-switzerland/), and the broader [employment law framework](/employment-law/employment-law-switzerland/). For company formation and employer registration, see our [formation guide](/company-formation/company-formation-switzerland/).
...
[Employment contracts in Switzerland](/employment-law/employment-contract-switzerland/) can be oral or written, though written contracts are standard practice.
...
Certain provisions are only valid if agreed in writing:
...
The first month of employment is automatically a probationary period under Swiss law, unless the contract excludes it. The parties can extend the probation to up to 3 months by written agreement.
...
The [working hours framework](/employment-law/working-hours-switzerland/) in Switzerland is governed by the Labour Act (ArG):
...
**Public holidays:**
Swiss public holidays vary by canton. The only national public holiday is 1 August (Swiss National Day). Each canton designates 8-15 additional public holidays. Employers must check the applicable cantonal holiday calendar.

---

## Termination of Employment

[Employment termination in Switzerland](/employment-law/termination-employment-switzerland/) follows the principle of freedom of termination (Kuendigungsfreiheit):

**Ordinary termination (ordentliche Kuendigung):**
Either party can terminate with notice. No reason is required.
...
**Extraordinary termination (fristlose Kuendigung):**
Either party can terminate immediately for good cause (wichtiger Grund) under Art. 337 OR. Good cause exists when circumstances make it unreasonable to continue the employment relationship. Examples: theft, fraud, persistent refusal to work, serious breach of duty. Wrongful immediate termination triggers damages.

**Protection against termination during protected periods (Art. 336c OR):**
Termination by the employer is void (nichtig) if given during:
...
**Consequences of abusive dismissal:**
An abusive termination is **not void** — it remains effective, and the employment ends on the notice date. However, the employee is entitled to compensation of up to **6 months' salary** (in practice, courts typically award 2-4 months). The employee must file an objection (Einsprache) before the end of the notice period and bring a court claim within 180 days thereafter.

**Mass layoffs (Massenentlassung):**
If an employer plans to dismiss at least 10 employees (in companies with 20-99 employees) or at least 10% of the workforce (in companies with 100-299 employees) or at least 30 employees (in companies with 300+ employees) within 30 days, the employer must follow the mass layoff consultation procedure: inform employees, consult with employee representatives, and notify the cantonal employment office (RAV).

---

## Overtime and Compensation

**Overtime under the OR (Art. 321c):**
Overtime (Ueberstunden) is work performed beyond the contractually agreed hours but within the statutory maximum. The employee must perform overtime if it is necessary and they are reasonably able to do so.
...
**How GAVs work:**
A GAV is negotiated between an employer association and one or more trade unions. It sets minimum employment conditions for the sector — wages, working hours, holidays, overtime rules, training contributions, and pension arrangements.

**Generally binding GAVs:**
The Federal Council can declare a GAV generally binding (allgemeinverbindlich) at the request of the contracting parties. This means the GAV applies to **all** employers and employees in the sector, regardless of whether they are members of the signatory organisations.
...
Return to our [Employment Law in Switzerland](/employment-law/) hub for related guides and services.
