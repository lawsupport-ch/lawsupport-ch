...
readTime: "8 min read"
faqItems:
  - question: "Can I work as self-employed in Switzerland without a work permit?"
    answer: "EU/EFTA nationals can register as self-employed in Switzerland under the Agreement on the Free Movement of Persons and do not need a separate work permit — they apply for a residence permit (B or C) that includes the right to work as self-employed. Non-EU/EEA nationals need an explicit work permit for self-employed activity, which requires cantonal approval and is subject to quotas."
  - question: "What income do I need to demonstrate to get a self-employed work permit in Switzerland?"
    answer: "There is no fixed statutory minimum, but the canton must be satisfied that the self-employed activity will generate sufficient income to support the applicant without recourse to social assistance. In practice, most cantons look for a projected annual income of CHF 50,000–80,000 from the self-employed activity, supported by client contracts, business plan projections, and professional qualifications."
  - question: "How long does it take to get a Swiss self-employment permit?"
    answer: "For EU/EFTA nationals: registration as self-employed typically takes 2 to 6 weeks after submitting the cantonal application. For non-EU nationals: the cantonal and federal process takes 3 to 6 months, as applications must be approved at cantonal level and then by the State Secretariat for Migration (SEM) in Bern, and are subject to the annual quota system."
  - question: "What is the difference between a B permit and a C permit for the self-employed?"
    answer: "The B permit is an initial residence permit, valid for 1 year (EU/EFTA) or as specified for non-EU nationals, and renewable. The C permit is a permanent residence permit that grants the same rights as Swiss citizens for employment and self-employment. EU/EFTA nationals can apply for the C permit after 5 years of legal residence. Non-EU nationals generally need 10 years. The C permit has no restrictions on self-employed activity."
  - question: "Can I register a Swiss company instead of working as a sole trader?"
    answer: "Yes. Registering a GmbH or AG and appointing yourself as director/managing director is an alternative to sole trader self-employment. You would be employed by your own company, which requires a work permit as an employee (simpler in some cases) rather than as a self-employed person. However, the company must have a Swiss-resident director, and you still need a residence and work permit to work in Switzerland."
  - question: "Are there quotas for self-employed permits for non-EU nationals?"
...
tocItems:
  - id: "eu-efta-nationals-simplified-rules"
    title: "EU/EFTA Nationals: Simplified Rules"
  - id: "non-eu-non-efta-nationals-quota-system"
    title: "Non-EU/EEA Nationals: Quota System"
  - id: "proving-your-self-employed-activity-is-genuine"
    title: "Proving Your Self-Employed Activity Is Genuine"
  - id: "documents-required"
    title: "Documents Required"
  - id: "registering-as-self-employed-with-the-ahv"
    title: "Registering as Self-Employed with the AHV"
  - id: "self-employed-vs-forming-a-swiss-company"
    title: "Self-Employed vs Forming a Swiss Company"
  - id: "common-mistakes-and-pitfalls"
    title: "Common Mistakes and Pitfalls"
relatedArticles:
  - title: "B Permit Switzerland: Application Requirements"
    href: "/immigration/b-permit-switzerland/"
  - title: "Opening a Company in Switzerland as a Foreigner"
    href: "/company-formation/open-company-in-switzerland-foreigners/"
  - title: "Moving to Switzerland: Practical Guide"
...
Citizens of EU and EFTA member states benefit from the <a href="https://www.sem.admin.ch/sem/en/home/themen/fza.html" target="_blank" rel="nofollow noopener">Agreement on the Free Movement of Persons (FZA)</a> between Switzerland and the EU/EFTA. This agreement grants EU/EFTA nationals the right to live and work in Switzerland — including as self-employed persons — without needing a specific work permit approval.
...
| Lease agreement or proof of accommodation | Swiss address required before permit is issued |
| Business plan | In the cantonal language (German, French, or Italian depending on canton) |
| Client contracts or letters of intent | Signed where possible |
| Professional qualifications / CV | Translated if not in cantonal language |
| Evidence of financial resources | Bank statements for the last 3–6 months |
| Criminal record extract | From country of origin and any country of residence in last 5 years |
| Health insurance confirmation | Swiss mandatory health insurance (KVG) required |
...
| Factor | Sole trader (Einzelfirma) | Swiss GmbH with salaried director |
|---|---|---|
| Personal liability | Unlimited | Limited to company assets |
| Share capital required | None | CHF 20,000 (GmbH) |
| AHV/IV contributions | ~10% of net income | Employee rate (~5.3%) — employer pays other half |
| Work permit type | Self-employment permit | Employment permit (often simpler) |
| Bookkeeping | Simple (if revenue < CHF 500,000) | Full double-entry required |
| VAT registration threshold | CHF 100,000 | CHF 100,000 (same) |

For many service professionals with consistent revenue above CHF 100,000/year, the GmbH structure provides better liability protection, more flexible profit extraction, and — when structured correctly — lower effective tax. See our [GmbH formation guide](/company-formation/gmbh-formation-switzerland/) for the full analysis.
...
[Request a Free Assessment](/contacts/) to discuss your specific immigration situation.

- **Phone:** +41 44 51 52 592
- **Email:** info@lawsupport.ch
- **Address:** Baarerstrasse 135, 6300 Zug, Switzerland

For the employee permit process, see our [work permit guide](/immigration/b-permit-switzerland/). For the company formation alternative, see our [opening a company as a foreigner](/company-formation/open-company-in-switzerland-foreigners/) guide.
