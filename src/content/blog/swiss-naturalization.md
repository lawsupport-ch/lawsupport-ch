...
faqItems:
  ...
  - question: "Can I count years spent in Switzerland as a child towards naturalisation?"
    answer: "Yes. Years spent in Switzerland between ages 8 and 18 count double towards the ten-year residence requirement. A child who spent five years in Switzerland during school (ages 8 to 13) would accumulate ten qualifying years, potentially reaching eligibility earlier in adulthood."
  - question: "What is a Gemeindeversammlung and should I attend?"
    answer: "A Gemeindeversammlung is a communal assembly where residents vote on local matters. Attending these meetings demonstrates genuine civic engagement and is viewed favourably by communes assessing naturalisation applications. In some communes, attendance records are checked as part of the integration assessment."
  - question: "Can I reapply after my naturalisation application is rejected?"
    answer: "Yes. Commune rejections are not permanent. You may reapply after addressing the specific gaps identified — typically insufficient local integration, inadequate language skills, or unresolved financial issues. Most communes recommend waiting at least twelve months before resubmitting."
  - question: "Do I need to pass a written citizenship test?"
    answer: "This varies by canton and commune. Some communes administer a formal written test covering Swiss civics, history, and local knowledge. Others assess integration through an interview only. The federal law does not mandate a standardised written test, so requirements differ across Switzerland."
  - question: "Is military service required before applying for naturalisation?"
    answer: "No. Military service is not a prerequisite for naturalisation. However, once you become Swiss, male citizens of military age are subject to Swiss military service obligations or must pay the military service exemption tax (Militaerpflichtersatzabgabe)."
  - question: "Does changing cantons reset my naturalisation timeline?"
    answer: "Moving to a new canton does not reset the federal ten-year residence requirement — those years accumulate nationally. However, many cantons require a minimum period of cantonal residence (typically two to three years) before accepting a naturalisation application, which can add time to the process."
  - question: "Can self-employed individuals apply for Swiss naturalisation?"
    answer: "Yes. Self-employment does not disqualify you from naturalisation. The key requirement is financial independence — you must not be receiving social welfare. Self-employed applicants should be prepared to demonstrate stable income through tax returns and business records."
tocItems:
