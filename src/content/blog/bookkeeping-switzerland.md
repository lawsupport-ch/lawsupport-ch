...
tocItems:
  ...
  - id: "double-entry-vs-simplified-bookkeeping-who-must-do-what"
    title: "Double-Entry vs. Simplified Bookkeeping: Who Must Do What"
  - id: "what-records-must-be-kept"
    title: "What Records Must Be Kept"
  - id: "retention-period-10-years"
    title: "Retention Period: 10 Years"
  - id: "digital-bookkeeping-in-switzerland"
    title: "Digital Bookkeeping in Switzerland"
  - id: "chart-of-accounts-in-switzerland"
    title: "Chart of Accounts in Switzerland"
  - id: "swiss-gaap-fer-the-accounting-standard-for-swiss-companies"
    title: "Swiss GAAP FER: The Accounting Standard for Swiss Companies"
  - id: "the-financial-year"
    title: "The Financial Year"
  - id: "language-and-reporting-currency"
    title: "Language and Reporting Currency"
  - id: "swiss-tax-accounts-vs-commercial-accounts"
    title: "Swiss Tax Accounts vs. Commercial Accounts"
  - id: "penalties-for-non-compliance"
    title: "Penalties for Non-Compliance"
  - id: "common-bookkeeping-issues-for-foreign-owned-swiss-companies"
    title: "Common Bookkeeping Issues for Foreign-Owned Swiss Companies"
  - id: "bookkeeping-software-used-in-switzerland"
    title: "Bookkeeping Software Used in Switzerland"
...
<!-- breadcrumb_1: Home | / -->
<!-- breadcrumb_2: Tax & Accounting | /accounting-switzerland/ -->
<!-- breadcrumb_3: Bookkeeping Switzerland | /bookkeeping-switzerland/ -->
...
## Legal Basis: Art. 957–963 of the Swiss Code of Obligations
...
| Entity Type | Turnover Threshold | Required Standard |
|---|---|---|
...
**1. Journal (Grundbuch)**
A chronological record of all business transactions, recorded completely, truthfully, and systematically, with reference to supporting documents.

**2. General Ledger (Hauptbuch)**
A classification of all transactions by account. The ledger is the foundation of the balance sheet and profit and loss statement.

**3. Balance Sheet (Bilanz)**
A snapshot of the company's assets, liabilities, and equity at a specific point in time — typically year-end.

**4. Profit and Loss Statement (Erfolgsrechnung)**
A summary of income and expenses over the financial year, resulting in net profit or net loss.

**5. Supporting Documents (Belege)**
Every entry in the books must be supported by a document — an invoice, receipt, bank statement, or equivalent. Art. 957a(2) CO is explicit: no entry without a document.

**6. Notes (Anhang) — for larger companies**
Companies that exceed two of the three thresholds (total assets CHF 20 million; turnover CHF 40 million; 250 full-time employees) must prepare extended notes to the accounts and are also subject to statutory audit obligations.
...
| 8 | Extraordinary / prior-year items |
