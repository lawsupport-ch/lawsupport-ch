...
faqItems:
  ...
  - question: "Can a Swiss foundation engage in commercial activities?"
    answer: "A Swiss foundation may conduct commercial activities if they serve the foundation's purpose. However, a foundation that exists primarily to generate profit rather than pursue a defined purpose risks being reclassified or challenged by the supervisory authority. The purpose must remain the primary driver."
  - question: "Is a Swiss foundation subject to government supervision?"
    answer: "Yes. Charitable and public-benefit foundations are supervised by the relevant federal or cantonal supervisory authority. The authority reviews annual reports, financial statements, and compliance with the foundation's charter. Private-benefit family foundations are generally exempt from formal supervision."
  - question: "Can a Swiss foundation be dissolved?"
    answer: "Yes, but only under specific conditions. The foundation board may petition for dissolution if the purpose has become unachievable. The supervisory authority or a court may also dissolve a foundation. Remaining assets must be applied in accordance with the charter or, failing that, to a purpose as close to the original as possible."
  - question: "What tax exemptions are available for Swiss foundations?"
    answer: "Foundations pursuing exclusively public-benefit (gemeinnuetzig) purposes may apply for tax exemption at both cantonal and federal levels. The exemption covers income tax and capital tax. Donations to tax-exempt foundations are deductible for the donor. The tax authority assesses each application individually."
  - question: "Can a foreign national establish a Swiss foundation?"
    answer: "Yes. Swiss law does not restrict foundation formation to Swiss citizens or residents. A foreign national can establish a Swiss foundation, though at least one member of the foundation board must be resident in Switzerland or the foundation must have a Swiss-domiciled representative."
  - question: "What ongoing governance obligations does a Swiss foundation have?"
    answer: "The foundation board must hold regular meetings, maintain proper accounts, submit annual reports and audited financial statements to the supervisory authority, and ensure that activities remain aligned with the charter. Failure to meet governance obligations can result in the supervisory authority appointing replacement board members."
  - question: "Why do crypto projects choose Swiss foundations?"
    answer: "Switzerland's foundation structure suits decentralised projects because the foundation has no shareholders or members — eliminating ownership claims over protocol assets. Zug offers a favourable regulatory environment, established crypto-foundation precedent, and proximity to the broader Swiss blockchain ecosystem."
tocItems:
  - id: "what-is-a-swiss-foundation"
    title: "What Is a Swiss Foundation?"
  - id: "types-of-swiss-foundations"
    title: "Types of Swiss Foundations"
  - id: "foundation-type-comparison"
    title: "Foundation Type Comparison"
  - id: "formation-process-step-by-step"
    title: "Formation Process: Step by Step"
  - id: "supervisory-authorities-in-switzerland"
    title: "Supervisory Authorities in Switzerland"
  - id: "formation-timeline"
    title: "Formation Timeline"
  - id: "tax-treatment-of-swiss-foundations"
    title: "Tax Treatment of Swiss Foundations"
  - id: "ongoing-governance-requirements"
    title: "Ongoing Governance Requirements"
  - id: "why-zug-for-swiss-foundation-formation"
    title: "Why Zug for Swiss Foundation Formation?"
  - id: "crypto-blockchain-protocol-foundations-in-depth"
    title: "Crypto / Blockchain Protocol Foundations in Depth"
  - id: "swiss-foundation-vs-trust"
    title: "Swiss Foundation vs. Trust"
  - id: "formation-costs"
...
A Swiss foundation is a separate legal entity created by dedicating assets to a specific, permanently defined purpose. It has no shareholders, no members, and no owners. Legally, it is constituted under Articles 80 to 89a of the <a href="https://www.fedlex.admin.ch/eli/cc/24/233_245_233/en" target="_blank" rel="nofollow noopener">Swiss Civil Code (Zivilgesetzbuch, ZGB)</a>.
...
<!-- VIDEO: Walkthrough of Swiss foundation formation process from charter drafting to Commercial Register entry and supervisory notification -->
