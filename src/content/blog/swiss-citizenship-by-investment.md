...
faqItems:
  ...
  - question: "Can I get Swiss residency without lump-sum taxation?"
    answer: "Yes. Standard work permits, family reunification, and business investor permits under Art. 19 AIG all provide Swiss residency without requiring a lump-sum tax arrangement. The route depends on your circumstances, employment status, and nationality."
  - question: "Is lump-sum taxation available in all Swiss cantons?"
    answer: "No. Zurich abolished the regime in 2009 and does not participate. Participating cantons include Zug, Geneva, Vaud, Valais, Graubunden, Bern, and Lucerne, among others. Each canton sets its own minimum deemed living expenses."
  - question: "Can I work in Switzerland while on lump-sum taxation?"
    answer: "No. Lump-sum taxation explicitly requires that you do not engage in any gainful employment in Switzerland. You may manage passive investments and derive income from non-Swiss sources, but Swiss-source earned income disqualifies you from the regime."
  - question: "What is the minimum annual tax under lump-sum taxation?"
    answer: "The annual minimum varies by canton. Zug starts at approximately CHF 600'000 in deemed living expenses, resulting in annual tax of roughly CHF 200'000 to CHF 300'000. Geneva starts at approximately CHF 400'000 deemed expenses. These figures are negotiated individually with the cantonal tax authority."
  - question: "Do years under lump-sum taxation count towards naturalisation?"
    answer: "Yes. Time spent as a legal resident under lump-sum taxation counts toward the ten-year ordinary naturalisation requirement. However, the lump-sum tax status itself confers no advantage in the citizenship application process."
  - question: "Can US citizens use lump-sum taxation in Switzerland?"
    answer: "In principle, yes — US citizenship does not disqualify someone from lump-sum taxation. However, US citizens face practical difficulties because the United States taxes citizens globally, and most Swiss banks decline US persons due to FATCA compliance costs."
  - question: "Is the business investor permit under Art. 19 AIG guaranteed if I invest enough?"
    answer: "No. The Art. 19 AIG permit is discretionary. Cantons assess the quality of the business plan, the number of Swiss jobs created, and the economic benefit to the canton. A large investment alone does not guarantee approval."
tocItems:
  - id: "why-people-search-for-swiss-citizenship-by-investment"
    title: "Why People Search for Swiss Citizenship by Investment"
  - id: "what-switzerland-actually-offers-wealthy-foreign-nationals"
    title: "What Switzerland Actually Offers Wealthy Foreign Nationals"
  - id: "what-investment-can-and-cannot-do"
    title: "What Investment Can — and Cannot — Do"
  - id: "how-switzerland-compares-to-other-programmes"
    title: "How Switzerland Compares to Other Programmes"
  - id: "the-swiss-passport-what-you-get-after-naturalisation"
...
<!-- VIDEO: Overview of legitimate pathways to Swiss residency and eventual citizenship for high-net-worth individuals -->
