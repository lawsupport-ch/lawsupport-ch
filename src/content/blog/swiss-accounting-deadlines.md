...
readTime: "9 min read"
tocItems:
  - id: "the-three-deadline-mistakes-that-cost-swiss-companies-money"
    title: "The Three Deadline Mistakes That Cost Swiss Companies Money"
  - id: "annual-filing-calendar-31-december-year-end"
    title: "Annual Filing Calendar (31 December Year-End)"
  - id: "vat-filing-deadlines"
    title: "VAT Filing Deadlines"
  - id: "payroll-and-social-insurance-deadlines"
    title: "Payroll and Social Insurance Deadlines"
  - id: "corporate-tax-return-deadlines-by-canton"
    title: "Corporate Tax Return Deadlines by Canton"
  - id: "agm-and-annual-accounts-approval"
    title: "AGM and Annual Accounts Approval"
  - id: "what-happens-when-you-miss-a-deadline"
    title: "What Happens When You Miss a Deadline"
  - id: "how-to-get-extensions"
    title: "How to Get Extensions"
faqItems:
  - question: "When is the corporate tax return due in Switzerland?"
    answer: "For companies with a 31 December year-end, the standard deadline is 30 June of the following year in most cantons. Extensions to 30 September or 31 December are routinely granted when requested through a professional representative before the original deadline."
  - question: "How often must Swiss companies file VAT returns?"
    answer: "Most companies file quarterly. Semi-annual filing is available for companies with annual VAT liability below CHF 10,000. Monthly filing is required for companies with annual turnover above CHF 5,001,000. Returns are due 60 days after the end of the reporting period."
  - question: "What is the penalty for late VAT filing in Switzerland?"
    answer: "The ESTV charges default interest at 5% per annum from the date payment was due. Repeated late filing can trigger enforcement proceedings. There is no grace period — interest accrues from day one after the deadline."
  - question: "When must the AGM be held for a Swiss company?"
    answer: "The annual general meeting must be held within six months of the financial year-end. For calendar-year companies, this means by 30 June. The AGM must approve the annual accounts and decide on profit distribution."
  - question: "Can I get an extension for my Swiss corporate tax return?"
    answer: "Yes. Most cantons grant extensions routinely when requested before the original deadline. In Zurich, extensions to 30 September are standard. In Zug, extensions to 31 December are common. A professional representative (Treuhaender) can usually obtain longer extensions than an individual taxpayer."
  - question: "When are AHV/IV wage declarations due?"
    answer: "Annual wage declarations must be submitted to the cantonal compensation office (Ausgleichsskasse) by 28 February following the calendar year. Late submissions result in estimated contributions and interest charges."
  - question: "What happens if I miss the corporate tax deadline without requesting an extension?"
    answer: "The cantonal tax authority issues an estimated assessment (Ermessensveranlagung). These estimates are typically 200-400% above actual liability. Interest accrues from the original due date at approximately 3% per annum. Correcting an estimated assessment requires filing the actual return and formally objecting to the estimate."
  - question: "Are Swiss accounting deadlines the same in every canton?"
    answer: "No. While federal deadlines (VAT, withholding tax) are uniform, corporate tax return deadlines and extension policies vary by canton. Zug, Zurich, Bern and Geneva each have different standard deadlines and extension practices."
  - question: "Do dormant Swiss companies have the same filing deadlines?"
    answer: "Yes. A dormant company registered in the commercial register must file annual accounts and a corporate tax return on the same schedule as an active company. There is no exemption for zero-turnover entities."
  - question: "When must salary certificates be issued to employees?"
    answer: "Employers must issue salary certificates (Lohnausweis) to all employees by 31 March following the calendar year. The salary certificate is a standardised form that employees need for their personal tax returns."
relatedArticles:
...
For registration requirements and thresholds, see our [VAT registration guide](/tax-accounting/vat-registration-switzerland/).
...
For a full guide on employer obligations, see [Payroll Switzerland: Rates & Obligations](/tax-accounting/payroll-switzerland/).
...
For detailed filing guidance, see our [corporate tax return guide](/tax-accounting/corporate-tax-return-switzerland/).
...
2. Decision on profit distribution or loss carry-forward
3. Discharge of the board of directors (Décharge)
4. Election or re-election of the board and auditor (if applicable)
...
The annual general meeting must be held within six months of the financial year-end. For calendar-year companies, this means by 30 June. The AGM must approve the [annual accounts](/tax-accounting/accounting-switzerland/) and decide on profit distribution.
