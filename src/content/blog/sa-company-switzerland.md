...
pageLevel: 3
tocItems:
  - id: "what-is-an-sa-in-switzerland"
    title: "What Is an SA in Switzerland?"
  - id: "sa-vs-ag-same-entity-different-language"
    title: "SA vs AG: Same Entity, Different Language"
  - id: "forming-an-sa-in-romandie"
    title: "Forming an SA in Romandie"
  - id: "cantonal-differences-geneva-vs-vaud-vs-zurich"
    title: "Cantonal Differences: Geneva vs Vaud vs Zurich"
  - id: "sa-for-international-businesses"
    title: "SA for International Businesses"
faqItems:
  - question: "Is an SA the same as an AG in Switzerland?"
    answer: "Yes. An SA (Société Anonyme) and an AG (Aktiengesellschaft) are the identical legal entity type under Swiss law, governed by the same provisions of the Code of Obligations (Art. 620-763). The difference is purely linguistic: SA is used in French-speaking cantons (Geneva, Vaud, Neuchâtel, Fribourg, Valais, Jura), while AG is used in German-speaking cantons."
  - question: "What is the minimum capital for a Swiss SA?"
    answer: "CHF 100,000, of which at least CHF 50,000 must be paid in at incorporation. This is identical to the AG — the capital requirements are set by federal law and apply uniformly across all cantons regardless of language."
  - question: "Should I register my SA in Geneva or Zurich?"
  ...
  - question: "Can an SA registered in Geneva do business in German-speaking Switzerland?"
    answer: "Yes, without restriction. An SA registered in Geneva is fully recognised across all 26 cantons. The company name will appear as 'SA' in the Commercial Register, but this has no effect on its legal capacity to operate anywhere in Switzerland or internationally."
  - question: "What is a Sàrl in Switzerland?"
    answer: "A Sàrl (Société à responsabilité limitée) is the French equivalent of a GmbH (Gesellschaft mit beschränkter Haftung). It is a limited liability company with CHF 20,000 minimum capital. Like SA/AG, Sàrl/GmbH are the same entity type — the name reflects the language of the canton."
relatedArticles:
  - title: "AG Formation Switzerland: Step-by-Step Guide (2026)"
    href: "/company-formation/ag-formation-switzerland/"
  - title: "Swiss Entity Types Compared"
...
<!-- Schema.org: WebPage, BreadcrumbList, Article, FAQPage markup applied via template -->
...
For a full breakdown of formation steps and costs, see the [AG formation guide](/company-formation/ag-formation-switzerland/).

---

## Forming an SA in Romandie

The formation process for an SA follows the same federal procedure as an [AG formation](/company-formation/ag-formation-switzerland/). The difference lies in language: documents are in French, the notary conducts proceedings in French, and the Commercial Register (Registre du Commerce) operates in French.
...
4. **File with the <a href="https://www.zefix.ch/en/" target="_blank" rel="nofollow noopener">Registre du Commerce</a>** — the cantonal register processes the application. Geneva typically completes registration within 5–10 business days after submission. Vaud averages 7–12 business days.
...
For a side-by-side comparison of all Swiss entity types, see the [entity types comparison guide](/company-formation/swiss-entity-types-compared/).
...
Need guidance on structuring your Swiss company? Our [company formation guide](/company-formation/company-formation-switzerland/) covers the full process, and the [GmbH formation guide](/company-formation/gmbh-formation-switzerland/) explains the alternative for businesses that do not require CHF 100'000 in capital.
