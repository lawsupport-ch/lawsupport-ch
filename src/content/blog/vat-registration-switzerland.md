...
description: "VAT registration in Switzerland for foreign companies: CHF 100'000 threshold, 8.1% standard rate, fiscal representative rules, and ESTV filing."
date: "15.08.2026"
...
faqItems:
  ...
  - question: "What security deposit does the ESTV require from foreign VAT-registered companies?"
    answer: "The ESTV requires a cash deposit or bank guarantee (Sicherheitsleistung) from foreign companies without a Swiss permanent establishment. The amount is typically set at CHF 5,000 to CHF 50,000 depending on estimated annual VAT liability. The deposit is held for the duration of the registration."
  - question: "How often must Swiss VAT returns be filed?"
    answer: "VAT returns are filed quarterly by default, with deadlines 60 days after the end of each quarter. Businesses with annual VAT liability below CHF 1,000 may apply for semi-annual filing. Monthly filing is available on request for businesses with regular net refund positions."
  - question: "Can a foreign e-commerce seller be required to register for Swiss VAT?"
    answer: "Yes. Foreign businesses making supplies of low-value goods (under CHF 65) to Swiss consumers exceeding CHF 100,000 per year must register for Swiss VAT under the mail-order provisions. Digital services supplied to Swiss customers also trigger registration obligations."
  - question: "What is the Swiss VAT flat-rate method?"
    answer: "Small businesses with annual taxable turnover below CHF 5,005,000 and annual tax liability below CHF 103,000 may apply the Saldosteuersatzmethode. This method uses industry-specific flat rates applied to gross revenue, eliminating the need to track input VAT on individual purchases."
  - question: "What are the consequences of late Swiss VAT registration?"
    answer: "The ESTV assesses VAT retroactively from the date registration should have occurred, plus default interest at 4.75% per annum. A late registration fine of up to CHF 10,000 may also apply. Businesses should monitor turnover thresholds continuously and register proactively."
tocItems:
  ...
  - id: "swiss-vat-rates-2026"
    title: "Swiss VAT Rates 2026"
  - id: "swiss-vat-registration-thresholds"
    title: "Swiss VAT Registration Thresholds"
  - id: "voluntary-vat-registration-when-it-makes-sense"
    title: "Voluntary VAT Registration: When It Makes Sense"
  - id: "swiss-vat-registration-process-step-by-step"
    title: "Swiss VAT Registration Process: Step by Step"
  - id: "real-world-scenario-german-e-commerce-company-entering-switz"
    title: "Real-World Scenario: German E-Commerce Company Entering Switzerland"
  - id: "vat-return-filing-frequency-and-deadlines"
    title: "VAT Return Filing: Frequency and Deadlines"
  - id: "input-tax-recovery-vorsteuerabzug"
    title: "Input Tax Recovery (Vorsteuerabzug)"
  - id: "exempt-vs-excluded-supplies-a-critical-distinction"
    title: "Exempt vs. Excluded Supplies: A Critical Distinction"
...
|---|---|---|
| Standard rate | **8.1%** | Most goods and services, professional fees, IT services, consulting |
| Reduced rate | **2.6%** | Food and non-alcoholic beverages, books, newspapers, medicines, water supply |
| Special rate (accommodation) | **3.8%** | Hotel stays, short-term furnished accommodation |
| Export rate | **0%** | Goods exported outside Switzerland, certain international services |
...
| Filing period | Who uses it | Return due |
|---|---|---|
| **Quarterly** | Default for most registrants | 60 days after quarter end |
