...
faqItems:
  ...
  - question: "How much does a statutory audit cost for a Swiss SME?"
    answer: "A limited audit for a small company typically costs CHF 3,000 to 8,000 per year. An ordinary audit for a larger entity ranges from CHF 15,000 to 50,000 or more, depending on complexity and industry."
  - question: "Can a company reverse its audit opting-out decision?"
    answer: "Yes. A company can reverse the opt-out at any time by shareholder resolution. The company then engages an external auditor and resumes statutory audits from the current financial year."
  - question: "What qualifications must a Swiss statutory auditor hold?"
    answer: "The lead auditor must hold a Swiss federal diploma in auditing or an equivalent recognised qualification. The audit firm must be registered with the Federal Audit Oversight Authority (RAB)."
  - question: "Are there industry-specific audit requirements beyond the general thresholds?"
    answer: "Yes. Banks, insurance companies, securities dealers, and collective investment schemes are subject to mandatory ordinary audits regardless of size. FINMA-regulated entities must use FINMA-approved audit firms."
  - question: "What is the deadline for completing the statutory audit in Switzerland?"
    answer: "The audit must be completed in time for the annual general meeting, which must be held within 6 months of the financial year end. In practice, most audits are finished within 3 to 4 months after year-end."
tocItems:
  ...
  - id: "rab-the-swiss-audit-oversight-authority"
    title: "RAB: The Swiss Audit Oversight Authority"
  - id: "internal-audit-as-a-governance-function"
    title: "Internal Audit as a Governance Function"
  - id: "internal-audit-vs-external-audit-key-differences"
    title: "Internal Audit vs External Audit: Key Differences"
  - id: "audit-requirements-for-specific-swiss-entities"
...
Understanding your Swiss audit obligations — and structuring your company's governance correctly from the outset — saves time and cost. Morgan Hartley, Senior Corporate Lawyer & Partner at Morgan Hartley Consulting, reviews your situation and sets out the steps needed — without obligation.
