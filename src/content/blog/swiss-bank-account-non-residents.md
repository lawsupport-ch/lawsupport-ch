...
faqItems:
  - question: "Can I open a Swiss bank account online as a non-resident without forming a company?"
    answer: "In almost all cases, no. Swiss retail banks require residency for personal accounts. Some fintech providers like Wise offer CHF accounts remotely, but these are not Swiss bank accounts. For a genuine Swiss bank account, forming a Swiss company is the most reliable path for non-residents."
  - question: "Do I need to visit Switzerland to open a corporate bank account?"
    answer: "Not always, but it depends on the bank. Some institutions accept full remote onboarding with video KYC and certified documentation. Others prefer or require an in-person meeting, particularly for accounts with non-resident beneficial owners. We advise on this bank by bank and facilitate remote processes wherever possible."
  - question: "Are Swiss bank accounts still confidential in 2026?"
    answer: "No. Switzerland participates in the OECD Common Reporting Standard (CRS) and automatically exchanges financial account information with over 100 partner countries. Your home country's tax authority will receive information about your Swiss account. Swiss banking confidentiality as it was historically understood no longer exists for foreign nationals. Any service or provider suggesting otherwise is misinforming you."
  - question: "What is the minimum investment for Swiss private banking as a non-resident?"
    answer: "Most Swiss private banks — Pictet, Julius Baer, EFG, Lombard Odier — have effective minimums of CHF 1 million in assets under management, and some have higher relationship thresholds in practice. Private banking is a wealth management product, not a current account, and the relationship is advisory or discretionary in nature."
  - question: "How long does it take to open a Swiss corporate bank account for a new company?"
    answer: "From the point of company formation, the corporate account application and approval process typically takes four to eight weeks. The capital deposit account (Kapitaleinzahlungskonto) required before company registration adds two to six weeks at the beginning of the process. Total timeline from engagement to active account is generally eight to twelve weeks for straightforward structures."
  - question: "What fees do non-residents pay for Swiss bank accounts?"
    answer: "Non-resident account fees are typically higher than resident fees. Expect CHF 200-500 per quarter for corporate accounts and CHF 50-150 per quarter for personal accounts at private banks. Some banks add a non-resident surcharge of CHF 100-300 annually."
  - question: "Can a non-resident open a joint Swiss bank account?"
    answer: "Joint accounts for non-residents are uncommon at retail level. Private banks may accommodate joint accounts for couples with combined assets above CHF 1 million. For corporate purposes, multi-signatory accounts are standard and available to non-residents through a Swiss company."
  - question: "Which countries face the most difficulty opening Swiss bank accounts?"
    answer: "Nationals from FATF grey-listed countries, US persons (due to FATCA), and residents of countries without a CRS agreement face the highest rejection rates. Politically exposed persons from any country also face enhanced scrutiny that significantly extends the onboarding timeline."
  - question: "Do non-residents need to declare Swiss bank accounts to their home country?"
    answer: "Yes. Under the Common Reporting Standard (CRS), Swiss banks automatically report account information to over 100 partner countries. Non-disclosure of a Swiss account on your domestic tax return constitutes tax evasion in most jurisdictions."
  - question: "Can a non-resident get a Swiss mortgage through their bank account?"
    answer: "Non-residents can obtain Swiss mortgages, but terms are restrictive. Banks typically require 40-50% down payment (versus 20% for residents), and the property must be in a zone permitting foreign ownership under the Lex Koller Act. Only holiday apartments in designated tourist areas qualify for most non-residents."
tocItems:
  - id: "the-reality-check-personal-swiss-banking-for-non-residents-i"
    title: "The Reality Check: Personal Swiss Banking for Non-Residents in 2026"
  - id: "what-is-possible-three-realistic-paths"
    title: "What IS Possible: Three Realistic Paths"
  - id: "why-swiss-banks-restrict-non-resident-accounts"
    title: "Why Swiss Banks Restrict Non-Resident Accounts"
  - id: "comparison-options-for-non-residents-seeking-swiss-banking"
    title: "Comparison: Options for Non-Residents Seeking Swiss Banking"
  - id: "remote-account-opening-how-far-has-it-come"
    title: "Remote Account Opening: How Far Has It Come?"
  - id: "real-world-scenario-singapore-resident-wants-a-swiss-bank-ac"
...
5. **Corporate bank account application** — Submitting full KYC documentation for the company and all beneficial owners, including business plan and ownership structure.
6. **Account activation** — Once the bank completes its review and activates the account, the Kapitaleinzahlungskonto balance is transferred to the active corporate account.
