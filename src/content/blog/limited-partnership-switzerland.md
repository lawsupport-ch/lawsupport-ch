...
faqItems:
  ...
  - question: "What are the costs of forming a Swiss limited partnership (KG)?"
    answer: "Formation costs are low compared to capital companies. Notarial authentication runs CHF 500 to 1,500, Commercial Register fees are approximately CHF 600, and legal drafting of the partnership agreement costs CHF 3,000 to 8,000."
  - question: "How long does it take to register a Swiss KG?"
    answer: "Registration with the Commercial Register typically takes 1 to 2 weeks after submission of all documents. The entire process from drafting to registration usually spans 3 to 6 weeks."
  - question: "What are the main tax differences between a KG and a GmbH?"
    answer: "A KG is fiscally transparent: profits are taxed at partner level, not entity level. A GmbH pays corporate tax on profits, and distributions are taxed again as income to shareholders. The KG avoids this double taxation but offers less flexibility in profit retention."
  - question: "Can a GmbH or AG serve as the general partner of a Swiss KG?"
    answer: "Yes. A GmbH & Co. KG structure is common and limits the liability of all participants. The GmbH acts as general partner with unlimited liability, but its own liability is limited to its assets."
  - question: "What are common mistakes when setting up a Swiss limited partnership?"
    answer: "Failing to define profit-sharing clearly in the partnership agreement causes disputes. Other frequent errors include allowing limited partners to participate in management (which removes their liability protection) and omitting succession or exit provisions."
  - question: "Must a Swiss KG publish annual financial statements?"
    answer: "A KG must keep proper accounting records under the Swiss Code of Obligations if it exceeds CHF 500,000 in revenue. However, there is no public filing requirement for financial statements unless the KG issues bonds or is subject to an ordinary audit."
tocItems:
  - id: "structure-of-the-swiss-kg"
    title: "Structure of the Swiss KG"
  - id: "formation-and-registration"
    title: "Formation and Registration"
  - id: "tax-treatment"
    title: "Tax Treatment"
  - id: "limited-partnership-for-collective-investment-schemes"
    title: "Limited Partnership for Collective Investment Schemes"
  - id: "comparison-with-other-swiss-structures"
...
**Kommanditgesellschaft fur kollektive Kapitalanlagen (KGK):** A Swiss limited partnership specifically designed for private equity and real estate funds, regulated under the <a href="https://www.fedlex.admin.ch/eli/cc/2006/822/en" target="_blank" rel="nofollow noopener">Collective Investment Schemes Act (CISA/KAG)</a>.
...
- <a href="https://www.finma.ch/en/" target="_blank" rel="nofollow noopener">FINMA</a> approval required for the GP fund manager
