---
title: "Swiss Banking System: Structure & Regulation"
...
tocItems:
  - id: "overview-of-the-swiss-banking-system"
    title: "Overview of the Swiss Banking System"
  - id: "finma-the-financial-market-supervisory-authority"
    title: "FINMA: The Financial Market Supervisory Authority"
  - id: "the-swiss-national-bank"
    title: "The Swiss National Bank"
  - id: "universal-banks-ubs-and-the-big-bank-model"
    title: "Universal Banks: UBS and the Big Bank Model"
  - id: "cantonal-banks-state-guaranteed-regional-banking"
    title: "Cantonal Banks: State-Guaranteed Regional Banking"
  - id: "private-banks-wealth-management-tradition"
    title: "Private Banks: Wealth Management Tradition"
  - id: "foreign-banks-in-switzerland"
    title: "Foreign Banks in Switzerland"
  - id: "digital-banking-and-fintech"
...
faqItems:
  ...
  - question: "Can foreign banks operate in Switzerland?"
    answer: "Yes. Foreign banks can establish Swiss subsidiaries (which require a full FINMA banking licence) or representative offices (which cannot conduct banking business but can market services). Over 100 foreign-controlled banks operate in Switzerland, including branches and subsidiaries of major US, European, and Asian banks. The Swiss subsidiary model is most common because it allows full banking operations under FINMA supervision."
  - question: "What is the difference between a banking licence and an SRO membership?"
    answer: "A FINMA banking licence authorises deposit-taking, lending, and full banking operations under the Banking Act. It requires minimum capital of CHF 10 million and extensive organisational requirements. SRO (Self-Regulatory Organisation) membership is an AML/KYC compliance framework for financial intermediaries who do not take deposits — such as asset managers, payment processors, and crypto service providers. SRO membership requires no minimum capital beyond the underlying business requirements."
  - question: "Is Switzerland still a global banking centre?"
    answer: "Switzerland remains the world's largest centre for cross-border wealth management, with approximately CHF 2.4 trillion in foreign-held assets as of 2025. While the end of banking secrecy for international clients reduced inflows from tax-motivated depositors, Switzerland's political stability, strong currency, rule of law, and concentration of wealth management expertise continue to attract legitimate international capital."
  - question: "What is the Swiss Bankers Association?"
    answer: "The Swiss Bankers Association (SBA/SBVg) is the industry body representing Swiss banks. It issues self-regulatory guidelines — including the Agreement on Due Diligence (VSB), which sets KYC standards — negotiates with regulators, and represents banking interests in legislative processes. SBA guidelines often become binding through FINMA recognition, giving them quasi-regulatory force."
relatedArticles:
  ...
  - title: "Private Banking in Switzerland: Wealth Management & Investment Services"
    href: "/banking/private-banking-switzerland-guide/"
...
This guide explains how the Swiss banking system is structured, who regulates it, and how the different categories of banks serve foreign entrepreneurs, companies, and investors. For practical account-opening guidance, see our [guide to opening a Swiss bank account](/banking/opening-swiss-bank-account-guide/).

---

## Overview of the Swiss Banking System

The [Swiss banking system](/banking/swiss-banking-system/) has evolved over centuries from a collection of local deposit-takers into one of the world's most sophisticated financial centres. Several features distinguish it:
...
The [full list of Swiss banks](/banking/swiss-banks-list/) includes institutions ranging from the global operations of UBS to single-branch cantonal savings institutions.
...
For businesses requiring financial licences, the FINMA application process is the gateway to operating in Switzerland's regulated financial sector. See our detailed guides on [banking licences](/licensing/banking-license-switzerland/) and [FINMA licensing](/licensing/finma-licensing-switzerland/).
...
UBS's scale makes it suitable for complex international structures, but its fees are higher than cantonal or regional banks. For simple Swiss SME banking, a [cantonal bank](/banking/cantonal-banks-switzerland/) often provides better value.

---

## Cantonal Banks: State-Guaranteed Regional Banking

Switzerland's 24 [cantonal banks](/banking/cantonal-banks-switzerland/) are a unique feature of the banking system. Each canton (except Appenzell Innerrhoden, Solothurn, and Uri, which privatised or merged their cantonal banks) operates a publicly owned bank that serves the local economy.
...
Swiss [private banking](/banking/private-banking-switzerland/) has operated for over 200 years. Geneva and Zurich are the two main centres, with approximately 90 private banks managing assets for high-net-worth individuals and family offices.
...
The [top private banks in Switzerland](/banking/top-private-banks-switzerland/) include Julius Baer, Lombard Odier, Pictet, Vontobel, and EFG International. Each has distinct strengths in terms of geographic coverage, asset classes, and client segments.

Private banking is relevant to foreign entrepreneurs who have accumulated significant personal wealth and want professional management alongside their Swiss business banking. [Interest rates on Swiss bank deposits](/banking/swiss-bank-account-interest-rates/) remain modest, making active investment management the default approach for private banking clients.
