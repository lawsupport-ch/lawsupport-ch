...
description: "Swiss withholding tax at 35% on dividends and interest. Treaty reductions, refund process via ESTV Form 65, and holding structure planning."
date: "23.08.2026"
...
faqItems:
  - question: "What is the Swiss withholding tax rate on dividends?"
    answer: "Switzerland levies a flat 35% Verrechnungssteuer on all dividend distributions from Swiss AG and GmbH companies. This rate applies equally to Swiss and foreign shareholders. The 35% is withheld at source by the paying company and remitted to the ESTV."
  - question: "Is the 35% withholding tax a final tax?"
    answer: "For Swiss residents who correctly declare the income in their tax return, the 35% is fully refundable. For foreign shareholders, the withholding is either final (if no treaty applies) or partially refundable under the applicable double tax treaty rate."
  - question: "How long does a withholding tax refund take?"
    answer: "The ESTV typically processes refund applications within 6-18 months of submission. Applications with complete documentation are processed faster. The deadline for filing is 3 years from the end of the calendar year in which the dividend was paid."
  - question: "Do royalties and licence fees attract Swiss withholding tax?"
    answer: "No. Swiss withholding tax does not apply to royalties, licence fees, service fees, or management fees. It applies only to dividends, certain interest payments on bonds and bank deposits, and lottery winnings above CHF 1,000."
  - question: "What is the withholding tax rate for UK shareholders?"
  ...
  - question: "Does Switzerland impose withholding tax on interest payments?"
    answer: "Withholding tax applies to interest on Swiss-issued bonds and bank deposits held by Swiss banks. Interest on ordinary intercompany loans, trade receivables, and private lending is not subject to withholding tax, provided the arrangement does not qualify as a bond substitute under the 10/20 non-bank creditor rule."
  - question: "What is the 10/20 non-bank creditor rule?"
    answer: "If a Swiss borrower has more than 10 non-bank creditors on a single loan (or more than 20 non-bank creditors across all loans), the interest payments are recharacterised as bond interest and attract 35% withholding tax. This rule prevents companies from circumventing bond withholding tax through syndicated loan structures."
  - question: "How do double tax treaties reduce Swiss withholding tax on dividends?"
    answer: "Most Swiss treaties reduce the withholding rate to 15% for portfolio dividends and 5% or 0% for substantial participations (typically 10-25% ownership). The shareholder must submit a claim form to the ESTV with a certificate of residence from their home tax authority to obtain the treaty rate."
  - question: "Is Swiss withholding tax refundable for EU parent companies?"
    answer: "Under the Swiss-EU Savings Agreement and bilateral treaties, qualifying EU parent companies holding at least 25% of a Swiss subsidiary can reclaim the full 35% withholding tax, reducing the effective rate to 0%. The refund procedure requires submission of Form 823B or 823C to the ESTV."
  - question: "What notification procedure can eliminate Swiss withholding tax at source?"
    answer: "For qualifying intercompany dividends within Swiss groups or to treaty-entitled foreign parents, the paying company can apply for the notification procedure (Meldeverfahren). This replaces the pay-and-refund mechanism, allowing dividends to be paid without deducting the 35% at source."
tocItems:
  ...
  - id: "treaty-reductions-for-foreign-shareholders"
    title: "Treaty Reductions for Foreign Shareholders"
  - id: "the-participation-exemption-route-eliminating-withholding"
    title: "The Participation Exemption Route: Eliminating Withholding"
  - id: "swiss-swiss-withholding-the-intercompany-dividend-rule"
    title: "Swiss-Swiss Withholding: The Intercompany Dividend Rule"
  - id: "practical-planning-points"
    title: "Practical Planning Points"
  - id: "how-to-request-a-withholding-tax-refund"
    title: "How to Request a Withholding Tax Refund"
  - id: "withholding-tax-and-swiss-company-formation"
...
<!-- VIDEO: Explainer — How to claim a Swiss withholding tax refund under a double tax treaty -->
