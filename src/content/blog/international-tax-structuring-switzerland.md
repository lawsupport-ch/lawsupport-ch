...
faqItems:
  ...
  - question: "What does it cost to set up a Swiss holding company for tax structuring?"
    answer: "Incorporation of a Swiss AG costs CHF 15,000 to 30,000 in legal and notarial fees, plus CHF 100,000 minimum share capital. Ongoing substance costs including directors, office, and accounting typically run CHF 50,000 to 100,000 per year."
  - question: "How long does it take to obtain a Swiss tax ruling?"
    answer: "Cantonal tax authorities typically issue advance rulings within 4 to 8 weeks for standard requests. Complex international structures involving multiple entities or novel arrangements can take 3 to 6 months."
  - question: "What are the most common mistakes in Swiss tax structuring?"
    answer: "Insufficient substance in the Swiss entity is the leading cause of challenge by foreign tax authorities. Other frequent errors include failing to meet the participation exemption holding period and ignoring transfer pricing documentation requirements."
  - question: "Can Swiss tax rulings be revoked retroactively?"
    answer: "Generally no, provided the facts disclosed were accurate. However, a ruling becomes invalid if the underlying law changes or if the taxpayer deviated from the facts presented. Rulings are typically granted for 5-year periods."
  - question: "How does the Swiss participation exemption work in practice?"
    answer: "Qualifying dividends and capital gains from subsidiaries are effectively exempt from federal and cantonal tax if the holding meets the 10% ownership or CHF 1 million value threshold and holds for at least one year. The exemption is applied as a proportional reduction of overall tax."
  - question: "Which cantons offer the lowest effective tax rates for holding structures?"
    answer: "Zug offers approximately 11.9%, followed by Nidwalden at around 12%, Appenzell Innerrhoden at 12.7%, and Lucerne at roughly 12.2%. Rates change periodically and depend on the specific income mix of the entity."
tocItems:
  ...
  - id: "structure-1-swiss-holding-company"
    title: "Structure 1: Swiss Holding Company"
  - id: "structure-2-ip-holding-with-ip-box"
    title: "Structure 2: IP Holding with IP Box"
  - id: "structure-3-swiss-trading-company"
    title: "Structure 3: Swiss Trading Company"
  - id: "structure-4-treasury-and-finance-centre"
...
Swiss entities must file annual corporate tax returns (federal and cantonal), prepare audited or reviewed financial statements under Swiss GAAP or IFRS, maintain transfer pricing documentation for related-party transactions, and file CbCR if applicable. Holding companies must track the participation exemption annually. IP box companies must compute and document the nexus fraction each year. All entities must maintain proper accounting records in accordance with the <a href="https://www.fedlex.admin.ch/eli/cc/27/317_321_377/en" target="_blank" rel="nofollow noopener">Swiss Code of Obligations</a>.

---

For an overview of Swiss corporate tax rates and how they apply across cantons, see the <a href="https://www.estv.admin.ch/en" target="_blank" rel="nofollow noopener">Federal Tax Administration (ESTV)</a> website. The <a href="https://www.oecd.org/tax/beps/" target="_blank" rel="nofollow noopener">OECD BEPS framework</a> sets the international standards that Swiss structures must satisfy.
