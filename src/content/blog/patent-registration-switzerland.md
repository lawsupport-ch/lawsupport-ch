...
faqItems:
  ...
  - question: "How long does the IPI take to examine a Swiss patent application?"
    answer: "The IPI conducts a formal examination only -- it does not assess novelty or inventive step. Grant typically occurs within 12-18 months of filing. The lack of substantive examination means Swiss patents can be challenged more easily post-grant."
  - question: "What are the annual maintenance fees for a Swiss patent?"
    answer: "Annual fees start at CHF 100 in year 4 and increase progressively to CHF 900 in year 20. No fees are due for years 1-3. Total maintenance fees over the full 20-year term amount to approximately CHF 8'000."
  - question: "Should I file a Swiss national patent or go directly through the EPO?"
    answer: "If protection is needed only in Switzerland, a national filing is faster and cheaper (CHF 700 filing fee versus EUR 3'500+ at the EPO). If you need protection in multiple European countries, the EP route is more cost-effective for three or more jurisdictions."
  - question: "What is a provisional patent application in Switzerland?"
    answer: "Switzerland does not have a formal provisional application system like the US. However, you can file a Swiss application to establish a priority date and then file internationally within 12 months under the Paris Convention, achieving a similar result."
  - question: "What are the most common reasons for patent application rejection at the IPI?"
    answer: "Since the IPI does not examine novelty or inventive step, rejections are limited to formal deficiencies: unclear claims, insufficient description, non-patentable subject matter (e.g. pure software, business methods, therapeutic methods), or failure to pay required fees on time."
tocItems:
  - id: "swiss-patent-law-overview"
    title: "Swiss Patent Law Overview"
  - id: "route-1-swiss-national-patent-ipi"
    title: "Route 1: Swiss National Patent (IPI)"
  - id: "route-2-european-patent-epo"
    title: "Route 2: European Patent (EPO)"
  - id: "route-3-pct-patent-cooperation-treaty-application"
    title: "Route 3: PCT (Patent Cooperation Treaty) Application"
  - id: "comparing-the-three-patent-routes"
    title: "Comparing the Three Patent Routes"
  - id: "swiss-ip-box-and-patent-strategy"
    title: "Swiss IP Box and Patent Strategy"
  - id: "patent-enforcement-in-switzerland"
    title: "Patent Enforcement in Switzerland"
  - id: "patent-attorney-requirement"
    title: "Patent Attorney Requirement"
  - id: "related-guides"
    title: "Related Guides"
  - id: "case-study-medtech-startup--wrong-patent-route-cost-18-months"
    title: "Case Study: Medtech Startup — Wrong Patent Route"
  - id: "decision-tree-which-patent-route"
