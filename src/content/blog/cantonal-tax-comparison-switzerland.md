...
tocItems:
  ...
  - id: "individual-income-tax-top-marginal-rates-by-canton-2026"
    title: "Individual Income Tax: Top Marginal Rates by Canton (2026)"
  - id: "wealth-tax-by-canton"
    title: "Wealth Tax by Canton"
  - id: "capital-tax-on-companies"
    title: "Capital Tax on Companies"
  - id: "inheritance-and-gift-tax"
    title: "Inheritance and Gift Tax"
  - id: "why-companies-choose-zug"
    title: "Why Companies Choose Zug"
  - id: "zug-vs-zurich-head-to-head"
    title: "Zug vs Zurich: Head-to-Head"
  - id: "special-tax-regimes"
    title: "Special Tax Regimes"
  - id: "tax-competition-between-cantons"
    title: "Tax Competition Between Cantons"
  - id: "moving-between-cantons"
    title: "Moving Between Cantons"
...
1. **Federal tax (Direkte Bundessteuer / DBSt):** Uniform across all of Switzerland, set by federal law. The standard corporate rate is 8.5% on profit after tax (approx. 7.83% on pre-tax profit).
2. **Cantonal tax:** Set independently by each canton — the primary variable in any tax comparison.
3. **Communal/municipal tax:** A multiplier (Steuerfuss) applied on top of cantonal tax, which varies by commune within each canton.
...
Most cantons exempt direct descendants (children) from inheritance tax — including Zug, Schwyz, Zurich, and Geneva (spouses and children exempt).

**Inheritance tax on non-relatives:**
All cantons impose inheritance tax on bequests to unrelated persons. Rates range from 5–50% depending on the relationship and the canton.
...
1. Amending the articles of association to change the registered address
2. Filing a deletion with the old cantonal commercial register
3. Registering with the new cantonal commercial register
4. Notifying tax authorities in both cantons
