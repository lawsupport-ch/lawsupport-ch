...
tocItems:
  - id: "why-switzerland-for-international-tax-planning"
    title: "Why Switzerland for International Tax Planning"
  - id: "the-swiss-treaty-network"
    title: "The Swiss Treaty Network"
  - id: "holding-structures-and-participation-exemption"
    title: "Holding Structures and Participation Exemption"
  - id: "ip-and-principal-structures"
    title: "IP and Principal Structures"
  - id: "transfer-pricing-rules"
    title: "Transfer Pricing Rules"
  - id: "tax-residency-for-individuals-and-companies"
    title: "Tax Residency for Individuals and Companies"
  - id: "substance-requirements"
    title: "Substance Requirements"
  - id: "switzerland-and-oecd-pillar-two"
    title: "Switzerland and OECD Pillar Two"
  - id: "withholding-tax-on-outbound-payments"
    title: "Withholding Tax on Outbound Payments"
  - id: "practical-structuring-considerations"
    title: "Practical Structuring Considerations"
faqItems:
  - question: "How many double taxation treaties does Switzerland have?"
    answer: "Switzerland has over 100 double taxation agreements in force, covering all major trading partners including the US, UK, Germany, France, China, India, and the UAE. The treaty network is one of the most extensive globally and is a key reason for locating holding and IP structures in Switzerland."
  - question: "Does Switzerland have transfer pricing legislation?"
    answer: "Switzerland has no standalone transfer pricing statute. The arm's length principle is derived from general tax law — specifically the requirement that transactions with related parties reflect market conditions. The Federal Tax Administration issued transfer pricing guidance in 2024 aligned with OECD Transfer Pricing Guidelines."
  - question: "What is the participation exemption in Switzerland?"
    answer: "The participation deduction (Beteiligungsabzug) reduces corporate tax proportionally on dividends and capital gains from qualifying participations. A qualifying participation means holding at least 10% of a subsidiary or a participation with a fair market value of at least CHF 1 million."
  - question: "Can a foreigner become tax resident in Switzerland?"
    answer: "Yes. Tax residency is established by habitual abode — spending 30 consecutive days engaged in gainful activity or 90 consecutive days without gainful activity. Corporate tax residency requires the place of effective management to be in Switzerland. A registered office alone is insufficient."
  - question: "What is the Swiss withholding tax rate on dividends?"
    answer: "Switzerland levies a 35% withholding tax on dividends paid to shareholders. This is reduced under applicable double tax treaties — typically to 15% for portfolio investors and 5% or 0% for qualifying corporate shareholders. The withholding tax is fully refundable to Swiss resident shareholders."
  - question: "Is Switzerland subject to the OECD global minimum tax?"
    answer: "Yes. Switzerland implemented Pillar Two from 1 January 2024 through a constitutional amendment approved by popular vote. A Qualified Domestic Minimum Top-Up Tax (QDMTT) ensures that large multinationals with Swiss operations pay at least 15% effective tax."
  - question: "What substance is required for a Swiss holding company?"
    answer: "There is no statutory checklist, but tax authorities and treaty partners expect genuine economic substance. This means qualified directors resident in Switzerland, a physical office, independent decision-making at the Swiss level, appropriate staffing, and board meetings held in Switzerland."
  - question: "Can Switzerland be used as an IP holding location?"
    answer: "Yes. The combination of patent box regime (up to 90% cantonal reduction on qualifying IP income), R&D super-deduction (up to 150%), and an extensive treaty network makes Switzerland attractive for intellectual property structures. Substance and genuine R&D activities strengthen the position."
  - question: "How does Swiss transfer pricing compare to OECD standards?"
    answer: "Swiss practice follows OECD Transfer Pricing Guidelines closely. The five standard methods (CUP, resale price, cost plus, TNMM, profit split) are all accepted. Documentation requirements are less prescriptive than in Germany or the UK, but the arm's length standard is applied rigorously."
  - question: "What are the risks of aggressive international tax planning through Switzerland?"
    answer: "Risks include denial of treaty benefits under limitation-on-benefits or principal purpose test clauses, transfer pricing adjustments by foreign authorities, reputational damage, and — from 2024 — Pillar Two top-up tax eliminating ultra-low effective rates. Substance and genuine business purpose remain the strongest defences."
relatedArticles:
  ...
  - title: "Accounting, Payroll & Social Insurance in Switzerland"
    href: "/tax-accounting/accounting-payroll-switzerland/"
---
...
Switzerland's [double tax treaty network](/tax-accounting/double-tax-treaties-switzerland/) covers over 100 jurisdictions. Treaties follow the OECD Model Convention with Swiss-specific modifications, including limitations on the treaty shopping provisions.
...
Combined with low [capital tax](/tax-accounting/capital-tax-switzerland/) rates in cantons like Zug and Schwyz, and the absence of thin capitalisation rules for equity-financed holdings, Switzerland remains highly competitive for this function.

For detailed analysis of structuring options, see our guide to [international tax structuring from Switzerland](/tax-accounting/international-tax-structuring-switzerland/).
...
1. **Patent Box**: Cantons may reduce taxable income from qualifying IP by up to 90%. The federal law sets the framework; each canton determines the actual percentage. Qualifying IP includes patents, comparable rights, and software (in some cantons). See our [patent box article](/tax-accounting/patent-box-switzerland/) for the full mechanics.
...
In practice, the Federal Tax Administration follows the <a href="https://www.oecd.org/tax/transfer-pricing/" target="_blank" rel="nofollow noopener">OECD Transfer Pricing Guidelines</a> closely. All five standard methods are accepted:
...
For a detailed guide, see [transfer pricing in Switzerland](/tax-accounting/transfer-pricing-switzerland/).

---

## Tax Residency for Individuals and Companies

[Tax residency](/tax-accounting/tax-residency-switzerland/) determines whether a person or entity is subject to Swiss taxation on worldwide income.
...
For high-net-worth individuals, Switzerland offers [lump-sum taxation](/tax-accounting/lump-sum-taxation-switzerland/) (forfait fiscal) — a regime where tax is assessed on living expenses rather than actual income. Eligibility requires non-Swiss nationality and no gainful employment in Switzerland. This regime is covered in detail in our [tax incentives overview](/tax-accounting/tax-incentives-switzerland/).
...
For details on how withholding tax interacts with international structures, see [withholding tax in Switzerland](/tax-accounting/withholding-tax-switzerland/).
...
4. **Secure a tax ruling**: A pre-transaction [tax ruling](/tax-accounting/tax-ruling-switzerland/) from the cantonal authority provides certainty on the tax treatment
...
For professional assistance with international tax structuring, consult our guide to [tax advisory services in Switzerland](/tax-accounting/tax-advisory-switzerland/).

---

## Frequently Asked Questions

The FAQ section above addresses the ten most common questions about international tax planning from Switzerland. For situation-specific advice, [contact Morgan Hartley Consulting](/contacts/) for a confidential discussion.
