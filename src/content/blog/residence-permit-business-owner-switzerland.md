...
tocItems:
  - id: "the-fundamental-point-company-ownership-does-not-create-resi"
    title: "The Fundamental Point: Company Ownership Does Not Create Residency"
  - id: "route-1-euefta-nationals-self-employed-status-under-free-mov"
    title: "Route 1: EU/EFTA Nationals — Self-Employed Status Under Free Movement"
  - id: "route-2-non-euefta-nationals-employed-director-route"
    title: "Route 2: Non-EU/EFTA Nationals — Employed Director Route"
  - id: "route-3-cantonal-discretionary-permit-art-19-aig"
    title: "Route 3: Cantonal Discretionary Permit — Art. 19 AIG"
  - id: "the-lump-sum-taxation-route-for-those-who-will-not-work"
    title: "The Lump-Sum Taxation Route: For Those Who Will Not Work"
  - id: "what-most-business-owners-get-wrong"
...
|---|---|
| Live and work in Switzerland through your company | Employed director route (Art. 18 AIG) — requires substance and cantonal approval |
| Live in Switzerland; significant investment, job creation | Art. 19 discretionary cantonal permit — high bar, fully discretionary |
| Live in Switzerland; no Swiss gainful activity | Lump-sum taxation residence permit |
| Operate a Swiss company while based abroad | Swiss GmbH/AG with nominee director; owner remains non-resident |
