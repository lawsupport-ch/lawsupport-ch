...
Search [ZEFIX](/company-formation/zefix-company-search/) (zefix.ch) to verify that your chosen company name is available. The name must be distinguishable from all existing registered entities in Switzerland — not just within your canton. Include the legal form designation (AG, GmbH, etc.) in the name.
...
[ZEFIX](/company-formation/zefix-company-search/) (Zentraler Firmenindex) at zefix.ch is the federal company search portal. It aggregates data from all 26 cantonal registers into a single searchable database.
