...
faqItems:
  ...
  - question: "What are the typical costs of obtaining an L permit in Switzerland?"
    answer: "The cantonal migration office charges CHF 100-200 for the permit itself. Employer-sponsored applications incur legal and administrative fees of CHF 1'500-3'000. The employer bears most costs, as they are the sponsoring party under the FNIA."
  - question: "How long does the L permit application process take?"
    answer: "Processing times vary by canton. Zurich and Zug typically take 4-8 weeks from submission. Geneva and Vaud may take 8-12 weeks. EU/EFTA nationals benefit from faster processing under the Agreement on the Free Movement of Persons."
  - question: "What is the most common mistake when applying for an L permit?"
    answer: "Failing to submit a complete employment contract with all required details (salary, duration, working hours, job description). Incomplete applications are returned without processing, adding weeks to the timeline."
  - question: "Are there cantonal differences in L permit issuance?"
    answer: "Yes. Each canton sets its own processing timeline and may impose additional requirements. German-speaking cantons generally process faster than French-speaking ones. Some cantons require proof of accommodation before issuing the permit."
  - question: "Can an L permit holder change employers during the permit period?"
    answer: "Not without a new application. The L permit is employer-specific. Changing employers requires the new employer to file a fresh permit application with the cantonal migration office, and the old permit is revoked."
tocItems:
  - id: "what-is-the-l-permit"
    title: "What Is the L Permit?"
  - id: "l-permit-for-euefta-nationals"
    title: "L Permit for EU/EFTA Nationals"
  - id: "l-permit-for-non-euefta-nationals"
    title: "L Permit for Non-EU/EFTA Nationals"
  - id: "duration-and-renewal"
    title: "Duration and Renewal"
  - id: "what-the-l-permit-allows"
    title: "What the L Permit Allows"
  - id: "l-permit-and-source-tax-quellensteuer"
    title: "L Permit and Source Tax (Quellensteuer)"
  - id: "common-uses-for-the-l-permit"
