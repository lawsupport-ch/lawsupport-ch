...
faqItems:
  ...
  - question: "What does a nominee shareholder arrangement cost annually?"
    answer: "Standard fees range from CHF 2'000-5'000 per year for straightforward holdings. More complex structures involving multiple share classes or frequent transaction activity cost CHF 5'000-10'000. The initial setup, including the nominee agreement, adds CHF 1'500-3'000."
  - question: "How is dividend income handled in a nominee shareholder arrangement?"
    answer: "The nominee receives dividends as the registered holder and forwards them to the beneficial owner after deducting Swiss withholding tax at 35%. The beneficial owner may reclaim the withholding tax under an applicable double taxation treaty."
  - question: "Can a nominee shareholder arrangement be unwound quickly?"
    answer: "Yes. Share transfers from nominee back to beneficial owner can be executed within days for AG shares. GmbH quota transfers require notarisation, adding 1-2 weeks. The commercial register reflects the change within 3-10 business days depending on the canton."
  - question: "Does a nominee shareholder need to be disclosed to the tax authorities?"
    answer: "The company must maintain a register of beneficial owners under Art. 697j CO. Tax authorities can request this register. The nominee arrangement does not shield the beneficial owner from Swiss or foreign tax obligations."
  - question: "What risks does the beneficial owner face in a nominee shareholder arrangement?"
    answer: "The primary risk is that the nominee acts outside the agreement, such as transferring shares or voting against instructions. Mitigation includes an undated share transfer form, a detailed nominee agreement with penalty clauses, and selecting a regulated fiduciary as nominee."
tocItems:
  - id: "swiss-shareholder-transparency-the-current-position"
    title: "Swiss Shareholder Transparency: The Current Position"
  - id: "beneficial-owner-disclosure-toba-requirements"
    title: "Beneficial Owner Disclosure: TOBA Requirements"
  - id: "nominee-shareholding-is-it-permitted"
    title: "Nominee Shareholding: Is It Permitted?"
  - id: "risks-of-improper-nominee-arrangements"
    title: "Risks of Improper Nominee Arrangements"
  - id: "legitimate-alternatives-to-nominee-shareholding"
    title: "Legitimate Alternatives to Nominee Shareholding"
  - id: "nominee-director-vs-nominee-shareholder"
...
**Art. 697j OR -- Shareholder notification duty:**
Any shareholder or group of shareholders who acquires **5% or more** of the share capital or votes in a Swiss AG or GmbH must notify the company of:
- Their identity (name, address, date of birth)
- The number and type of shares held

**Art. 697k OR -- Beneficial owner declaration:**
The company must request the identity of the **beneficial owner** (wirtschaftlich Berechtigter / ayant droit economique) from shareholders meeting the 25%+ threshold.
...
**Art. 697l OR -- AML obligation:**
Companies in certain regulated sectors must further disclose beneficial owners to FINMA-supervised intermediaries.
...
**4. Voting agreements / family governance:**
For family business confidentiality (not wanting competitors to know the family ownership structure), contractual arrangements can manage governance while ownership is disclosed in the share register.
...
Switzerland is not an EU member state and does not directly implement EU AML Directives. However, Swiss AML legislation (particularly the <a href="https://www.fedlex.admin.ch/eli/cc/1998/892_892_892/en" target="_blank" rel="nofollow noopener">Anti-Money Laundering Act</a>) achieves similar outcomes regarding beneficial ownership transparency. Switzerland also participates in the FATF mutual evaluation process, which assesses alignment with international standards.
