...
heroImage: "/images/hotel-restaurant-license-switzerland-hero.webp"
...
faqItems:
  ...
  - question: "What qualifications are accepted for the responsible manager (Betriebsleiter)?"
    answer: "Accepted qualifications include a federal certificate in restaurant management (eidgenossisches Fahigkeitszeugnis), a cantonal gastronomy course (3-5 days, CHF 300-800), or an equivalent recognised qualification from Switzerland or an EU/EFTA member state. Foreign qualifications must demonstrate equivalence and may require cantonal assessment."
  - question: "What are the total costs of opening a restaurant in Switzerland?"
    answer: "Licensing costs alone include: Wirtepatent fee CHF 200-500, gastronomy course CHF 300-800, criminal and debt register extracts CHF 40-80, HACCP documentation CHF 500-2,000, and SUISA registration CHF 200-2,000 per year. These are separate from fit-out, rent, and company formation costs. Budget CHF 1,500-5,000 for the licensing process itself."
  - question: "What are the L-GAV minimum wages for hospitality workers in 2026?"
    answer: "The L-GAV sets minimum wages tiered by function and experience. A kitchen assistant in Zurich earns a minimum of approximately CHF 3,800 per month gross. Qualified cooks and service staff earn more. These minimums are mandatory regardless of union membership and are enforced by cantonal labour inspectorates. Foreign operators consistently underestimate Swiss labour costs."
  - question: "Do I need a separate licence for each restaurant or hotel I operate?"
    answer: "Yes. The Wirtepatent is tied to both the operator and the specific premises. Operating three restaurants requires three separate licences. If the responsible manager changes at one location, that licence must be updated or reissued. Operating without a valid licence for any single premises is an administrative offence."
  - question: "What happens if my responsible manager leaves unexpectedly?"
    answer: "You cannot operate legally until a replacement is licensed. Most cantons offer no grace period. The cantonal gastronomy course takes weeks to schedule, and the licence transfer process adds 4-8 weeks. For small operations, this is the most underestimated operational risk in Swiss hospitality. Consider having a second qualified person on staff as contingency."
tocItems:
  ...
  - id: "music-events-and-entertainment"
    title: "Music, Events, and Entertainment"
  - id: "l-gav-the-national-collective-labour-agreement"
    title: "L-GAV: The National Collective Labour Agreement"
  - id: "hotel-specific-requirements"
    title: "Hotel-Specific Requirements"
  - id: "costs-and-timeline"
    title: "Costs and Timeline"
  - id: "cantonal-differences-worth-knowing"
    title: "Cantonal Differences Worth Knowing"
  - id: "vat-considerations"
    title: "VAT Considerations"
  - id: "step-by-step-checklist-opening-a-restaurant-or-hotel-in-swit"
...
![Swiss town with traditional hotel and restaurant buildings along the riverfront](/images/hotel-restaurant-license-switzerland-hero.webp)
...
These are not optional. <a href="https://www.suisa.ch/en/" target="_blank" rel="nofollow noopener">SUISA</a> actively audits establishments and pursues back-payments with interest.
...
3. Identify your qualified responsible manager; confirm their qualification is recognised in the relevant canton
4. Book the cantonal gastronomy course if a federal certificate is not held
5. Obtain criminal register and debt enforcement extracts (valid within 3 months)
6. Submit the Wirtepatent application to the cantonal authority with all supporting documents
7. Register with the cantonal veterinary office for food safety supervision
8. Prepare and document the HACCP concept
9. Register with SUISA if music will be played
