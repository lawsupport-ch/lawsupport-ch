...
faqItems:
  ...
  - question: "Which transfer pricing methods are accepted by Swiss tax authorities?"
    answer: "Swiss practice follows the OECD Transfer Pricing Guidelines. Accepted methods include the Comparable Uncontrolled Price method, Resale Price method, Cost Plus method, Transactional Net Margin Method, and Profit Split method. The method selection must be justified by a functional analysis."
  - question: "Can Swiss tax authorities make a secondary adjustment after a transfer pricing correction?"
    answer: "Yes. If the primary adjustment recharacterises excess payments as hidden profit distributions, a secondary adjustment imposing 35% withholding tax on the deemed dividend typically follows. This creates an effective combined burden that substantially exceeds the corporate income tax adjustment alone."
  - question: "How does the arm's length principle apply to management fees between Swiss group companies?"
    answer: "Management fees must reflect services actually rendered and be priced at arm's length. The ESTV scrutinises management fee charges closely, particularly fees paid to foreign parent companies. Documentation should demonstrate the nature, scope, and benefit of services received, with benchmarked mark-ups where applicable."
  - question: "Are advance pricing agreements available in Switzerland?"
    answer: "Switzerland does not have a formal unilateral APA programme. However, taxpayers can request advance tax rulings from cantonal tax authorities on specific transfer pricing methodologies. Bilateral APAs are available through the mutual agreement procedure under applicable double tax treaties."
  - question: "What triggers a transfer pricing audit in Switzerland?"
    answer: "Common triggers include significant related-party transactions with low-tax jurisdictions, sudden profit margin changes, large management fee or royalty payments abroad, and restructurings that shift functions or risks out of Switzerland. Cantonal tax inspectors increasingly use CbCR data to identify audit targets."
tocItems:
  - id: "the-arms-length-principle-in-swiss-law"
    title: "The Arm's Length Principle in Swiss Law"
  - id: "transfer-pricing-methods"
    title: "Transfer Pricing Methods"
  - id: "key-related-party-transaction-types"
    title: "Key Related-Party Transaction Types"
  - id: "documentation-requirements"
    title: "Documentation Requirements"
  - id: "advance-pricing-agreements-apas"
    title: "Advance Pricing Agreements (APAs)"
  - id: "hidden-profit-distribution-the-withholding-tax-risk"
    title: "Hidden Profit Distribution: The Withholding Tax Risk"
  - id: "beps-and-swiss-implementation"
    title: "BEPS and Swiss Implementation"
  - id: "transfer-pricing-in-practice-common-audit-triggers"
...
<!-- VIDEO: Transfer pricing documentation requirements and audit preparation for Swiss multinational groups -->
...
Yes. Swiss-headquartered multinational groups with consolidated annual revenue above CHF 900 million must file a CbCR with the ESTV. Reports are exchanged with treaty partner jurisdictions under the automatic exchange framework established by the <a href="https://www.admin.ch" target="_blank" rel="nofollow noopener">Swiss Federal Council</a>.
