...
faqItems:
  ...
  - question: "What happens to my application if we separate before the decision?"
    answer: "The application fails. Facilitated naturalisation requires that the marriage is genuine and ongoing at the time of the SEM's decision. If the marriage dissolves before the decree is issued, eligibility is extinguished. You would need to switch to the ordinary naturalisation track."
  ...
  - question: "Can same-sex spouses apply for facilitated naturalisation?"
    answer: "Yes. Since 1 July 2022, same-sex spouses have the same access to facilitated naturalisation as opposite-sex spouses. The eligibility requirements — marriage duration, residence, integration — apply identically."
  - question: "Does the SEM interview both spouses separately?"
    answer: "Typically, yes. The SEM conducts separate interviews to assess the genuineness of the marriage. Each spouse is asked detailed questions about daily life, routines, and shared activities. Inconsistencies between the two accounts can trigger additional investigation rounds."
  - question: "What evidence proves a genuine marriage to the SEM?"
    answer: "The SEM considers shared address registration, joint bank accounts, joint lease agreements, utility bills, photographs of shared holidays, travel records, and evidence of mutual knowledge of each other's daily lives. No single document is decisive — the assessment is holistic."
  - question: "Can I apply from abroad if my Swiss spouse lives in Switzerland?"
    answer: "The abroad route under Art. 21(2) BüG requires six years of marriage and does not require Swiss residence. If your Swiss spouse lives in Switzerland but you do not, you would need to assess whether the in-Switzerland route (three years marriage, five years residence) or the abroad route applies to your specific situation."
  - question: "What happens if my Swiss spouse dies during the application process?"
    answer: "The death of the Swiss spouse during the application process is assessed case by case. If the application was complete and the marriage was genuine at the time of death, the SEM may still process it. However, if the Swiss spouse dies before the application is filed, eligibility for facilitated naturalisation is extinguished."
  - question: "Is there an age limit for facilitated naturalisation by marriage?"
    answer: "No. There is no minimum or maximum age for applying. The eligibility requirements are marriage duration, residence, integration, and genuine community of life — age is not a factor."
  - question: "How much does facilitated naturalisation cost in total?"
    answer: "Government fees total approximately CHF 600 to CHF 900 (federal fee CHF 400, cantonal and communal fees CHF 100 to CHF 500). Professional legal fees, if engaged, typically range from CHF 2'000 to CHF 6'000. This is substantially cheaper than ordinary naturalisation."
tocItems:
  - id: "the-shortcut-and-the-catch"
    title: "The Shortcut and the Catch"
  - id: "eligibility-requirements-living-in-switzerland"
    title: "Eligibility Requirements: Living in Switzerland"
  - id: "eligibility-requirements-living-abroad"
    title: "Eligibility Requirements: Living Abroad"
  - id: "the-genuineness-investigation-what-actually-happens"
    title: "The Genuineness Investigation: What Actually Happens"
  - id: "case-study-the-couple-who-couldnt-name-the-same-restaurants"
    title: "Case Study: The Couple Who Couldn't Name the Same Restaurants"
  ...
  - id: "costs"
    title: "Costs"
  - id: "four-traps-that-derail-facilitated-naturalisation"
    title: "Four Traps That Derail Facilitated Naturalisation"
...
This guide sets out the precise legal requirements under Article 21 of the <a href="https://www.fedlex.admin.ch/eli/cc/2016/404/en" target="_blank" rel="nofollow noopener">Federal Act on Swiss Citizenship (Bürgerrechtsgesetz, BüG)</a>, the application process, realistic timelines, costs, and the specific situations that derail what would otherwise be successful applications.
...
- **Valid permit:** A [B permit](/immigration/b-permit-switzerland/) is sufficient; a [C permit](/immigration/c-permit-switzerland/) is not required.
...
<!-- VIDEO: What to expect during the SEM marriage genuineness assessment for facilitated naturalisation -->
...
6. **Registration:** The new Swiss citizen is registered in the civil registry of the Swiss spouse's Heimatgemeinde, and may then apply for a [Swiss passport](/immigration/swiss-passport/).
...
| Cantonal/communal registration fees | CHF 100–500 |
| Language certification | CHF 150–350 |
...
| Factor | Facilitated | Ordinary |
|---|---|---|
| Residence required | 5 years total (in CH) | 10 years (3 continuous) |
| Permit required | B or C | C only |
| Deciding authority | SEM (federal only) | Communal + cantonal + federal |
| Communal vote | No | Yes (in most cantons) |
| Timeline from application | 1–2 years | 1–3 years (after eligibility met) |
| Federal fee | CHF 400 | CHF 100 + cantonal/communal fees |
...
- Advise on [dual citizenship](/immigration/swiss-dual-citizenship/) implications under the home country's law
