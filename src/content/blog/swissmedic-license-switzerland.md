...
faqItems:
  ...
  - question: "Can I sell medical devices in Switzerland with only a CE mark?"
    answer: "A CE mark from an EU-recognised notified body supports the Swiss conformity pathway, but it is not sufficient on its own. The device must also be registered in Switzerland, and non-Swiss manufacturers must appoint a Swiss Authorised Representative (CH-REP) based in Switzerland."
  - question: "What is a clock-stop in the Swissmedic review process?"
    answer: "When Swissmedic identifies a deficiency in a marketing authorisation dossier, it issues a list of questions and halts the review clock entirely. The clock only restarts when the applicant provides a complete response. Each round of questions typically adds 3 to 6 months to the overall timeline."
  - question: "Do I need a Swiss company to apply for Swissmedic authorisation?"
    answer: "The marketing authorisation holder must have a legal address in Switzerland. Foreign companies without a Swiss presence typically establish a Swiss subsidiary or appoint a local regulatory affairs representative. A valid Swiss UID is required at the time of filing."
  - question: "Are Swissmedic GMP inspections recognised in the EU?"
    answer: "Yes, under the Swiss-EU Mutual Recognition Agreement. Swissmedic GMP certificates are recognised by EU competent authorities without re-inspection, and vice versa. This bilateral arrangement does not extend to the UK post-Brexit."
  - question: "What are the penalties for selling unauthorised therapeutic products in Switzerland?"
    answer: "Operating without the required Swissmedic authorisation is a criminal offence under the Therapeutic Products Act (HMG), not merely a regulatory infraction. Penalties include fines and imprisonment. Swissmedic actively monitors the market and investigates unauthorised distribution."
  - question: "How often must a Swissmedic marketing authorisation be renewed?"
    answer: "Every five years. The renewal application must demonstrate ongoing pharmacovigilance compliance, updated safety data, and any approved formulation or labelling changes. Failure to renew results in the authorisation lapsing and the product being withdrawn from the Swiss market."
  - question: "Can I conduct clinical trials in Switzerland without ethics committee approval?"
    answer: "No. Clinical trials require dual authorisation from both Swissmedic and the relevant cantonal ethics committee. Both must approve before the trial can begin. Swissmedic reviews the investigational product data, while the ethics committee reviews the protocol and patient consent procedures."
tocItems:
  - id: "what-is-swissmedic"
    title: "What Is Swissmedic?"
  - id: "pharmaceutical-marketing-authorisation-zulassung"
    title: "Pharmaceutical Marketing Authorisation (Zulassung)"
  - id: "manufacturing-licence"
    title: "Manufacturing Licence"
  - id: "import-licence"
    title: "Import Licence"
  - id: "clinical-trial-authorisation"
    title: "Clinical Trial Authorisation"
  - id: "medical-device-regulation-in-switzerland"
    title: "Medical Device Regulation in Switzerland"
  - id: "the-swiss-eu-mutual-recognition-agreement"
    title: "The Swiss-EU Mutual Recognition Agreement"
  - id: "why-switzerlands-regulatory-environment-matters-commercially"
...
Swissmedic applies the Common Technical Document (CTD) format, consistent with <a href="https://www.ich.org" target="_blank" rel="nofollow noopener">ICH guidelines</a>.
...
<!-- VIDEO: Overview of the Swiss clinical trial approval process and timelines -->

---

## Medical Device Regulation in Switzerland

Switzerland aligned its medical device regulatory framework with the EU Medical Device Regulation (MDR, 2017/745) and the EU In Vitro Diagnostic Medical Device Regulation (IVDR, 2017/746) with effect from May 2021. The <a href="https://www.fedlex.admin.ch/eli/cc/2020/552/en" target="_blank" rel="nofollow noopener">MepV/ODim</a> transposes these EU frameworks into Swiss law.
