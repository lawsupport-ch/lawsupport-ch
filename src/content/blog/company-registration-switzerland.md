---
title: "Company Registration in Switzerland: Step-by-Step Guide (2026)"
description: "Register a company in Switzerland in 2–4 weeks. Costs, legal requirements, and the exact steps from name check to Commercial Register entry."
date: "29.04.2026"
publishDate: "2026-04-29"
heroImage: "/images/company-registration-switzerland.webp"
category: "Company Formation"
categoryHref: "/company-formation/"
readTime: "8 min read"
faqItems:
  - question: "How long does company registration in Switzerland take?"
    answer: "A standard GmbH or AG registration takes 2 to 4 weeks from the notarial signing to the Commercial Register entry. Banking delays — particularly for the blocked capital deposit account — are the most common cause of extensions. Complex structures can take 6 to 8 weeks."
  - question: "What is the minimum share capital for company registration in Switzerland?"
    answer: "For a GmbH, the minimum is CHF 20,000, fully paid in at formation. For an AG, the minimum is CHF 100,000, with at least CHF 50,000 paid in at registration. The capital must be deposited in a Swiss bank before the notarial appointment."
  - question: "Do I need to be a Swiss resident to register a company in Switzerland?"
    answer: "No. Foreign nationals can own 100% of a Swiss GmbH or AG. However, at least one managing director (GmbH) or one board member with individual signatory rights (AG) must be domiciled in Switzerland. If no founder lives in Switzerland, a nominee director can satisfy this requirement."
  - question: "What documents are required for Swiss company registration?"
    answer: "The core documents are: articles of association (Gesellschaftsvertrag or Statuten), the Stampa Declaration signed by each founder, a capital deposit confirmation from a Swiss bank, and identity documents for all founders and directors. Non-Swiss documents typically require certified translation and/or apostille."
  - question: "Which Swiss canton is best for registering a company?"
    answer: "Zug is the most popular canton for international founders due to its low effective corporate tax rate (approximately 11.9% combined), fast Commercial Register processing, and established professional services ecosystem. Zurich suits businesses that need a major-city address. The right choice depends on your operational needs and tax situation."
  - question: "Can I register a Swiss company online without travelling to Switzerland?"
    answer: "Yes. The entire process can be handled remotely via power of attorney. Founders sign documents locally, have them certified or apostilled, and a Swiss representative attends the notarial meeting. No physical travel is required."
tocItems:
  - id: "which-legal-form-should-you-choose"
    title: "Which Legal Form Should You Choose?"
  - id: "step-by-step-company-registration-in-switzerland"
    title: "Step-by-Step: Company Registration in Switzerland"
  - id: "costs-of-company-registration"
    title: "Costs of Company Registration"
  - id: "the-stampa-declaration-what-it-is-and-why-it-matters"
    title: "The Stampa Declaration"
  - id: "swiss-resident-director-requirement"
    title: "Swiss Resident Director Requirement"
  - id: "choosing-the-right-canton"
    title: "Choosing the Right Canton"
  - id: "common-registration-mistakes"
    title: "Common Registration Mistakes"
relatedArticles:
  ...
  - title: "Swiss Shelf Companies: Ready-Made AG and GmbH"
    href: "/company-formation/ready-made-companies-switzerland/"
---
...
The GmbH suits most SMEs, subsidiaries, and service businesses. The AG is preferred when shareholder privacy matters, when investor rounds are planned, or when the business involves significant capital — see our [AG formation guide](/company-formation/ag-formation-switzerland/) for a full comparison.
...
Search the <a href="https://www.zefix.ch" target="_blank" rel="nofollow noopener">ZEFIX federal commercial register portal</a> to confirm your proposed name is available. The name must be unique, not misleading, and must include the legal form designation ("GmbH", "AG", "Sàrl", etc.). Names implying a public authority, bank, or regulated activity require additional authorisation.
...
For a full breakdown of the banking situation, see our guide to [corporate bank accounts in Switzerland](/banking/corporate-bank-account-switzerland/).
...
Once the entry is confirmed, the Commercial Register publishes the company in the Swiss Official Gazette of Commerce (<a href="https://www.shab.ch" target="_blank" rel="nofollow noopener">SHAB</a>). The bank then releases the blocked capital into the company's operating account.
...
1. No separate agreements exist about the shares beyond what is stated in the articles
2. No contributions in kind are being made unless explicitly disclosed
3. The subscriber is the true and sole beneficial owner of the shares being subscribed
...
This is the most common practical obstacle for foreign founders. Article 718 of the <a href="https://www.fedlex.admin.ch/eli/cc/27/317_321_377/en" target="_blank" rel="nofollow noopener">Swiss Code of Obligations</a> requires that at least one managing director with individual signatory rights be domiciled in Switzerland. The same principle applies to AG boards under Article 707.
...
See our [nominee director service](/corporate-services/nominee-director-switzerland/) for full details and current pricing.
...
For a full breakdown, see our [cantonal tax comparison](/tax-accounting/cantonal-tax-comparison-switzerland/).
...
For context on the broader Swiss company formation process, start with our guide to [company formation in Switzerland](/company-formation/company-formation-switzerland/).
