---
title: "Aktiengesellschaft (AG) in Switzerland Explained"
description: "What is a Swiss Aktiengesellschaft? Structure, capital, governance, tax treatment, and how the AG compares to UK PLC, US Corp, and German AG."
date: "08.04.2026"
...
pageLevel: 3
tocItems:
  - id: "what-is-an-aktiengesellschaft"
    title: "What Is an Aktiengesellschaft?"
  - id: "key-features-of-a-swiss-ag"
    title: "Key Features of a Swiss AG"
  - id: "ag-vs-gmbh-when-to-choose-which"
    title: "AG vs GmbH: When to Choose Which"
  - id: "how-the-swiss-ag-compares-internationally"
    title: "How the Swiss AG Compares Internationally"
  - id: "governance-and-board-structure"
    title: "Governance and Board Structure"
  - id: "tax-treatment-of-a-swiss-ag"
    title: "Tax Treatment of a Swiss AG"
  - id: "forming-an-aktiengesellschaft-in-switzerland"
    title: "Forming an Aktiengesellschaft in Switzerland"
faqItems:
  - question: "What does Aktiengesellschaft mean in English?"
    answer: "Aktiengesellschaft translates literally as 'stock company' or 'share company.' It is the Swiss equivalent of a UK public limited company (PLC), a US corporation (Corp/Inc), or a French société anonyme (SA). The abbreviation AG appears after the company name in the Commercial Register."
  - question: "What is the minimum capital for a Swiss Aktiengesellschaft?"
    answer: "CHF 100,000. At least CHF 50,000 (or 20% of total capital, whichever is greater) must be paid in at the time of incorporation. The remaining amount may be left as uncalled capital, subject to call by the board when needed."
  - question: "Is the Aktiengesellschaft the same as a GmbH?"
    answer: "No. The Aktiengesellschaft (AG) is a corporation with share capital, anonymous ownership, and a mandatory board of directors. The GmbH (Gesellschaft mit beschränkter Haftung) is a limited liability company with lower capital (CHF 20,000), members listed publicly in the Commercial Register, and a managing officer structure."
  - question: "Can a foreigner own a Swiss Aktiengesellschaft?"
    answer: "Yes. There are no nationality restrictions on AG share ownership. Foreign nationals and foreign companies may hold 100% of the shares. The only residency requirement is that at least one board member with signatory authority must be resident in Switzerland."
  - question: "How long does it take to set up an Aktiengesellschaft in Switzerland?"
    answer: "A standard AG formation takes 3-6 weeks from first instruction to Commercial Register entry. The bank account opening and capital deposit typically account for the longest portion of that timeline."
  - question: "What is the difference between a Swiss AG and a German AG?"
    answer: "Both are share corporations, but they differ in minimum capital (CHF 100,000 vs EUR 50,000), governance rules, and audit requirements. Swiss AGs have more flexible board structures and lower regulatory overhead for private companies. German AGs must have a supervisory board (Aufsichtsrat) separate from the management board (Vorstand) — Swiss AGs do not require this dual-board structure."
relatedArticles:
  - title: "AG Formation Switzerland: Step-by-Step Guide (2026)"
    href: "/company-formation/ag-formation-switzerland/"
  - title: "Swiss Entity Types Compared: AG, GmbH & More"
...
An Aktiengesellschaft (AG) is Switzerland's primary corporate vehicle, equivalent to a UK PLC or US corporation. Governed by <a href="https://www.fedlex.admin.ch/eli/cc/27/317_321_377/en" target="_blank" rel="nofollow noopener">Art. 620–763 of the Swiss Code of Obligations (CO)</a>, the AG is a share corporation with limited liability, a mandatory board of directors, and a minimum share capital of CHF 100'000. It accounts for roughly 35% of all commercial entities in the Swiss Commercial Register. If you already know you want to form one, see our [step-by-step AG formation guide](/company-formation/ag-formation-switzerland/). This article explains what the Aktiengesellschaft actually is, how it works, and when it is the right choice.
...
Switzerland had approximately 220'000 registered AGs as of early 2026, according to data from <a href="https://www.zefix.ch/" target="_blank" rel="nofollow noopener">ZEFIX (the Central Business Name Index)</a>. The AG is used by single-person businesses, family offices, multinational holding structures, and publicly listed companies alike.
...
**Ownership privacy.** Shareholders are recorded in the company's internal share register (Aktienbuch), not in the public Commercial Register. This is the principal privacy advantage over the [GmbH](/company-formation/gmbh-formation-switzerland/), where every quota holder's name is publicly visible.
...
The AG and the [GmbH](/company-formation/gmbh-formation-switzerland/) are the two standard commercial entities in Switzerland. They share limited liability and separate legal personality but differ in critical areas.
...
**Choose an AG when:** you need shareholder privacy, plan to raise capital from institutional investors (many fund mandates exclude GmbH investments), intend to create a [holding structure](/company-formation/holding-company-switzerland/), or anticipate frequent share transfers.

**Choose a GmbH when:** you want lower capital commitment, run an owner-managed business, and do not require ownership confidentiality. For a full entity comparison, see [Swiss entity types compared](/company-formation/swiss-entity-types-compared/).
...
- **US C-Corp vs Swiss AG.** Delaware imposes no minimum capital. Swiss law requires CHF 100'000, of which at least CHF 50'000 must be deposited before formation. US corporations face state-level franchise taxes; Swiss AGs pay federal, cantonal, and municipal [corporate income tax](/tax-accounting/corporate-tax-switzerland/).
...
1. **Strategic direction** — setting the company's overall direction and issuing necessary directives
2. **Financial oversight** — organising accounting, financial controls, and financial planning
3. **Appointment and supervision** — appointing and removing management, determining signatory rights
...
**Withholding tax on dividends.** Switzerland levies a 35% withholding tax (Verrechnungssteuer) on dividend distributions. Swiss-resident individual shareholders can reclaim this in full through their tax return. Foreign shareholders may obtain partial or full relief under an applicable [double tax treaty](/tax-accounting/double-tax-treaties-switzerland/).

**Participation exemption.** If the AG holds at least 10% of another company's share capital (or a participation worth CHF 1 million), dividend income and capital gains from that participation qualify for the participation deduction (Beteiligungsabzug). This effectively eliminates double taxation and makes the AG the standard vehicle for [holding company structures](/company-formation/holding-company-switzerland/).
...
For full details on corporate taxation, see [corporate tax Switzerland](/tax-accounting/corporate-tax-switzerland/).

## Forming an Aktiengesellschaft in Switzerland

The AG formation process has distinct stages. A detailed walkthrough is in our [AG formation guide](/company-formation/ag-formation-switzerland/); the summary below covers the essential steps.
...
**5. Post-registration.** Register for VAT if annual turnover exceeds CHF 100'000 (see [VAT guide](/tax-accounting/vat-switzerland/)). Register with AHV/social insurance authorities if hiring employees. Convert the capital deposit account into a regular corporate bank account.
...
Morgan Hartley Consulting has been forming Swiss companies for over 18 years from our office at Baarerstrasse 135, 6300 Zug. We have completed more than 1,000 formations for founders and companies in over 40 countries. Whether you need a new AG, a [ready-made shelf company](/company-formation/shelf-company-switzerland/), or guidance on the right entity type, we manage every step — from articles of association to Commercial Register entry.
