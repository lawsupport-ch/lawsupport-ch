...
faqItems:
  - question: "What corporate services does a Swiss company need?"
    answer: "Every Swiss company requires at minimum: a registered address (Sitz) entered in the commercial register, at least one Swiss-resident person with signatory authority, proper bookkeeping under OR Art. 957-963, annual financial statements, an annual general meeting within 6 months of the financial year-end, corporate tax filings, and social insurance registration if the company has employees. Additional services such as nominee directors, virtual offices, and outsourced accounting become relevant depending on the company structure and owner residency."
  - question: "Do I need a physical office to register a company in Switzerland?"
    answer: "You need a physical address, not necessarily your own office. A registered address (Sitz) must be a real location — PO boxes are not accepted. If you do not have office space, you can use a domicile service (c/o address) provided by a law firm, fiduciary company, or virtual office provider. The domicile provider receives official correspondence and serves as the company address for commercial register purposes."
  - question: "What is a nominee director and is it legal?"
    answer: "A nominee director is appointed to the board to satisfy the Swiss-resident director requirement when the beneficial owner is not resident in Switzerland. Nominee directorships are fully legal but carry real responsibilities. The nominee must fulfil all duties of a director under the Code of Obligations, including duty of care, loyalty, and proper management. The nominee is personally liable for compliance failures."
  - question: "Does my Swiss company need an audit?"
    answer: "It depends on size. Large companies (exceeding two of: CHF 20 million total assets, CHF 40 million revenue, or 250 employees in two consecutive years) require an ordinary audit. Smaller companies undergo a limited audit (review engagement). Companies with fewer than 10 full-time employees can opt out entirely (opting-out) if all shareholders agree — this must be recorded in the articles of association."
  - question: "What ongoing compliance obligations does a Swiss company have?"
    answer: "Swiss companies must maintain proper books and records, file annual accounts with the commercial register (for certain legal forms), hold an annual general meeting within 6 months of year-end, submit VAT returns if registered, file corporate tax returns, comply with social insurance obligations (AHV/IV/EO, BVG, UVG) for employees, and maintain an up-to-date share register. Failure to meet these obligations can result in fines, director liability, and court-ordered dissolution."
  - question: "How much does a virtual office cost in Switzerland?"
    answer: "Basic virtual office packages (registered address, mail handling, phone answering) cost CHF 200-500 per month. Premium packages with meeting room access, co-working space, and administrative support range from CHF 500-1,500 per month. Pricing varies by location — Zug and Zurich are at the higher end, while smaller cantons may offer lower rates. Annual contracts are standard."
  - question: "Can a foreign company operate in Switzerland without forming a local entity?"
    answer: "If a foreign company conducts business activities in Switzerland, it must register a branch office (Zweigniederlassung) with the commercial register. The branch needs a registered address, a Swiss-resident representative, and must file annual accounts. A virtual office can serve as the branch address, but the branch itself must be formally registered. Simply renting a virtual office without a legal entity is not sufficient."
  - question: "What accounting obligations apply to Swiss companies?"
    answer: "All Swiss companies must maintain proper books and records under OR Art. 957-963 using double-entry bookkeeping. Annual financial statements must include a balance sheet, profit and loss statement, and notes. Larger companies must prepare a cash flow statement and management report. Financial statements must comply with Swiss GAAP or, for listed companies, IFRS. Sole proprietorships and partnerships with less than CHF 500,000 annual revenue may use simplified bookkeeping."
  - question: "What happens if my company lacks a Swiss-resident director?"
    answer: "The commercial register requires at least one person with signatory authority to be resident in Switzerland. Without this, the register will refuse to register a new company or, for existing companies, may initiate dissolution proceedings. The solution is to appoint a nominee director who is Swiss-resident. This is a common arrangement for companies owned by non-residents."
  - question: "What social insurance must a Swiss employer provide?"
    answer: "Employers must contribute to: AHV/IV/EO (old-age, disability, income replacement) at 5.3% of salary; ALV (unemployment insurance) at 1.1% up to CHF 148,200; BVG (occupational pension) with employer paying at least 50% of the total contribution; UVG (accident insurance) with employer paying non-occupational accident premiums; and FAK (family compensation) at 1-3% depending on canton. Total employer social insurance costs amount to approximately 15-20% of gross salary."
tocItems:
  - id: "what-are-corporate-services"
    title: "What Are Corporate Services?"
  - id: "registered-address-and-domicile"
    title: "Registered Address and Domicile"
  - id: "virtual-office-solutions"
    title: "Virtual Office Solutions"
  - id: "nominee-director-services"
    title: "Nominee Director Services"
  - id: "corporate-secretary-and-governance"
    title: "Corporate Secretary and Governance"
  - id: "accounting-and-bookkeeping-obligations"
    title: "Accounting and Bookkeeping Obligations"
  - id: "audit-requirements"
    title: "Audit Requirements"
  - id: "social-insurance-and-employer-obligations"
    title: "Social Insurance and Employer Obligations"
  - id: "annual-general-meeting-and-filings"
    title: "Annual General Meeting and Filings"
  - id: "ongoing-compliance-calendar"
    title: "Ongoing Compliance Calendar"
  - id: "costs-of-corporate-services"
...
Running a Swiss company involves more than formation and banking. Every AG, GmbH, or branch office must maintain a registered address, keep proper books, hold annual meetings, file tax returns, and comply with social insurance obligations — regardless of whether the owner lives in Switzerland or abroad. This guide covers the full range of corporate administration and infrastructure services, drawing on our detailed resource on [corporate infrastructure in Switzerland](/corporate-services/corporate-infrastructure-switzerland/), and explains what you need to keep your Swiss company compliant and operational.
...
For a complete overview of infrastructure options including virtual offices, nominee arrangements, and accounting software, see our [corporate infrastructure guide](/corporate-services/corporate-infrastructure-switzerland/).
...
Our [corporate infrastructure guide](/corporate-services/corporate-infrastructure-switzerland/) covers virtual office selection and branch office requirements in detail.
...
For detailed guidance on accounting software options, see our [corporate infrastructure guide](/corporate-services/corporate-infrastructure-switzerland/).
...
For a detailed breakdown of specific infrastructure components — registered addresses, virtual offices, nominee arrangements, and accounting software — see our [corporate infrastructure guide](/corporate-services/corporate-infrastructure-switzerland/).
