...
tocItems:
  ...
  - id: "the-three-level-tax-filing-requirement"
    title: "The Three-Level Tax Filing Requirement"
  - id: "filing-deadlines"
    title: "Filing Deadlines"
  - id: "what-the-return-requires"
    title: "What the Return Requires"
  - id: "common-adjustments-and-traps"
    title: "Common Adjustments and Traps"
...
**4. Participation schedule (if applicable)**
Companies claiming participation exemption on dividends or capital gains from qualifying shareholdings must disclose the holdings and the amounts claimed.

**5. IP Box / R&D schedule (if applicable)**
Companies claiming IP Box relief or R&D super-deductions must file a separate schedule detailing the qualifying income/expenditure and the nexus calculation.
