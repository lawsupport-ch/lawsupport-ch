...
faqItems:
  - question: "What is the corporate tax rate in Switzerland?"
    answer: "The federal corporate income tax rate is 8.5% on profit after tax. Cantonal and municipal taxes add to this, resulting in effective combined rates ranging from approximately 11.9% (Zug) to 24% (Geneva). The exact rate depends on the canton and municipality where the company is registered."
  - question: "Do Swiss companies have to register for VAT?"
    answer: "Yes, if worldwide turnover from taxable supplies exceeds CHF 100,000 per year. Voluntary registration is possible below this threshold. Once registered, the company must charge VAT (MWST) on taxable supplies, file quarterly returns and remit the balance to the Federal Tax Administration."
  - question: "What are the Swiss VAT rates?"
    answer: "The standard rate is 8.1%. A reduced rate of 2.6% applies to everyday necessities such as food, non-alcoholic beverages, books and newspapers. A special rate of 3.8% applies to accommodation services. Certain services (healthcare, education, financial services) are exempt."
  - question: "How does Switzerland avoid double taxation?"
    answer: "Switzerland has signed over 100 double taxation agreements (DTAs) with countries worldwide. These treaties allocate taxing rights between jurisdictions and provide mechanisms for credit or exemption to prevent the same income being taxed twice. The treaties follow the OECD Model Convention with Swiss-specific modifications."
  - question: "What is the patent box regime?"
    answer: "The patent box allows qualifying income from patents and comparable rights to be taxed at a reduced rate. Up to 90% of qualifying patent income can be excluded from the cantonal tax base. The federal tax does not offer a patent box — this is purely a cantonal instrument, and each canton sets its own reduction percentage."
  - question: "When are Swiss corporate tax returns due?"
    answer: "Filing deadlines vary by canton but typically fall 6-9 months after the financial year-end. For companies with a 31 December year-end, the deadline is usually 30 June or 30 September of the following year. Extensions are commonly granted upon request. Late filing results in assessment by estimation, which is almost always unfavourable."
  - question: "Do I need an auditor for my Swiss company?"
    answer: "An ordinary audit is required if the company exceeds two of three thresholds: CHF 20 million in total assets, CHF 40 million in revenue, or 250 full-time employees. Below these thresholds, a limited (review) audit applies. Companies with fewer than 10 full-time employees may opt out of audit entirely with unanimous shareholder consent."
  - question: "What social insurance contributions must Swiss employers pay?"
    answer: "Employers contribute approximately 6.4% of gross salary for AHV/IV/EO (old age, disability, loss of earnings insurance), plus BVG (occupational pension) contributions which vary by provider and plan, UVG (accident insurance) premiums, and ALV (unemployment insurance) of 1.1% up to CHF 148,200. Total employer social costs typically amount to 12-18% of gross salary depending on the pension plan."
  - question: "Can I get a tax ruling from Swiss authorities?"
    answer: "Yes. Swiss cantonal tax authorities issue advance tax rulings on the tax treatment of planned transactions. These rulings are binding on the authority that issues them, provided the facts match what was described. Rulings are commonly sought for holding structures, IP migration, reorganisations and individual tax status (lump-sum taxation)."
  - question: "What accounting standards apply in Switzerland?"
    answer: "All companies must comply with the Code of Obligations (OR, Art. 957-963b) as a minimum. Larger companies and those with public debt may adopt Swiss GAAP FER or IFRS. Listed companies on the SIX Swiss Exchange must use IFRS or US GAAP. The choice of standard affects reporting requirements, disclosure levels and audit scope."
tocItems:
  - id: "the-swiss-tax-system"
    title: "The Swiss Tax System"
  - id: "corporate-taxation"
    title: "Corporate Taxation"
  - id: "international-tax-structures"
    title: "International Tax Structures"
  - id: "vat-obligations"
    title: "VAT Obligations"
  - id: "tax-incentives-and-special-regimes"
    title: "Tax Incentives and Special Regimes"
  - id: "accounting-and-payroll-requirements"
    title: "Accounting and Payroll Requirements"
...
For a thorough analysis of corporate tax rates, filing obligations, cantonal comparisons and planning considerations, see our guide to [Swiss corporate tax](/tax-accounting/corporate-tax-overview-switzerland/).
...
For full coverage of treaties, holding structures, transfer pricing and cross-border planning, see our guide to [international tax planning in Switzerland](/tax-accounting/international-tax-planning-switzerland/).

## VAT Obligations

Value Added Tax (Mehrwertsteuer, MWST) is a federal consumption tax administered by the <a href="https://www.estv.admin.ch/en/home.html" target="_blank" rel="nofollow noopener">Federal Tax Administration (FTA)</a>. It applies to most supplies of goods and services within Switzerland.
...
For registration procedures, rate details, filing obligations and cross-border VAT rules, see our [Swiss VAT guide](/tax-accounting/swiss-vat-guide/).
...
For a full analysis of available incentives including eligibility criteria, cantonal implementation differences and application procedures, see our guide to [tax incentives in Switzerland](/tax-accounting/tax-incentives-switzerland/).
...
For detailed coverage of accounting standards, bookkeeping rules, audit thresholds, payroll processing and social insurance registration, see our guide to [accounting and payroll in Switzerland](/tax-accounting/accounting-payroll-switzerland/).
