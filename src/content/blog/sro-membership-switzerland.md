...
tocItems:
  - id: "the-legal-basis-amla-and-the-sro-system"
    title: "The Legal Basis: AMLA and the SRO System"
  - id: "who-must-join-an-sro"
    title: "Who Must Join an SRO?"
  - id: "finma-recognised-sros-which-one-is-right-for-you"
    title: "FINMA-Recognised SROs: Which One Is Right for You?"
  - id: "application-requirements"
    title: "Application Requirements"
  - id: "costs-what-to-budget"
    title: "Costs: What to Budget"
  - id: "timeline-how-long-does-sro-membership-take"
    title: "Timeline: How Long Does SRO Membership Take?"
  - id: "annual-obligations-after-membership"
    title: "Annual Obligations After Membership"
...
The SRO system is not a light-touch compliance formality. <a href="https://www.finma.ch/" target="_blank" rel="nofollow noopener">FINMA</a> sets the overarching AML standards; each SRO translates those standards into binding member regulations and supervises compliance through ongoing reporting requirements, periodic audits, and the power to expel non-compliant members.
...
**Annual fee payment**
Fees are invoiced annually and must be paid to maintain active membership status.

**Notification of material changes**
Members must notify the SRO promptly of any material change, including:
...
The AML training programme must be delivered to relevant staff at least annually, with attendance records maintained.
