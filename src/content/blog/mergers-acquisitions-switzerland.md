...
faqItems:
  ...
  - question: "What are typical M&A advisory fees in Switzerland?"
    answer: "Legal fees for a mid-market deal (CHF 5-50 million enterprise value) range from CHF 50'000-200'000 per side. Financial advisory fees typically add 1-3% of transaction value. Tax structuring advice costs CHF 15'000-50'000 depending on cross-border complexity."
  - question: "What are the main tax implications of a Swiss share deal versus an asset deal?"
    answer: "In a share deal, the seller pays capital gains tax (tax-free for individuals holding private assets, taxable for corporates). In an asset deal, the seller faces corporate income tax on gains plus real estate transfer tax if property is included. Buyers prefer asset deals for the step-up in tax basis."
  - question: "What due diligence items are unique to Swiss M&A transactions?"
    answer: "Swiss-specific items include pension fund (BVG) coverage ratios and potential restructuring liabilities, withholding tax on dividends at 35%, cantonal tax rulings that may not survive a change of control, and Lex Koller restrictions if real estate is involved."
  - question: "Can a COMCO merger filing delay a Swiss M&A transaction?"
    answer: "Yes. Transactions meeting the turnover thresholds (combined CHF 2 billion worldwide or CHF 500 million in Switzerland) require prior notification. COMCO has one month for Phase I review, extendable to four months for Phase II. Gun-jumping before clearance is prohibited."
  - question: "What are the key differences between acquiring an AG and a GmbH?"
    answer: "AG shares transfer by endorsement (bearer) or assignment (registered) without notarisation. GmbH quota transfers require public authentication before a Swiss notary. GmbH transfers also require shareholder approval unless the articles state otherwise."
tocItems:
  - id: "swiss-ma-market-what-the-numbers-show"
    title: "Swiss M&A Market: What the Numbers Show"
  - id: "share-deal-vs-asset-deal-choosing-the-right-structure"
    title: "Share Deal vs Asset Deal: Choosing the Right Structure"
  - id: "transaction-structures-under-swiss-law"
    title: "Transaction Structures Under Swiss Law"
  - id: "due-diligence-what-gets-examined"
    title: "Due Diligence: What Gets Examined"
  - id: "spa-key-terms"
    title: "SPA Key Terms"
  - id: "regulatory-approvals"
    title: "Regulatory Approvals"
  - id: "swiss-stamp-duty-on-share-transfers"
    title: "Swiss Stamp Duty on Share Transfers"
  - id: "employment-consequences"
...
The legal framework is straightforward by international standards. Private M&A is governed by the <a href="https://www.fedlex.admin.ch/eli/cc/27/317_321_377/en" target="_blank" rel="nofollow noopener">Swiss Code of Obligations (OR)</a>. Public takeovers fall under the Financial Markets Infrastructure Act (FMIA) with FINMA and the Takeover Board (UEK/TOB) playing central roles. Formal mergers, spin-offs, and demergers are regulated by the Swiss Merger Act (FusG). Each path has distinct mechanics and timelines.
...
Public takeovers are regulated by <a href="https://www.finma.ch/en/" target="_blank" rel="nofollow noopener">FINMA</a> and the Takeover Board (UEK/TOB) under the FMIA. The mandatory bid threshold is 33.33% of voting rights (the "opting-out" and "opting-up" mechanisms allow Swiss companies to adjust this threshold in their articles of association). Once triggered, the acquirer must make an offer for all listed shares at a minimum price set by the TOB. Timelines, disclosure obligations, and board duties are strictly regulated. Public M&A in Switzerland is a specialist practice area with limited tolerance for procedural error.
