...
heroImage: "/images/gold-trading-license-switzerland-hero.webp"
category: "Licensing & Permits"
categoryHref: "/licensing/"
readTime: "6 min read"
faqItems:
  - question: "Do I need a FINMA licence to trade gold in Switzerland?"
    answer: "A FINMA licence is only required if gold trading activities involve accepting deposits, managing client gold portfolios on a discretionary basis, or trading gold derivatives for third parties. Physical gold spot trading requires SRO membership under AMLA, not a FINMA licence."
  - question: "Is investment gold VAT-exempt in Switzerland?"
    answer: "Yes. Gold bars and wafers with purity of at least 995/1000, and qualifying gold coins, are exempt from Swiss VAT. Non-investment gold is subject to the standard 8.1% VAT rate."
  - question: "What is an SRO and why must gold dealers join one?"
    answer: "A Self-Regulatory Organisation (SRO) is a FINMA-approved body that supervises financial intermediaries, including precious metals dealers, for AML compliance. Swiss gold dealers must affiliate with an SRO such as VQF or OAR-G."
  - question: "How do I set up a gold trading company in Switzerland?"
    answer: "You first need a Swiss legal entity (typically an AG or GmbH), then SRO membership, a compliant AML programme, and appropriate bank relationships. Company formation takes 2-4 weeks; SRO membership adds 4-8 weeks."
  - question: "What is the cash transaction limit for gold purchases in Switzerland?"
    answer: "Cash payments for gold above CHF 100,000 trigger mandatory written client identification under AMLA. In practice, Swiss banks and AML regulations make large cash transactions difficult — most commercial gold trading is conducted by bank transfer. Some cantons and individual banks apply lower de facto thresholds."
  - question: "Is Swiss gold trading anonymous?"
    answer: "No. The Swiss AML Act requires identification of clients above the relevant thresholds. Anonymous gold purchasing in Switzerland ended with the tightening of AMLA and OECD/FATF pressure on the Swiss AML framework. All commercial gold dealers must maintain records of transactions for 10 years."
  - question: "What is the LBMA Good Delivery standard?"
    answer: "The LBMA Good Delivery standard is the global benchmark for gold bar quality accepted in international wholesale markets. Swiss refineries require LBMA accreditation to participate in international gold trading. The four major Swiss refineries (Valcambi, PAMP, Argor-Heraeus, Metalor) collectively process 2,000-2,500 tonnes of gold annually."
  - question: "Can I store gold in a Swiss freeport and what are the advantages?"
    answer: "Yes. Geneva and Zurich freeports allow gold storage outside Swiss customs territory. Gold stored in freeports is exempt from import duties and VAT as long as it remains inside. Gold can be traded and transferred within the freeport without triggering customs clearance. Operators must comply with AML requirements and hold customs authorisation."
  - question: "What happens if a gold dealer combines precious metals with cryptocurrency?"
    answer: "Combining gold trading with crypto (accepting crypto payments, tokenising gold) triggers enhanced KYC scrutiny from every Swiss bank. Privacy coins in particular raise AML red flags. Expect additional months to develop a banking strategy. VQF is the recommended SRO choice because it covers both gold and crypto under a single membership."
  - question: "What are the costs of setting up a gold trading company in Switzerland?"
    answer: "First-year costs for a gold trading entity typically total approximately CHF 12,000: company registration CHF 1,900-2,500, registered address CHF 2,400, nominee director CHF 5,900, and basic accounting CHF 1,800. SRO membership adds CHF 15,000-40,000 depending on the chosen SRO and business complexity. Share capital is additional."
tocItems:
  - id: "types-of-gold-business-in-switzerland"
    title: "Types of Gold Business in Switzerland"
  - id: "anti-money-laundering-aml-requirements"
    title: "Anti-Money Laundering (AML) Requirements"
  - id: "precious-metals-control-act-pmca-emkg"
    title: "Precious Metals Control Act (PMCA / EMKG)"
  - id: "vat-treatment-of-gold-in-switzerland"
    title: "VAT Treatment of Gold in Switzerland"
  - id: "gold-import-and-export"
    title: "Gold Import and Export"
  - id: "operating-a-swiss-gold-refinery"
    title: "Operating a Swiss Gold Refinery"
  - id: "swiss-free-ports-and-gold-storage"
    title: "Swiss Free Ports and Gold Storage"
  - id: "setting-up-your-swiss-gold-trading-company"
...
![Stacked gold bars ready for trading and secure vault storage in Switzerland](/images/gold-trading-license-switzerland-hero.webp)
...
- **SRO membership:** Gold dealers must be affiliated with a <a href="https://www.finma.ch/en/authorisation/self-regulatory-organisations-sros/" target="_blank" rel="nofollow noopener">FINMA-approved Self-Regulatory Organisation (SRO)</a> — e.g., VQF, OAR-G, or sector-specific SROs
