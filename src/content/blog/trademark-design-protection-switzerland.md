...
tocItems:
  - id: "trademark-and-design-protection-overview"
    title: "Trademark and Design Protection Overview"
  - id: "trademark-registration-in-switzerland"
    title: "Trademark Registration in Switzerland"
  - id: "design-registration-and-protection"
    title: "Design Registration and Protection"
  - id: "searching-the-swiss-trademark-register"
    title: "Searching the Swiss Trademark Register"
  - id: "international-protection-via-the-madrid-protocol"
    title: "International Protection via the Madrid Protocol"
  - id: "domain-disputes-and-online-brand-protection"
    title: "Domain Disputes and Online Brand Protection"
  - id: "enforcement-and-infringement-actions"
    title: "Enforcement and Infringement Actions"
...
faqItems:
  ...
  - question: "How long does trademark registration take in Switzerland?"
...
This guide covers the full scope of trademark and design protection in Switzerland: from searching the [Swissreg register](/intellectual-property/swissreg-trademark-search/) and filing applications, to [international trademark protection](/intellectual-property/madrid-protocol-switzerland/) and [domain dispute resolution](/intellectual-property/domain-dispute-switzerland/). For the broader [IP protection framework](/intellectual-property/) in Switzerland, see our companion guides on [patents](/intellectual-property/patent-registration-switzerland/) and [copyright](/intellectual-property/copyright-law-switzerland/).
...
- **Patents** protect technical inventions — covered separately in our [patent registration guide](/intellectual-property/patent-registration-switzerland/)
- **Copyright** protects creative works automatically — covered in our [copyright guide](/intellectual-property/copyright-law-switzerland/)

---

## Trademark Registration in Switzerland

[Trademark registration in Switzerland](/intellectual-property/trademark-registration-switzerland/) follows a structured process through IGE/IPI:

### Step 1: Prior Art Search

Before filing, conduct a search on [Swissreg](/intellectual-property/swissreg-trademark-search/) to identify existing marks that could conflict with your proposed trademark. Swissreg allows free searches by keyword, Nice class, and owner name. A professional availability search — checking not just identical marks but also similar marks and phonetic equivalents — typically costs CHF 300-800 through a trademark attorney.
...
[Design registration in Switzerland](/intellectual-property/design-registration-switzerland/) protects the visual appearance of products — from furniture and packaging to user interfaces and fashion items.
...
**Filing process:**
Applications are filed with IGE/IPI. Multiple designs (up to 100) can be included in a single application if they belong to the same Locarno class. The fee is CHF 200 for the first design and CHF 100 for each additional design.
...
[Swissreg](/intellectual-property/swissreg-trademark-search/) is the official online database for searching Swiss trademarks, patents, and designs. It is free to use and provides:
...
1. **Exact word search** — search for your proposed mark as an exact phrase
2. **Phonetic variants** — search for similar-sounding marks (e.g. "Zurich" and "Zuerich")
3. **Truncated search** — use wildcards to find marks containing your word element
4. **Nice class filter** — narrow results to the classes relevant to your goods or services
5. **Owner search** — check what marks competitors have registered
...
The [Madrid Protocol](/intellectual-property/madrid-protocol-switzerland/) allows Swiss trademark owners to extend protection internationally through a single application filed with WIPO (World Intellectual Property Organisation) via IGE/IPI.

**How it works:**

1. You must first have a Swiss trademark application or registration (the "base mark")
2. File an international application through IGE/IPI, designating the countries where you want protection
3. IGE/IPI forwards the application to WIPO, which publishes the international registration
4. Each designated country examines the mark under its own national law
5. If accepted, the mark receives protection equivalent to a national registration in that country
...
[Domain disputes in Switzerland](/intellectual-property/domain-dispute-switzerland/) arise when third parties register domain names that conflict with existing trademark rights. Two main resolution mechanisms exist:

**For .ch domains:**
SWITCH (the .ch registry) provides a dispute resolution procedure under SWITCH's General Terms and Conditions. Disputes can also be brought before the ordinary Swiss courts. Since 2020, SWITCH allows holders of prior rights to request transfer of .ch domains through a streamlined procedure.

**For .com/.org/.net and other gTLDs:**
...
**Criminal remedies (Art. 61 MSchG):**
Intentional trademark infringement is a criminal offence punishable by imprisonment of up to one year or a fine of up to CHF 100,000. Criminal proceedings can be initiated by filing a complaint with the cantonal prosecution authority.
...
1. **Filing without a search** — discovering a conflicting mark after filing wastes fees and creates legal exposure
2. **Too narrow Nice class selection** — failing to cover related goods or services leaves gaps in protection that competitors can exploit
3. **Too broad Nice class selection** — filing in classes where you have no genuine use intention risks non-use cancellation after 5 years
4. **Ignoring international protection** — a Swiss-only registration provides no protection in export markets; consider [Madrid Protocol filing](/intellectual-property/madrid-protocol-switzerland/) early
5. **Descriptive marks** — choosing marks that describe the product or service rather than distinguishing it (e.g. "Swiss Quality Watches") leads to refusal or weak protection
6. **Missing the opposition deadline** — you have only 3 months to oppose a conflicting mark after publication; monitoring is essential
7. **Failure to use the mark** — Swiss trademarks are vulnerable to cancellation if not genuinely used in commerce for 5 consecutive years after registration
