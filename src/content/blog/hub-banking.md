---
title: "Banking & Finance in Switzerland: Accounts, Private Banking & System Guide"
...
faqItems:
  ...
  - question: "Is Swiss banking secrecy still in effect?"
    answer: "Domestically, yes. Article 47 of the Banking Act still imposes criminal penalties on bank employees who disclose client information to unauthorised parties within Switzerland. Internationally, Switzerland participates in the Automatic Exchange of Information (AEOI) with over 100 countries, sharing account data with foreign tax authorities. Banking secrecy no longer provides protection against international tax transparency."
  - question: "How is the Swiss banking system regulated?"
    answer: "FINMA (Swiss Financial Market Supervisory Authority) is the integrated regulator overseeing banks, insurance companies, securities dealers, and financial market infrastructure. The Swiss National Bank (SNB) sets monetary policy and manages financial system stability. The Swiss Bankers Association (SBA) issues self-regulatory guidelines including the Agreement on Due Diligence (VSB), which carries quasi-regulatory force through FINMA recognition."
  - question: "What fees do Swiss banks charge?"
    answer: "Fee structures vary by bank type. Retail bank account maintenance runs CHF 20-60 per quarter for personal accounts and CHF 50-200 per quarter for corporate accounts. Private banking all-in fees range from 0.8-1.5% annually on assets under management. Additional charges include custody fees (0.1-0.5% annually), international transfer fees (CHF 5-30), and card fees (CHF 50-100 per year)."
  - question: "Are Swiss bank deposits protected?"
    answer: "Yes. The esisuisse deposit protection scheme covers deposits up to CHF 100,000 per depositor per bank. This includes savings accounts, current accounts, and fixed-term deposits held by natural persons and legal entities. Investment assets (securities, funds) held in custody are segregated from the bank balance sheet and are not part of the bankruptcy estate if a bank fails."
  - question: "How long does it take to open a corporate bank account in Switzerland?"
    answer: "A straightforward Swiss GmbH or AG with Swiss-resident directors typically opens a corporate account within 2-3 weeks. Complex structures involving foreign beneficial owners, multi-layered ownership, or high-risk jurisdictions can take 6-8 weeks due to enhanced KYC/AML checks. Digital banks may process simpler applications faster, but established banks remain the standard for corporate relationships."
  - question: "What is a capital deposit account?"
...
tocItems:
  ...
  - id: "the-swiss-banking-system"
    title: "The Swiss Banking System"
  - id: "types-of-swiss-banks"
    title: "Types of Swiss Banks"
  - id: "regulation-and-supervision"
    title: "Regulation and Supervision"
  - id: "opening-a-bank-account-in-switzerland"
    title: "Opening a Bank Account in Switzerland"
  - id: "personal-accounts-for-residents-and-non-residents"
    title: "Personal Accounts for Residents and Non-Residents"
  - id: "corporate-bank-accounts"
    title: "Corporate Bank Accounts"
  - id: "private-banking-in-switzerland"
    title: "Private Banking in Switzerland"
  - id: "wealth-management-services"
    title: "Wealth Management Services"
  - id: "fee-structures-across-bank-types"
    title: "Fee Structures Across Bank Types"
  - id: "deposit-protection-and-safety"
    title: "Deposit Protection and Safety"
  - id: "swiss-banking-for-international-clients"
...
For a detailed breakdown of how the system is organised — from FINMA supervision to SNB monetary policy — see our guide to the [Swiss banking system](/banking/swiss-banking-landscape/).
...
This layered system means that compliance requirements vary significantly depending on the type of institution and the services it offers. The [Swiss banking system guide](/banking/swiss-banking-landscape/) explains each regulatory layer and what it means for different participants in the financial market.
...
Our detailed guide on [opening a Swiss bank account](/banking/opening-swiss-bank-account-guide/) covers every scenario — personal accounts, corporate accounts, non-resident accounts, and capital deposit accounts for company formation.
...
For a full breakdown of documentation requirements by residency status, see our [account opening guide](/banking/opening-swiss-bank-account-guide/).
...
Our [private banking guide](/banking/private-banking-switzerland-guide/) covers this sector in detail, including institution-by-institution comparisons, fee transparency, and practical guidance on choosing the right bank.
...
**For private wealth management**: The choice depends on asset level, investment preferences, and the importance of additional services like estate planning or family office support. See our [private banking guide](/banking/private-banking-switzerland-guide/) for institution-by-institution comparisons.
