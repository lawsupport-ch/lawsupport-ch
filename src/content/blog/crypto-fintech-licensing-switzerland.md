...
tocItems:
  - id: "swiss-crypto-regulatory-framework"
    title: "Swiss Crypto Regulatory Framework"
  - id: "vasp-registration"
    title: "VASP Registration"
  - id: "sro-membership-for-crypto-businesses"
    title: "SRO Membership for Crypto Businesses"
  - id: "crypto-exchange-licensing"
    title: "Crypto Exchange Licensing"
  - id: "dlt-trading-facility-licence"
    title: "DLT Trading Facility Licence"
  - id: "ico-and-token-issuance-rules"
    title: "ICO and Token Issuance Rules"
  - id: "fintech-licence-and-sandbox"
    title: "Fintech Licence and Sandbox"
  - id: "aml-compliance-for-crypto"
    title: "AML Compliance for Crypto"
  - id: "which-licence-do-you-need"
...
faqItems:
  ...
  - question: "What is the difference between VASP registration and SRO membership?"
    answer: "VASP registration is the international term for the obligation to register as a virtual asset service provider. In Switzerland, this obligation is fulfilled through SRO membership — joining a self-regulatory organisation recognised by FINMA for AML supervision. SRO membership is the Swiss mechanism for VASP compliance."
  - question: "Can I issue tokens in Switzerland without a licence?"
    answer: "Possibly. FINMA classifies tokens into payment tokens, utility tokens, and asset tokens. Pure utility tokens with no investment function may not trigger securities law obligations. Payment tokens trigger AML obligations (SRO membership). Asset tokens are treated as securities and require a prospectus and compliance with FinSA. Always obtain a FINMA no-action letter before launching."
  - question: "What does the DLT Act change for crypto businesses?"
    answer: "The DLT Act (in force since 1 August 2021) introduced DLT securities (uncertificated register securities on blockchain), the DLT trading facility licence (a new FINMA licence category), and provisions for segregating crypto assets in bankruptcy. It provides legal certainty for tokenised assets and decentralised trading platforms."
  - question: "How much does SRO membership cost for a crypto company?"
    answer: "Application fees: CHF 5,000 to 15,000 depending on the SRO. Annual membership fees: CHF 5,000 to 30,000 depending on company size and transaction volume. Initial AML framework setup: CHF 10,000 to 50,000 (legal and compliance costs). Total first-year cost: CHF 20,000 to 95,000."
  - question: "Can a foreign crypto company operate in Switzerland without a Swiss entity?"
    answer: "No. Any crypto business targeting Swiss clients or operating from Switzerland must have a Swiss legal entity (AG or GmbH) with registered office in Switzerland. Foreign exchanges listing Swiss tokens or targeting Swiss users may also trigger Swiss regulatory requirements. FINMA has taken enforcement action against foreign entities operating without authorisation."
  - question: "What AML requirements apply to crypto businesses in Switzerland?"
    answer: "Full AMLA compliance: customer identification (KYC) for transactions above CHF 1,000 (or CHF 0 for ongoing relationships), transaction monitoring, suspicious activity reporting to MROS, record retention for 10 years, and risk-based due diligence. The travel rule applies to crypto transfers — originator and beneficiary information must be transmitted."
  - question: "Is staking or DeFi lending regulated in Switzerland?"
    answer: "Staking services may constitute deposit-taking if the provider pools client assets and bears the risk of loss. DeFi lending protocols where a Swiss entity acts as intermediary may trigger banking licence requirements. Pure protocol development without intermediary functions is generally unregulated. Each case requires individual assessment."
  - question: "How long does it take to get a DLT trading facility licence?"
    answer: "The DLT trading facility licence application takes 9 to 18 months from filing to approval. Pre-application preparation adds 3 to 6 months. FINMA reviews the application against banking-level standards, including capital adequacy, governance, IT security, and AML compliance. This is one of the most demanding licence categories."
  - question: "What happens if my crypto business operates without proper licensing?"
    answer: "FINMA can issue public warnings, freeze accounts, appoint an investigator, liquidate the company, and refer the matter for criminal prosecution. Unlicensed financial intermediation is a criminal offence. FINMA regularly publishes its warning list of unlicensed operators and maintains an enforcement division specifically for fintech and crypto."
relatedArticles:
...
<a href="https://www.finma.ch/en/finma/finma-guidance/guidelines-and-circulars/" target="_blank" rel="nofollow noopener">FINMA guidelines</a> and the 2018 ICO guidelines provide additional classification and supervisory detail.

---

## VASP Registration

[VASP registration](/licensing/vasp-registration-switzerland/) (Virtual Asset Service Provider) is the international standard established by the Financial Action Task Force (FATF). In Switzerland, the VASP obligation is fulfilled through SRO membership.
...
[SRO membership](/licensing/sro-membership-switzerland/) is the primary regulatory step for most Swiss crypto businesses. Self-regulatory organisations (SROs) are private bodies recognised by FINMA to supervise financial intermediaries for AML compliance.
...
[Crypto exchange licensing](/licensing/crypto-exchange-license-switzerland/) depends on the exchange model:
...
The [DLT trading facility](/licensing/dlt-trading-facility-switzerland/) is a licence category introduced by the DLT Act. It authorises the operation of a multilateral trading platform for DLT securities — tokenised assets recorded on a distributed ledger.
...
[ICO and token issuance](/licensing/ico-token-issuance-switzerland/) in Switzerland follows FINMA's token classification framework:
...
The [fintech licence](/licensing/fintech-license-switzerland/) (Art. 1b BankG) is a lighter-touch banking authorisation for companies that:
...
- [Crypto exchange](/licensing/crypto-exchange-license-switzerland/) and [DLT trading facility](/licensing/dlt-trading-facility-switzerland/) licence applications
- [ICO and token issuance](/licensing/ico-token-issuance-switzerland/) structuring and FINMA no-action letters
