...
tocItems:
  ...
  - id: "personal-accounts-documents-and-requirements"
    title: "Personal Accounts: Documents and Requirements"
  - id: "corporate-accounts-what-swiss-banks-expect"
    title: "Corporate Accounts: What Swiss Banks Expect"
  - id: "non-resident-account-opening"
  ...
  - id: "comparing-swiss-banks-for-foreign-clients"
    title: "Comparing Swiss Banks for Foreign Clients"
...
faqItems:
  ...
  - question: "Can a non-resident open a Swiss bank account without visiting Switzerland?"
    answer: "Some banks accept remote account opening for personal accounts, typically through video identification (e.g. Dukascopy, Alpian, Yuh). Corporate accounts almost always require at least one in-person meeting or a visit by a representative with notarised power of attorney. Banks conducting enhanced due diligence on non-resident corporate clients generally expect a face-to-face meeting in Switzerland."
  - question: "How long does it take to open a Swiss corporate bank account?"
    answer: "The timeline ranges from 2 to 8 weeks depending on the bank and the complexity of the corporate structure. Simple Swiss GmbH or AG structures with Swiss-resident directors open faster (2-3 weeks). Complex holding structures with foreign beneficial owners, multi-layered ownership, or high-risk jurisdictions can take 6-8 weeks due to enhanced KYC/AML checks."
  - question: "What documents do I need to open a personal Swiss bank account as a foreigner?"
...
Opening a personal [Swiss bank account](/banking/swiss-bank-account/) requires the following core documents:
...
[Non-residents](/banking/swiss-bank-account-non-residents/) face additional requirements but can absolutely open Swiss bank accounts. The key considerations are:
...
Several Swiss banks now offer [fully digital account opening](/banking/swiss-bank-account-online/), though the availability depends on your residency status and the type of account.
...
Choosing the right bank depends on your specific situation. Here is a practical comparison for the [best Swiss banks for foreign clients](/banking/best-swiss-banks-foreigners/):

**For SMEs and startups:**
Cantonal banks (ZKB, BCGE, Banque Cantonale Vaudoise) offer the most competitive fee structures and pragmatic onboarding for standard business accounts. They are state-guaranteed, which provides additional security.

**For international holding companies:**
UBS has the most extensive international network and experience with complex corporate structures. Fees are higher, but the bank's capacity to handle multi-currency, multi-jurisdictional structures is unmatched.

**For high-net-worth individuals:**
Private banks (Julius Baer, Lombard Odier, Pictet, Vontobel) offer dedicated relationship managers, bespoke investment mandates, and family office services. Minimum thresholds typically start at CHF 500,000-2,000,000.

**For fintech and crypto businesses:**
Seba Bank and Sygnum are the two FINMA-licensed crypto banks. They accept crypto-native businesses that traditional banks decline. Bank Frick in Liechtenstein (accessible from Switzerland) is another option for blockchain companies.

For a full comparison, see our [guide to the best Swiss banks for foreigners](/banking/best-swiss-banks-foreigners/).
