...
faqItems:
  ...
  - question: "Can I apply for a Swiss visa while already in the Schengen Area?"
    answer: "Generally no. Schengen C visa applications must be submitted at the Swiss embassy or consulate in your country of residence before travel. Applying from within the Schengen Area is not permitted except in narrow emergency circumstances. D visa applications similarly require pre-approval from the cantonal migration authority."
  - question: "What happens if I overstay my 90-day visa-free allowance?"
    answer: "Overstay is recorded in the Schengen Information System (SIS) and can result in fines, detention, and a ban on future Schengen entry for up to 3 years. The record also complicates future D visa and work permit applications, as Swiss consulates flag prior overstays during processing."
  - question: "Do children need separate Swiss visa applications?"
    answer: "Yes. Each child requires a separate Schengen C visa application, even if travelling with parents. Children under 6 are exempt from the visa fee. Children aged 6 to 12 pay a reduced fee of EUR 40. Each child must have their own valid passport."
  - question: "Can I open a Swiss bank account while on a tourist visa?"
    answer: "Most Swiss banks require a valid residence permit for account opening. The exception is blocked capital deposit accounts for company formation, which can be opened with passport identification and proof of the formation mandate. Regular current accounts typically require a permit."
  - question: "Is travel insurance mandatory for a Swiss Schengen visa?"
    answer: "Yes. Travel insurance covering a minimum of CHF 30,000 in medical costs and repatriation is mandatory for all Schengen C visa applications. The policy must cover the entire duration of the planned stay and be valid across all Schengen member states."
tocItems:
  - id: "who-does-not-need-a-swiss-visa"
    title: "Who Does Not Need a Swiss Visa"
  - id: "schengen-c-visa-short-stay-visa"
    title: "Schengen C Visa (Short-Stay Visa)"
  - id: "national-d-visa-long-stay-visa"
    title: "National D Visa (Long-Stay Visa)"
  - id: "schengen-area-and-switzerlands-membership"
    title: "Schengen Area and Switzerland's Membership"
  - id: "swiss-visa-for-business-purposes"
    title: "Swiss Visa for Business Purposes"
  - id: "from-visa-to-permanent-residence"
...
No. There is no language requirement for any Swiss visa category. The Schengen C visa and national D visa are assessed on documentation, financial means, and purpose of visit — not language ability. Language requirements only become relevant for the [C permit](/immigration/c-permit-switzerland/) and [Swiss citizenship](/immigration/swiss-citizenship/).
