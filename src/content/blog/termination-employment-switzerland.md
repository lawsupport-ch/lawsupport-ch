...
faqItems:
  ...
  - question: "Can an employer terminate during an employee's holiday?"
    answer: "Yes, unless the employee is simultaneously in a protected period (illness, pregnancy, military service). Holidays alone do not create a protected period. However, the notice period runs concurrently with the holiday, and the employer cannot require the employee to take untaken holiday during the notice period without the employee's agreement."
  - question: "What is a Saldoerklaerung and should the employee sign it?"
    answer: "A Saldoerklaerung is a final settlement declaration confirming that all mutual claims between employer and employee are settled. Employees are not obliged to sign it, and many employment lawyers advise against signing without independent review. Once signed, it functions as a release and is very difficult to challenge later."
  - question: "Are there special termination rules for employees over 50?"
    answer: "There is no specific prohibition on terminating employees over 50. However, employees aged 50 or older with at least 20 years of service are entitled to statutory severance of 2 to 8 months' salary under Art. 339b OR when the employer terminates. Courts also apply a heightened duty of care when assessing whether dismissal of long-serving older employees is abusive."
  - question: "What happens to untaken holiday when employment is terminated?"
    answer: "Swiss law strongly favours actual usage of remaining holiday during the notice period. If operational needs prevent this, the employer must pay out untaken holiday days at the daily salary rate. The payout covers only genuinely untaken days; the employer can require the employee to take holiday during the notice period if sufficient time remains."
  - question: "Can a fixed-term contract be terminated early in Switzerland?"
    answer: "Fixed-term contracts expire automatically at the agreed date without notice. Early termination is only possible if the contract includes an early termination clause or if good cause exists for summary dismissal under Art. 337 OR. Without such a clause, the employer owes the full remaining salary until the contract's natural expiry."
tocItems:
  - id: "swiss-employment-law-the-basic-framework"
    title: "Swiss Employment Law: The Basic Framework"
  - id: "notice-periods"
    title: "Notice Periods"
  - id: "protected-periods-when-dismissal-is-prohibited"
    title: "Protected Periods: When Dismissal Is Prohibited"
  - id: "summary-dismissal-fristlose-kundigung"
    title: "Summary Dismissal (Fristlose Kundigung)"
  - id: "abusive-dismissal-missbrauchliche-kundigung"
    title: "Abusive Dismissal (Missbrauchliche Kundigung)"
  - id: "severance-pay-abgangsentschadigung"
    title: "Severance Pay (Abgangsentschadigung)"
  - id: "mass-redundancy-massenentlassung"
    title: "Mass Redundancy (Massenentlassung)"
...
| Years 2-9 of employment | 2 months (end of calendar month) |
| Year 10 onwards | 3 months (end of calendar month) |
